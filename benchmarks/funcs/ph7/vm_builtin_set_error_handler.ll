...
@.str.535 = external hidden unnamed_addr constant [71 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_set_error_handler(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end12:                                         ; preds = %if.end, %entry
  ...
  %call13 = call ptr @ph7_lib_version()
  %call14 = call i32 (ptr, i32, ptr, ...) @ph7_context_throw_error_format(ptr noundef %16, i32 noundef 2, ptr noundef @.str.535, ptr noundef %call13)
  ret i32 0
}
