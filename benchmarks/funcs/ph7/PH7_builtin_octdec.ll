...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_octdec(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then6:                                         ; preds = %if.then2
  ...
  %call7 = call i32 @SyOctalStrToInt64(ptr noundef %7, i32 noundef %8, ptr noundef %iVal, ptr noundef null)
  br label %if.end8
