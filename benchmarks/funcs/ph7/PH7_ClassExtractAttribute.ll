...
; Function Attrs: nounwind uwtable
define hidden ptr @PH7_ClassExtractAttribute(ptr noundef %pClass, ptr noundef %zName, i32 noundef %nByte) #0 {
entry:
  ...
  %call = call ptr @SyHashGet(ptr noundef %hAttr, ptr noundef %1, i32 noundef %2)
