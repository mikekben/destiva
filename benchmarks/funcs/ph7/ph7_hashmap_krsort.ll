...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_krsort(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end12:                                         ; preds = %if.end11, %if.then4
  ...
  %call13 = call i32 @HashmapMergeSort(ptr noundef %13, ptr noundef @HashmapCmpCallback5, ptr noundef %15)
  br label %while.cond
...
; Function Attrs: nounwind uwtable
declare hidden i32 @HashmapCmpCallback5(ptr noundef, ptr noundef, ptr noundef) #0
