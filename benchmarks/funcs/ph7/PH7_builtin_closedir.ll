...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_closedir(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xCloseDir = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 5
  %16 = load ptr, ptr %xCloseDir, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %xCloseDir22 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %23, i32 0, i32 5
  %24 = load ptr, ptr %xCloseDir22, align 8
  ...
  call void @ReleaseIOPrivate(ptr noundef %27, ptr noundef %28)
  %29 = load ptr, ptr %apArg.addr, align 8
  %arrayidx23 = getelementptr inbounds ptr, ptr %29, i64 0
  %30 = load ptr, ptr %arrayidx23, align 8
  %call24 = call i32 @PH7_MemObjRelease(ptr noundef %30)
  store i32 0, ptr %retval, align 4
  br label %return
