...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_sum(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then16:                                        ; preds = %if.end14
  ...
  call void @DoubleSum(ptr noundef %17, ptr noundef %18)
  br label %if.end17

if.else:                                          ; preds = %if.end14
  %19 = load ptr, ptr %pCtx.addr, align 8
  %20 = load ptr, ptr %pMap, align 8
  call void @Int64Sum(ptr noundef %19, ptr noundef %20)
  br label %if.end17
...
; Function Attrs: nounwind uwtable
declare hidden void @DoubleSum(ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
declare hidden void @Int64Sum(ptr noundef, ptr noundef) #0
