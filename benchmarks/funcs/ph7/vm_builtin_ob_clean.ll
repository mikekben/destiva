...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_clean(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %4 = load ptr, ptr %pOb, align 8
  %sOB = getelementptr inbounds nuw %struct.VmObEntry, ptr %4, i32 0, i32 1
  %call2 = call i32 @SyBlobRelease(ptr noundef %sOB)
  br label %if.end
