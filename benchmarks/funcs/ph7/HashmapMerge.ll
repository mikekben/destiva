...
; Function Attrs: nounwind uwtable
define hidden i32 @HashmapMerge(ptr noundef %pSrc, ptr noundef %pDest) #0 {
entry:
...
if.else:                                          ; preds = %for.body
  ...
  %call9 = call i32 @HashmapInsert(ptr noundef %18, ptr noundef null, ptr noundef %19)
...
if.end13:                                         ; preds = %if.end10
  ...
  %pPrev = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %22, i32 0, i32 7
