...
@.str.811 = external hidden unnamed_addr constant [7 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden void @PH7_static_Const(ptr noundef %pVal, ptr noundef %pUserData) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 @ph7_value_string(ptr noundef %4, ptr noundef %6, i32 noundef %8)
  br label %if.end

if.else:                                          ; preds = %entry
  %9 = load ptr, ptr %pVal.addr, align 8
  %call2 = call i32 @ph7_value_string(ptr noundef %9, ptr noundef @.str.811, i32 noundef 6)
  br label %if.end
