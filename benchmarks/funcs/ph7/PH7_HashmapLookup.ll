...
define hidden i32 @PH7_HashmapLookup(ptr noundef %pMap, ptr noundef %pKey, ptr noundef %ppNode) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %4 = load ptr, ptr %ppNode.addr, align 8
  %call = call i32 @HashmapLookup(ptr noundef %2, ptr noundef %3, ptr noundef %4)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @HashmapLookup(ptr noundef, ptr noundef, ptr noundef) #0
