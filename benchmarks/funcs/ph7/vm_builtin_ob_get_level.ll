...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_get_level(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  store i32 %3, ptr %iNest, align 4
  %4 = load ptr, ptr %pCtx.addr, align 8
  %5 = load i32, ptr %iNest, align 4
  %call = call i32 @ph7_result_int(ptr noundef %4, i32 noundef %5)
  ret i32 0
}
