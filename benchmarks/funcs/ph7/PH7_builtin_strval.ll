...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_strval(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  store ptr %call1, ptr %zVal, align 8
  %4 = load ptr, ptr %pCtx.addr, align 8
  %5 = load ptr, ptr %zVal, align 8
  %6 = load i32, ptr %iLen, align 4
  %call2 = call i32 @ph7_result_string(ptr noundef %4, ptr noundef %5, i32 noundef %6)
  br label %if.end
