...
define dso_local i32 @ph7_array_walk(ptr noundef %pArray, ptr noundef %xWalk, ptr noundef %pUserData) #0 {
entry:
...
if.end3:                                          ; preds = %if.end
  %3 = load ptr, ptr %pArray.addr, align 8
  ...
  %call = call i32 @PH7_HashmapWalk(ptr noundef %4, ptr noundef %5, ptr noundef %6)
