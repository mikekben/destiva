...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_zip_entry_compressedsize(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end11:                                         ; preds = %lor.lhs.false6
  ...
  %nByteCompr = getelementptr inbounds nuw %struct.SyArchiveEntry, ptr %13, i32 0, i32 1
  %14 = load i32, ptr %nByteCompr, align 4
  %conv = zext i32 %14 to i64
  %call12 = call i32 @ph7_result_int64(ptr noundef %12, i64 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
