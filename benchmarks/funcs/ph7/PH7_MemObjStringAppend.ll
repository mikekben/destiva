...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_MemObjStringAppend(ptr noundef %pObj, ptr noundef %zData, i32 noundef %nLen) #0 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %7 = load ptr, ptr %zData.addr, align 8
  %8 = load i32, ptr %nLen.addr, align 4
  %call4 = call i32 @SyBlobAppend(ptr noundef %sBlob, ptr noundef %7, i32 noundef %8)
