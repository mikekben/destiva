...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_zip_entry_reset_read_cursor(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end11:                                         ; preds = %lor.lhs.false6
  ...
  store i32 0, ptr %nReadCount, align 8
  %13 = load ptr, ptr %pCtx.addr, align 8
  %call12 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
