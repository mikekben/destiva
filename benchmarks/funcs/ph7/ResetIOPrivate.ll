...
; Function Attrs: nounwind uwtable
define hidden void @ResetIOPrivate(ptr noundef %pDev) #0 {
entry:
  ...
  %call = call i32 @SyBlobReset(ptr noundef %sBuffer)
  %1 = load ptr, ptr %pDev.addr, align 8
  %nOfft = getelementptr inbounds nuw %struct.io_private, ptr %1, i32 0, i32 3
