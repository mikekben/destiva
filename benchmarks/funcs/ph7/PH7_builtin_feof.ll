...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_feof(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %zBuf = alloca [4096 x i8], align 16
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call2 = call i32 @ph7_result_bool(ptr noundef %4, i32 noundef 1)
...
if.then8:                                         ; preds = %lor.lhs.false6, %if.end
  ...
  %call10 = call i32 @ph7_result_bool(ptr noundef %11, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call18 = call i32 @ph7_result_bool(ptr noundef %20, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
...
if.end19:                                         ; preds = %if.end11
  ...
  %sBuffer = getelementptr inbounds nuw %struct.io_private, ptr %21, i32 0, i32 2
  ...
  %nOfft = getelementptr inbounds nuw %struct.io_private, ptr %23, i32 0, i32 3
  %24 = load i32, ptr %nOfft, align 8
  %sub = sub i32 %22, %24
  %cmp20 = icmp ugt i32 %sub, 0
...
if.else:                                          ; preds = %if.end19
  %25 = load ptr, ptr %pStream, align 8
  %xRead = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %25, i32 0, i32 6
  %26 = load ptr, ptr %xRead, align 8
  %27 = load ptr, ptr %pDev, align 8
  %pHandle = getelementptr inbounds nuw %struct.io_private, ptr %27, i32 0, i32 1
  %28 = load ptr, ptr %pHandle, align 8
  %arraydecay = getelementptr inbounds [4096 x i8], ptr %zBuf, i64 0, i64 0
  %call22 = call i64 %26(ptr noundef %28, ptr noundef %arraydecay, i64 noundef 4096)
  store i64 %call22, ptr %n, align 8
  %29 = load i64, ptr %n, align 8
  %cmp23 = icmp sgt i64 %29, 0
  br i1 %cmp23, label %if.then24, label %if.end28

if.then24:                                        ; preds = %if.else
  %30 = load ptr, ptr %pDev, align 8
  %sBuffer25 = getelementptr inbounds nuw %struct.io_private, ptr %30, i32 0, i32 2
  %arraydecay26 = getelementptr inbounds [4096 x i8], ptr %zBuf, i64 0, i64 0
  %31 = load i64, ptr %n, align 8
  %conv = trunc i64 %31 to i32
  %call27 = call i32 @SyBlobAppend(ptr noundef %sBuffer25, ptr noundef %arraydecay26, i32 noundef %conv)
  store i32 0, ptr %rc, align 4
  br label %if.end28
...
if.end29:                                         ; preds = %if.end28, %if.then21
  ...
  %cmp30 = icmp eq i32 %33, -18
  %conv31 = zext i1 %cmp30 to i32
  %call32 = call i32 @ph7_result_bool(ptr noundef %32, i32 noundef %conv31)
  store i32 0, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end29, %cond.end, %if.then8, %if.then
