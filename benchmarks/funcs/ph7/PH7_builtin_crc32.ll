...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_crc32(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = call i32 @ph7_result_int(ptr noundef %5, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
...
if.end5:                                          ; preds = %if.end
  ...
  %call6 = call i32 @SyCrc32(ptr noundef %6, i32 noundef %7)
  store i32 %call6, ptr %nCRC, align 4
  %8 = load ptr, ptr %pCtx.addr, align 8
  %9 = load i32, ptr %nCRC, align 4
  %conv = zext i32 %9 to i64
  %xor = xor i64 %conv, 4294967295
  %call7 = call i32 @ph7_result_int64(ptr noundef %8, i64 noundef %xor)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @SyCrc32(ptr noundef, i32 noundef) #0
