...
; Function Attrs: nounwind uwtable
define hidden i32 @HashmapInsertIntKey(ptr noundef %pMap, i64 noundef %iKey, ptr noundef %pValue, i32 noundef %nRefIdx, i32 noundef %isForeign) #0 {
entry:
...
if.end7:                                          ; preds = %if.else, %if.end5
  ...
  %xIntHash = getelementptr inbounds nuw %struct.ph7_hashmap, ptr %10, i32 0, i32 7
  %11 = load ptr, ptr %xIntHash, align 8
  %12 = load i64, ptr %iKey.addr, align 8
  %call8 = call i32 %11(i64 noundef %12)
  store i32 %call8, ptr %nHash, align 4
  %13 = load ptr, ptr %pMap.addr, align 8
  %14 = load i64, ptr %iKey.addr, align 8
  %15 = load i32, ptr %nHash, align 4
  %16 = load i32, ptr %nIdx, align 4
  %call9 = call ptr @HashmapNewIntNode(ptr noundef %13, i64 noundef %14, i32 noundef %15, i32 noundef %16)
...
if.end12:                                         ; preds = %if.end7
  %18 = load i32, ptr %isForeign.addr, align 4
  %tobool13 = icmp ne i32 %18, 0
  br i1 %tobool13, label %if.then14, label %if.end15

if.then14:                                        ; preds = %if.end12
  %19 = load ptr, ptr %pNode, align 8
  %iFlags = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %19, i32 0, i32 3
...
if.end15:                                         ; preds = %if.then14, %if.end12
  ...
  %call16 = call i32 @HashmapGrowBucket(ptr noundef %21)
  store i32 %call16, ptr %rc, align 4
  %22 = load i32, ptr %rc, align 4
  %cmp17 = icmp ne i32 %22, 0
  br i1 %cmp17, label %if.then18, label %if.end21

if.then18:                                        ; preds = %if.end15
  %23 = load ptr, ptr %pMap.addr, align 8
  %pVm19 = getelementptr inbounds nuw %struct.ph7_hashmap, ptr %23, i32 0, i32 0
  %24 = load ptr, ptr %pVm19, align 8
  %sAllocator = getelementptr inbounds nuw %struct.ph7_vm, ptr %24, i32 0, i32 0
  %25 = load ptr, ptr %pNode, align 8
  %call20 = call i32 @SyMemBackendPoolFree(ptr noundef %sAllocator, ptr noundef %25)
...
if.end21:                                         ; preds = %if.end15
  ...
  %29 = load i32, ptr %nHash, align 4
  %30 = load ptr, ptr %pMap.addr, align 8
  %nSize = getelementptr inbounds nuw %struct.ph7_hashmap, ptr %30, i32 0, i32 5
  %31 = load i32, ptr %nSize, align 8
  %sub = sub i32 %31, 1
  %and = and i32 %29, %sub
  call void @HashmapNodeLink(ptr noundef %27, ptr noundef %28, i32 noundef %and)
  %32 = load ptr, ptr %pMap.addr, align 8
  %pVm22 = getelementptr inbounds nuw %struct.ph7_hashmap, ptr %32, i32 0, i32 0
  %33 = load ptr, ptr %pVm22, align 8
  %34 = load i32, ptr %nIdx, align 4
  %35 = load ptr, ptr %pNode, align 8
  %call23 = call i32 @PH7_VmRefObjInstall(ptr noundef %33, i32 noundef %34, ptr noundef null, ptr noundef %35, i32 noundef 0)
...
; Function Attrs: nounwind uwtable
declare hidden ptr @HashmapNewIntNode(ptr noundef, i64 noundef, i32 noundef, i32 noundef) #0
