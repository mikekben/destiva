...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_VmThrowError(ptr noundef %pVm, ptr noundef %pFuncName, i32 noundef %iErr, ptr noundef %zMessage) #0 {
entry:
...
if.end16:                                         ; preds = %if.then11, %sw.epilog
  ...
  %24 = load ptr, ptr %zMessage.addr, align 8
  %25 = load ptr, ptr %zMessage.addr, align 8
  %call17 = call i32 @SyStrlen(ptr noundef %25)
  %call18 = call i32 @SyBlobAppend(ptr noundef %23, ptr noundef %24, i32 noundef %call17)
  %26 = load ptr, ptr %pVm.addr, align 8
  %27 = load ptr, ptr %pWorker, align 8
  %call19 = call i32 @VmCallErrorHandler(ptr noundef %26, ptr noundef %27)
