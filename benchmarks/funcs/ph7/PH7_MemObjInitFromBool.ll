...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_MemObjInitFromBool(ptr noundef %pVm, ptr noundef %pObj, i32 noundef %iVal) #0 {
entry:
  ...
  %5 = load i32, ptr %iVal.addr, align 4
  ...
  store i32 8, ptr %iFlags, align 8
  ret i32 0
}
