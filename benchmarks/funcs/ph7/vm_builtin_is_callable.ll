...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_is_callable(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %pVm1 = getelementptr inbounds nuw %struct.ph7_context, ptr %2, i32 0, i32 4
  ...
  %call2 = call i32 @PH7_VmIsCallable(ptr noundef %4, ptr noundef %6, i32 noundef 1)
  store i32 %call2, ptr %res, align 4
  %7 = load ptr, ptr %pCtx.addr, align 8
  %8 = load i32, ptr %res, align 4
  %call3 = call i32 @ph7_result_bool(ptr noundef %7, i32 noundef %8)
  store i32 0, ptr %retval, align 4
  br label %return
