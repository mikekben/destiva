...
; Function Attrs: nounwind uwtable
define hidden void @PH7_XML_ERROR_UNKNOWN_ENCODING_Const(ptr noundef %pVal, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @ph7_value_int(ptr noundef %0, i32 noundef 19)
  ret void
}
