...
define hidden i32 @SyBlobInit(ptr noundef %pBlob, ptr noundef %pAllocator) #0 {
entry:
  ...
  %pBlob1 = getelementptr inbounds nuw %struct.SyBlob, ptr %0, i32 0, i32 1
  store ptr null, ptr %pBlob1, align 8
  ...
  %pAllocator2 = getelementptr inbounds nuw %struct.SyBlob, ptr %4, i32 0, i32 0
  store ptr %3, ptr %pAllocator2, align 8
  %5 = load ptr, ptr %pBlob.addr, align 8
  %nFlags = getelementptr inbounds nuw %struct.SyBlob, ptr %5, i32 0, i32 4
  store i32 0, ptr %nFlags, align 8
  ret i32 0
}
