...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_parser_set_option(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end9:                                          ; preds = %lor.lhs.false5
  ...
  %call10 = call i32 @ph7_result_bool(ptr noundef %10, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
