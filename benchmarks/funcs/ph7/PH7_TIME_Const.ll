...
; Function Attrs: nounwind uwtable
define hidden void @PH7_TIME_Const(ptr noundef %pVal, ptr noundef %pUnused) #0 {
entry:
  ...
  %tm_hour11 = getelementptr inbounds nuw %struct.Sytm, ptr %sTm, i32 0, i32 2
  %19 = load i32, ptr %tm_hour11, align 8
  %tm_min12 = getelementptr inbounds nuw %struct.Sytm, ptr %sTm, i32 0, i32 1
  %20 = load i32, ptr %tm_min12, align 4
  %tm_sec13 = getelementptr inbounds nuw %struct.Sytm, ptr %sTm, i32 0, i32 0
  %21 = load i32, ptr %tm_sec13, align 8
  %call14 = call i32 (ptr, ptr, ...) @ph7_value_string_format(ptr noundef %18, ptr noundef @.str.817, i32 noundef %19, i32 noundef %20, i32 noundef %21)
  ret void
}
