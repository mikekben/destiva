...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_lstat(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xlStat = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 23
  %7 = load ptr, ptr %xlStat, align 8
...
if.end19:                                         ; preds = %lor.lhs.false14
  ...
  %xlStat22 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %19, i32 0, i32 23
  %20 = load ptr, ptr %xlStat22, align 8
