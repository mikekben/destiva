...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_readdir(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xReadDir = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 7
  %16 = load ptr, ptr %xReadDir, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %call22 = call i32 @ph7_result_bool(ptr noundef %23, i32 noundef 0)
  %24 = load ptr, ptr %pStream, align 8
  %xReadDir23 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %24, i32 0, i32 7
  %25 = load ptr, ptr %xReadDir23, align 8
  %26 = load ptr, ptr %pDev, align 8
  %pHandle = getelementptr inbounds nuw %struct.io_private, ptr %26, i32 0, i32 1
  %27 = load ptr, ptr %pHandle, align 8
  %28 = load ptr, ptr %pCtx.addr, align 8
  %call24 = call i32 %25(ptr noundef %27, ptr noundef %28)
...
if.then26:                                        ; preds = %if.end21
  ...
  %call27 = call i32 @ph7_result_bool(ptr noundef %30, i32 noundef 0)
  br label %if.end28
