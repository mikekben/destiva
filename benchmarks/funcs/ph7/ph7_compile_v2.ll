...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_compile_v2(ptr noundef %pEngine, ptr noundef %zSource, i32 noundef %nLen, ptr noundef %ppOutVm, i32 noundef %iFlags) #0 {
entry:
...
if.end6:                                          ; preds = %if.then5, %if.end
  ...
  %call7 = call i32 @ProcessScript(ptr noundef %8, ptr noundef %9, ptr noundef %sScript, i32 noundef %10, ptr noundef null)
