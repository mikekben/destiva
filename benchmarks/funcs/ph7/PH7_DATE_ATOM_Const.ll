...
@.str.821 = external hidden unnamed_addr constant [14 x i8], align 1

; Function Attrs: nounwind uwtable
declare dso_local i32 @ph7_value_string(ptr noundef, ptr noundef, i32 noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @PH7_DATE_ATOM_Const(ptr noundef %pVal, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @ph7_value_string(ptr noundef %0, ptr noundef @.str.821, i32 noundef -1)
  ret void
}
