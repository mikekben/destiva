...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_array_add_intkey_elem(ptr noundef %pArray, i32 noundef %iKey, ptr noundef %pValue) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %4 = load i32, ptr %iKey.addr, align 4
  %conv = sext i32 %4 to i64
  %call = call i32 @PH7_MemObjInitFromInt(ptr noundef %3, ptr noundef %sKey, i64 noundef %conv)
  ...
  %call1 = call i32 @PH7_HashmapInsert(ptr noundef %6, ptr noundef %sKey, ptr noundef %7)
  store i32 %call1, ptr %rc, align 4
  %call2 = call i32 @PH7_MemObjRelease(ptr noundef %sKey)
