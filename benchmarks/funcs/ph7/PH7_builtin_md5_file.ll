...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_md5_file(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %zDigest = alloca [16 x i8], align 16
...
if.end22:                                         ; preds = %if.end15
  %call23 = call i32 @MD5Init(ptr noundef %sCtx)
  br label %for.cond

for.cond:                                         ; preds = %if.end27, %if.end22
  ...
  %call24 = call i64 %25(ptr noundef %26, ptr noundef %arraydecay, i64 noundef 8192)
  store i64 %call24, ptr %n, align 8
  %27 = load i64, ptr %n, align 8
  %cmp25 = icmp slt i64 %27, 1
...
if.end27:                                         ; preds = %for.cond
  %arraydecay28 = getelementptr inbounds [8192 x i8], ptr %zBuf, i64 0, i64 0
  %28 = load i64, ptr %n, align 8
  %conv = trunc i64 %28 to i32
  call void @MD5Update(ptr noundef %sCtx, ptr noundef %arraydecay28, i32 noundef %conv)
  br label %for.cond
...
for.end:                                          ; preds = %if.then26
  ...
  %arraydecay29 = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  call void @MD5Final(ptr noundef %arraydecay29, ptr noundef %sCtx)
...
if.then31:                                        ; preds = %for.end
  ...
  %arraydecay32 = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  %call33 = call i32 @ph7_result_string(ptr noundef %32, ptr noundef %arraydecay32, i32 noundef 16)
  br label %if.end36

if.else:                                          ; preds = %for.end
  %arraydecay34 = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  %33 = load ptr, ptr %pCtx.addr, align 8
  %call35 = call i32 @SyBinToHexConsumer(ptr noundef %arraydecay34, i32 noundef 16, ptr noundef @vfsHashConsumer, ptr noundef %33)
  br label %if.end36
...
return:                                           ; preds = %if.end36, %if.then19, %if.then7, %if.then
