...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_strglob(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false1
  ...
  %12 = load i32, ptr %iEsc, align 4
  %call10 = call i32 @Glob(ptr noundef %10, ptr noundef %11, i32 noundef %12, i32 noundef 0)
  store i32 %call10, ptr %rc, align 4
  %13 = load ptr, ptr %pCtx.addr, align 8
  %14 = load i32, ptr %rc, align 4
  %call11 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef %14)
  store i32 0, ptr %retval, align 4
  br label %return
