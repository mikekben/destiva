...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_vprintf(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %lor.lhs.false1, %lor.lhs.false, %entry
  ...
  %call5 = call i32 @ph7_result_int(ptr noundef %5, i32 noundef 0)
...
if.then9:                                         ; preds = %if.end
  ...
  %call10 = call i32 @ph7_result_int(ptr noundef %9, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
...
if.end11:                                         ; preds = %if.end
  ...
  %call14 = call i32 @PH7_InputFormat(ptr noundef @printfConsumer, ptr noundef %14, ptr noundef %15, i32 noundef %16, i32 noundef %17, ptr noundef %18, ptr noundef %nCounter, i32 noundef 1)
  %19 = load ptr, ptr %pCtx.addr, align 8
  %20 = load i64, ptr %nCounter, align 8
  %call15 = call i32 @ph7_result_int64(ptr noundef %19, i64 noundef %20)
  %call16 = call i32 @SySetRelease(ptr noundef %sArg)
  store i32 0, ptr %retval, align 4
  br label %return
