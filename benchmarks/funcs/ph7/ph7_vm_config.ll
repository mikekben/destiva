...
define dso_local i32 @ph7_vm_config(ptr noundef %pVm, i32 noundef %iConfigOp, ...) #1 {
entry:
  %retval = alloca i32, align 4
  %pVm.addr = alloca ptr, align 8
  %iConfigOp.addr = alloca i32, align 4
  %ap = alloca [1 x %struct.__va_list_tag], align 16
  %rc = alloca i32, align 4
  store ptr %pVm, ptr %pVm.addr, align 8
  store i32 %iConfigOp, ptr %iConfigOp.addr, align 4
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %4 = load i32, ptr %iConfigOp.addr, align 4
  %arraydecay2 = getelementptr inbounds [1 x %struct.__va_list_tag], ptr %ap, i64 0, i64 0
  %call = call i32 @PH7_VmConfigure(ptr noundef %3, i32 noundef %4, ptr noundef %arraydecay2)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @PH7_VmConfigure(ptr noundef, i32 noundef, ptr noundef) #1
