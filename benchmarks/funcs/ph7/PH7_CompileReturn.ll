...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_CompileReturn(ptr noundef %pGen) #0 {
entry:
...
if.end9:                                          ; preds = %if.end8, %land.lhs.true, %entry
  ...
  %14 = load i32, ptr %nRet, align 4
  %call10 = call i32 @PH7_VmEmitInstr(ptr noundef %13, i32 noundef 1, i32 noundef %14, i32 noundef 0, ptr noundef null, ptr noundef null)
