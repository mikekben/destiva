...
; Function Attrs: nounwind uwtable
define hidden void @PH7_VER_Const(ptr noundef %pVal, ptr noundef %pUnused) #0 {
entry:
  ...
  %call = call ptr @ph7_lib_signature()
  %call1 = call i32 @ph7_value_string(ptr noundef %0, ptr noundef %call, i32 noundef -1)
  ret void
}
