...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_values(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  store ptr %call12, ptr %pObj, align 8
...
if.then14:                                        ; preds = %for.body
  ...
  %call15 = call i32 @ph7_array_add_elem(ptr noundef %18, ptr noundef null, ptr noundef %19)
  br label %if.end16
...
if.end16:                                         ; preds = %if.then14, %for.body
  ...
  store ptr %21, ptr %pNode, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %call17 = call i32 @ph7_result_value(ptr noundef %23, ptr noundef %24)
  store i32 0, ptr %retval, align 4
  br label %return
