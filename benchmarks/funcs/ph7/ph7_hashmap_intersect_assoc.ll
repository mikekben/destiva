...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_intersect_assoc(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end25:                                         ; preds = %for.body
  ...
  %iType = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %30, i32 0, i32 1
  %31 = load i32, ptr %iType, align 8
...
if.then30:                                        ; preds = %if.end25
  ...
  %xKey = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %33, i32 0, i32 2
  %34 = load i64, ptr %xKey, align 8
  %call31 = call i32 @HashmapLookupIntKey(ptr noundef %32, i64 noundef %34, ptr noundef %pN1)
...
if.else:                                          ; preds = %if.end25
  ...
  %xKey32 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %36, i32 0, i32 2
  ...
  %xKey33 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %38, i32 0, i32 2
  %nByte = getelementptr inbounds nuw %struct.SyBlob, ptr %xKey33, i32 0, i32 2
  %39 = load i32, ptr %nByte, align 8
  %call34 = call i32 @HashmapLookupBlobKey(ptr noundef %35, ptr noundef %37, i32 noundef %39, ptr noundef %pN1)
...
if.then43:                                        ; preds = %lor.lhs.false41, %if.end38
  br label %for.end
...
for.end:                                          ; preds = %if.then43, %if.then37, %for.cond19
  %47 = load i32, ptr %i, align 4
  %48 = load i32, ptr %nArg.addr, align 4
  %cmp45 = icmp sge i32 %47, %48
  br i1 %cmp45, label %if.then46, label %if.end49

if.then46:                                        ; preds = %for.end
  %49 = load ptr, ptr %pArray, align 8
  %x47 = getelementptr inbounds nuw %struct.ph7_value, ptr %49, i32 0, i32 1
  %50 = load ptr, ptr %x47, align 8
  %51 = load ptr, ptr %pEntry, align 8
  %call48 = call i32 @HashmapInsertNode(ptr noundef %50, ptr noundef %51, i32 noundef 1)
  br label %if.end49
