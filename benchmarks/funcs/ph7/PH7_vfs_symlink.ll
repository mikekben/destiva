...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_symlink(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false8:                                   ; preds = %if.end
  ...
  %xLink = getelementptr inbounds nuw %struct.ph7_vfs, ptr %8, i32 0, i32 35
  %9 = load ptr, ptr %xLink, align 8
...
if.end14:                                         ; preds = %lor.lhs.false8
  ...
  store ptr %call16, ptr %zTarget, align 8
  ...
  store ptr %call18, ptr %zLink, align 8
  %17 = load ptr, ptr %pVfs, align 8
  %xLink19 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %17, i32 0, i32 35
  %18 = load ptr, ptr %xLink19, align 8
  %19 = load ptr, ptr %zTarget, align 8
  %20 = load ptr, ptr %zLink, align 8
  %call20 = call i32 %18(ptr noundef %19, ptr noundef %20, i32 noundef 1)
