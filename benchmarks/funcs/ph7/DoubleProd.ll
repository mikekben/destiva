...
; Function Attrs: nounwind uwtable
define hidden void @DoubleProd(ptr noundef %pCtx, ptr noundef %pMap) #0 {
entry:
  ...
  store double 1.000000e+00, ptr %dProd, align 8
...
if.then5:                                         ; preds = %if.then
  ...
  %13 = load double, ptr %dProd, align 8
  %mul = fmul double %13, %12
  store double %mul, ptr %dProd, align 8
  br label %if.end26
...
if.then9:                                         ; preds = %if.else
  ...
  %18 = load double, ptr %dProd, align 8
  %mul10 = fmul double %18, %conv
  store double %mul10, ptr %dProd, align 8
  br label %if.end25
...
if.then18:                                        ; preds = %if.then15
  ...
  %28 = load double, ptr %dProd, align 8
  %mul23 = fmul double %28, %27
  store double %mul23, ptr %dProd, align 8
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  ...
  %33 = load double, ptr %dProd, align 8
