...
; Function Attrs: nounwind uwtable
define hidden i32 @VmJsonArrayDecoder(ptr noundef %pCtx, ptr noundef %pKey, ptr noundef %pWorker, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @ph7_array_add_elem(ptr noundef %1, ptr noundef %2, ptr noundef %3)
