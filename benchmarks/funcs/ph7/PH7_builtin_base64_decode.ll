...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_base64_decode(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end5:                                          ; preds = %if.end
  ...
  %call6 = call i32 @SyBase64Decode(ptr noundef %6, i32 noundef %7, ptr noundef @Consumer, ptr noundef %8)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @SyBase64Decode(ptr noundef, i32 noundef, ptr noundef, ptr noundef) #0
