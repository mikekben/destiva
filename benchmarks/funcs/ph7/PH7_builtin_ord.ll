...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_ord(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = call i32 @ph7_result_int(ptr noundef %5, i32 noundef -1)
  store i32 0, ptr %retval, align 4
  br label %return
...
if.end5:                                          ; preds = %if.end
  ...
  %call7 = call i32 @ph7_result_int(ptr noundef %8, i32 noundef %9)
  store i32 0, ptr %retval, align 4
  br label %return
