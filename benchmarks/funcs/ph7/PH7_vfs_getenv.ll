...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_getenv(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  %retval = alloca i32, align 4
  %pCtx.addr = alloca ptr, align 8
  %nArg.addr = alloca i32, align 4
  %apArg.addr = alloca ptr, align 8
  %zEnv = alloca ptr, align 8
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xGetenv = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 30
  %7 = load ptr, ptr %xGetenv, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %call12 = call ptr @ph7_value_to_string(ptr noundef %12, ptr noundef %iLen)
  store ptr %call12, ptr %zEnv, align 8
  %13 = load ptr, ptr %pCtx.addr, align 8
  %call13 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef 0)
...
if.end16:                                         ; preds = %if.end10
  ...
  %xGetenv17 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %15, i32 0, i32 30
  %16 = load ptr, ptr %xGetenv17, align 8
  %17 = load ptr, ptr %zEnv, align 8
