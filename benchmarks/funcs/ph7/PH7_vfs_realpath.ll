...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_realpath(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xRealpath = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 9
  %7 = load ptr, ptr %xRealpath, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %call13 = call ptr @ph7_value_to_string(ptr noundef %13, ptr noundef null)
  store ptr %call13, ptr %zPath, align 8
  %14 = load ptr, ptr %pVfs, align 8
  %xRealpath14 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %14, i32 0, i32 9
  %15 = load ptr, ptr %xRealpath14, align 8
...
if.then17:                                        ; preds = %if.end10
  ...
  %call18 = call i32 @ph7_result_bool(ptr noundef %19, i32 noundef 0)
  br label %if.end19
