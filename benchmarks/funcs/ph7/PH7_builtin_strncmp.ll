...
; Function Attrs: nounwind uwtable
declare hidden i32 @PH7_builtin_strcmp(ptr noundef, i32 noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_strncmp(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 @PH7_builtin_strcmp(ptr noundef %1, i32 noundef %2, ptr noundef %3)
...
if.end5:                                          ; preds = %if.end
  ...
  %call10 = call i32 @SyStrncmp(ptr noundef %12, ptr noundef %13, i32 noundef %14)
