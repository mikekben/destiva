...
; Function Attrs: nounwind uwtable
define hidden i32 @VmXMLEndElementHandler(ptr noundef %pEnd, ptr noundef %pNS, ptr noundef %pUserData) #0 {
entry:
  ...
  %arrayidx = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 1
...
if.end3:                                          ; preds = %if.end
  ...
  %pVm4 = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %9, i32 0, i32 0
  %10 = load ptr, ptr %pVm4, align 8
  %11 = load ptr, ptr %pCallback, align 8
  %12 = load ptr, ptr %pEngine, align 8
  %sParserValue = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %12, i32 0, i32 4
  %13 = load ptr, ptr %pTag, align 8
  %call5 = call i32 (ptr, ptr, ptr, ...) @PH7_VmCallUserFunctionAp(ptr noundef %10, ptr noundef %11, ptr noundef null, ptr noundef %sParserValue, ptr noundef %13, i32 noundef 0)
  %14 = load ptr, ptr %pEngine, align 8
  %pCtx = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %14, i32 0, i32 1
  %15 = load ptr, ptr %pCtx, align 8
  %16 = load ptr, ptr %pTag, align 8
  call void @ph7_context_release_value(ptr noundef %15, ptr noundef %16)
  store i32 0, ptr %retval, align 4
  br label %return
