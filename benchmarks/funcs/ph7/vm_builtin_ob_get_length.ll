...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_get_length(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %nByte = getelementptr inbounds nuw %struct.SyBlob, ptr %sOB, i32 0, i32 2
  %7 = load i32, ptr %nByte, align 8
  %conv = zext i32 %7 to i64
  %call3 = call i32 @ph7_result_int64(ptr noundef %5, i64 noundef %conv)
  br label %if.end
