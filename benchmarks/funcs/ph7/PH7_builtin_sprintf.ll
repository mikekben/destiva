...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_sprintf(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end7:                                          ; preds = %if.end
  ...
  %call8 = call i32 @PH7_InputFormat(ptr noundef @sprintfConsumer, ptr noundef %8, ptr noundef %9, i32 noundef %10, i32 noundef %11, ptr noundef %12, ptr noundef null, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
