...
define hidden i32 @SyStrnmicmp(ptr noundef %pLeft, ptr noundef %pRight, i32 noundef %SLen) #0 {
entry:
  ...
  %call = call i32 @SyStrnicmp(ptr noundef %0, ptr noundef %1, i32 noundef %2)
  ret i32 %call
}
