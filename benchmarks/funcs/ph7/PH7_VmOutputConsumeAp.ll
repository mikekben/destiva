...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_VmOutputConsumeAp(ptr noundef %pVm, ptr noundef %zFormat, ptr noundef %ap) #0 {
entry:
  ...
  %call = call i32 @SyBlobInit(ptr noundef %sWorker, ptr noundef %sAllocator)
  %2 = load ptr, ptr %zFormat.addr, align 8
  %3 = load ptr, ptr %ap.addr, align 8
  %call1 = call i32 @SyBlobFormatAp(ptr noundef %sWorker, ptr noundef %2, ptr noundef %3)
...
if.then:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr %xConsumer, align 8
  %pBlob = getelementptr inbounds nuw %struct.SyBlob, ptr %sWorker, i32 0, i32 1
  %7 = load ptr, ptr %pBlob, align 8
  %nByte2 = getelementptr inbounds nuw %struct.SyBlob, ptr %sWorker, i32 0, i32 2
  ...
  %call3 = call i32 %6(ptr noundef %7, i32 noundef %8, ptr noundef %10)
  store i32 %call3, ptr %rc, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %11 = load ptr, ptr %pCons, align 8
  %xConsumer4 = getelementptr inbounds nuw %struct.ph7_output_consumer, ptr %11, i32 0, i32 0
  %12 = load ptr, ptr %xConsumer4, align 8
  %cmp5 = icmp ne ptr %12, @VmObConsumer
  br i1 %cmp5, label %if.then6, label %if.end8

if.then6:                                         ; preds = %if.end
  %nByte7 = getelementptr inbounds nuw %struct.SyBlob, ptr %sWorker, i32 0, i32 2
  %13 = load i32, ptr %nByte7, align 8
...
if.end8:                                          ; preds = %if.then6, %if.end
  %call9 = call i32 @SyBlobRelease(ptr noundef %sWorker)
