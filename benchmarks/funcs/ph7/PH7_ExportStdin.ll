...
; Function Attrs: nounwind uwtable
define hidden ptr @PH7_ExportStdin(ptr noundef %pVm) #0 {
entry:
  ...
  %pStdin = getelementptr inbounds nuw %struct.ph7_vm, ptr %0, i32 0, i32 30
  %1 = load ptr, ptr %pStdin, align 8
...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call ptr @PHPStreamDataInit(ptr noundef %6, i32 noundef 1)
  ...
  %pStdin4 = getelementptr inbounds nuw %struct.ph7_vm, ptr %9, i32 0, i32 30
  store ptr %8, ptr %pStdin4, align 8
...
if.else:                                          ; preds = %entry
  ...
  %pStdin5 = getelementptr inbounds nuw %struct.ph7_vm, ptr %11, i32 0, i32 30
  %12 = load ptr, ptr %pStdin5, align 8
