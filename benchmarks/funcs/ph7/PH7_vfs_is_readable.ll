...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_is_readable(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xReadable = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 26
  %7 = load ptr, ptr %xReadable, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xReadable13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 26
  %14 = load ptr, ptr %xReadable13, align 8
