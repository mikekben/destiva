...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_usort(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then4:                                         ; preds = %if.end
  ...
  store ptr @HashmapCmpCallback4, ptr %xCmp, align 8
...
if.else:                                          ; preds = %land.lhs.true, %if.then4
  store ptr @HashmapCmpCallback1, ptr %xCmp, align 8
  br label %if.end11
...
if.end11:                                         ; preds = %if.else, %if.then9
  ...
  call void @HashmapSortRehash(ptr noundef %17)
  br label %if.end13

if.end13:                                         ; preds = %if.end11, %if.end
  %18 = load ptr, ptr %pCtx.addr, align 8
  %call14 = call i32 @ph7_result_bool(ptr noundef %18, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @HashmapCmpCallback4(ptr noundef, ptr noundef, ptr noundef) #0
