...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_ftruncate(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xTrunc = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 13
  %16 = load ptr, ptr %xTrunc, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %xTrunc22 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %23, i32 0, i32 13
  %24 = load ptr, ptr %xTrunc22, align 8
  ...
  %call24 = call i64 @ph7_value_to_int64(ptr noundef %28)
  %call25 = call i32 %24(ptr noundef %26, i64 noundef %call24)
...
if.then27:                                        ; preds = %if.end21
  ...
  call void @ResetIOPrivate(ptr noundef %30)
  br label %if.end28
...
if.end28:                                         ; preds = %if.then27, %if.end21
  ...
  %call30 = call i32 @ph7_result_bool(ptr noundef %31, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
