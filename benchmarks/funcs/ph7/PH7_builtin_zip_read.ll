...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_zip_read(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  store ptr %call4, ptr %pArchive, align 8
  %7 = load ptr, ptr %pArchive, align 8
  %cmp5 = icmp eq ptr %7, null
  br i1 %cmp5, label %if.then8, label %lor.lhs.false6

lor.lhs.false6:                                   ; preds = %if.end
  %8 = load ptr, ptr %pArchive, align 8
  %nMagic = getelementptr inbounds nuw %struct.SyArchive, ptr %8, i32 0, i32 12
...
if.then8:                                         ; preds = %lor.lhs.false6, %if.end
  ...
  %call9 = call i32 @ph7_context_throw_error(ptr noundef %10, i32 noundef 1, ptr noundef @.str.1230)
...
if.end11:                                         ; preds = %lor.lhs.false6
  %12 = load ptr, ptr %pArchive, align 8
  %call12 = call i32 @SyArchiveGetNextEntry(ptr noundef %12, ptr noundef %pNext)
...
if.else:                                          ; preds = %if.end11
  ...
  %call16 = call i32 @ph7_result_resource(ptr noundef %15, ptr noundef %16)
  ...
  %pUserData = getelementptr inbounds nuw %struct.SyArchiveEntry, ptr %18, i32 0, i32 16
  store ptr %arrayidx17, ptr %pUserData, align 8
  br label %if.end18
...
; Function Attrs: nounwind uwtable
declare hidden i32 @SyArchiveGetNextEntry(ptr noundef, ptr noundef) #0
