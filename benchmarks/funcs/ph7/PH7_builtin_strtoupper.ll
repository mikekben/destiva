...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_strtoupper(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #1 {
entry:
...
if.then30:                                        ; preds = %if.else
  ...
  %call33 = call i32 @toupper(i32 noundef %conv32) #4
