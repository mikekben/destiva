...
; Function Attrs: nounwind uwtable
define hidden ptr @ExtractClassAttrValue(ptr noundef %pVm, ptr noundef %pAttr) #0 {
entry:
  ...
  %nIdx = getelementptr inbounds nuw %struct.VmClassAttr, ptr %1, i32 0, i32 1
  %2 = load i32, ptr %nIdx, align 8
  %call = call ptr @SySetAt(ptr noundef %aMemObj, i32 noundef %2)
