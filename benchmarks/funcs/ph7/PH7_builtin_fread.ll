...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fread(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end19:                                         ; preds = %if.end11
  store i32 4096, ptr %nLen, align 4
...
if.then21:                                        ; preds = %if.end19
  ...
  %call23 = call i32 @ph7_value_to_int(ptr noundef %23)
  store i32 %call23, ptr %nLen, align 4
  %24 = load i32, ptr %nLen, align 4
  %cmp24 = icmp slt i32 %24, 1
...
if.end27:                                         ; preds = %if.end26, %if.end19
  ...
  %call28 = call ptr @ph7_context_alloc_chunk(ptr noundef %25, i32 noundef %26, i32 noundef 0, i32 noundef 0)
  store ptr %call28, ptr %pBuf, align 8
  %27 = load ptr, ptr %pBuf, align 8
  %cmp29 = icmp eq ptr %27, null
  br i1 %cmp29, label %if.then30, label %if.end33

if.then30:                                        ; preds = %if.end27
  %28 = load ptr, ptr %pCtx.addr, align 8
  %call31 = call i32 @ph7_context_throw_error(ptr noundef %28, i32 noundef 1, ptr noundef @.str.536)
  %29 = load ptr, ptr %pCtx.addr, align 8
  %call32 = call i32 @ph7_result_bool(ptr noundef %29, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return

if.end33:                                         ; preds = %if.end27
  %30 = load ptr, ptr %pDev, align 8
  %31 = load ptr, ptr %pBuf, align 8
  %32 = load i32, ptr %nLen, align 4
  %conv = sext i32 %32 to i64
  %call34 = call i64 @StreamRead(ptr noundef %30, ptr noundef %31, i64 noundef %conv)
  store i64 %call34, ptr %nRead, align 8
  %33 = load i64, ptr %nRead, align 8
  %cmp35 = icmp slt i64 %33, 1
  br i1 %cmp35, label %if.then37, label %if.else

if.then37:                                        ; preds = %if.end33
  %34 = load ptr, ptr %pCtx.addr, align 8
  %call38 = call i32 @ph7_result_bool(ptr noundef %34, i32 noundef 0)
  br label %if.end41
...
if.else:                                          ; preds = %if.end33
  ...
  %conv39 = trunc i64 %37 to i32
  %call40 = call i32 @ph7_result_string(ptr noundef %35, ptr noundef %36, i32 noundef %conv39)
  br label %if.end41

if.end41:                                         ; preds = %if.else, %if.then37
  %38 = load ptr, ptr %pCtx.addr, align 8
  %39 = load ptr, ptr %pBuf, align 8
  call void @ph7_context_free_chunk(ptr noundef %38, ptr noundef %39)
  store i32 0, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end41, %if.then30, %cond.end, %if.then8, %if.then
  %40 = load i32, ptr %retval, align 4
  ret i32 %40
}

; Function Attrs: nounwind uwtable
declare hidden i64 @StreamRead(ptr noundef, ptr noundef, i64 noundef) #0
