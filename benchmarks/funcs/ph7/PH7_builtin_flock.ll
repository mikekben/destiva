...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_flock(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xLock = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 10
  %16 = load ptr, ptr %xLock, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %call23 = call i32 @ph7_value_to_int(ptr noundef %24)
  store i32 %call23, ptr %nLock, align 4
  %25 = load ptr, ptr %pStream, align 8
  %xLock24 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %25, i32 0, i32 10
  %26 = load ptr, ptr %xLock24, align 8
  ...
  %29 = load i32, ptr %nLock, align 4
  %call25 = call i32 %26(ptr noundef %28, i32 noundef %29)
  ...
  %call27 = call i32 @ph7_result_bool(ptr noundef %30, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
