...
; Function Attrs: nounwind uwtable
define hidden ptr @PH7_ExportStderr(ptr noundef %pVm) #0 {
entry:
  %retval = alloca ptr, align 8
  %pVm.addr = alloca ptr, align 8
  %pErr = alloca ptr, align 8
  store ptr %pVm, ptr %pVm.addr, align 8
  %0 = load ptr, ptr %pVm.addr, align 8
  %pStderr = getelementptr inbounds nuw %struct.ph7_vm, ptr %0, i32 0, i32 32
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr %pErr, align 8
  %3 = load ptr, ptr %pErr, align 8
...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call ptr @PHPStreamDataInit(ptr noundef %6, i32 noundef 3)
  ...
  %pStderr4 = getelementptr inbounds nuw %struct.ph7_vm, ptr %9, i32 0, i32 32
  store ptr %8, ptr %pStderr4, align 8
  %10 = load ptr, ptr %pErr, align 8
  store ptr %10, ptr %retval, align 8
  br label %return

if.else:                                          ; preds = %entry
  %11 = load ptr, ptr %pVm.addr, align 8
  %pStderr5 = getelementptr inbounds nuw %struct.ph7_vm, ptr %11, i32 0, i32 32
  %12 = load ptr, ptr %pStderr5, align 8
