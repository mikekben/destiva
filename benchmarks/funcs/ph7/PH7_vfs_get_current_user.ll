...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_get_current_user(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %xUsername = getelementptr inbounds nuw %struct.ph7_vfs, ptr %2, i32 0, i32 41
  %3 = load ptr, ptr %xUsername, align 8
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call4 = call i32 @ph7_result_string(ptr noundef %6, ptr noundef @.str.21, i32 noundef 7)
  store i32 0, ptr %retval, align 4
  br label %return

if.end:                                           ; preds = %lor.lhs.false
  %7 = load ptr, ptr %pVfs, align 8
  %xUsername5 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %7, i32 0, i32 41
  %8 = load ptr, ptr %xUsername5, align 8
