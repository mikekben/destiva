...
@.str.602 = external hidden unnamed_addr constant [6 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_parser_get_option(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end9:                                          ; preds = %lor.lhs.false5
  ...
  %call11 = call i32 @ph7_value_to_int(ptr noundef %11)
  store i32 %call11, ptr %nOp, align 4
  %12 = load i32, ptr %nOp, align 4
...
sw.bb:                                            ; preds = %if.end9, %if.end9, %if.end9
  ...
  %call12 = call i32 @ph7_result_int(ptr noundef %13, i32 noundef 0)
  br label %sw.epilog

sw.bb13:                                          ; preds = %if.end9
  %14 = load ptr, ptr %pCtx.addr, align 8
  %call14 = call i32 @ph7_result_string(ptr noundef %14, ptr noundef @.str.602, i32 noundef 5)
  br label %sw.epilog
