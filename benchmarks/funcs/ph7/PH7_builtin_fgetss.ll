...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fgetss(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
land.lhs.true:                                    ; preds = %if.else
  ...
  %arrayidx30 = getelementptr inbounds ptr, ptr %29, i64 2
  %30 = load ptr, ptr %arrayidx30, align 8
  %call31 = call i32 @ph7_value_is_string(ptr noundef %30)
  %tobool32 = icmp ne i32 %call31, 0
  br i1 %tobool32, label %if.then33, label %if.end36

if.then33:                                        ; preds = %land.lhs.true
  %31 = load ptr, ptr %apArg.addr, align 8
  %arrayidx34 = getelementptr inbounds ptr, ptr %31, i64 2
  %32 = load ptr, ptr %arrayidx34, align 8
  %call35 = call ptr @ph7_value_to_string(ptr noundef %32, ptr noundef %nTaglen)
  store ptr %call35, ptr %zTaglist, align 8
  br label %if.end36

if.end36:                                         ; preds = %if.then33, %land.lhs.true, %if.else
  %33 = load ptr, ptr %pCtx.addr, align 8
  %34 = load ptr, ptr %zLine, align 8
  %35 = load i64, ptr %n, align 8
  %conv = trunc i64 %35 to i32
  %36 = load ptr, ptr %zTaglist, align 8
  %37 = load i32, ptr %nTaglen, align 4
  %call37 = call i32 @PH7_StripTagsFromString(ptr noundef %33, ptr noundef %34, i32 noundef %conv, ptr noundef %36, i32 noundef %37)
  br label %if.end38

if.end38:                                         ; preds = %if.end36, %if.then27
  store i32 0, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end38, %cond.end, %if.then8, %if.then
