...
; Function Attrs: nounwind uwtable
define hidden void @PH7_XML_OPTION_TARGET_ENCODING_Const(ptr noundef %pVal, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @ph7_value_int(ptr noundef %0, i32 noundef 32)
  ret void
}
