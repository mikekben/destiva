...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_getcwd(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %xGetcwd = getelementptr inbounds nuw %struct.ph7_vfs, ptr %2, i32 0, i32 4
  %3 = load ptr, ptr %xGetcwd, align 8
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call3 = call i32 (ptr, i32, ptr, ...) @ph7_context_throw_error_format(ptr noundef %4, i32 noundef 2, ptr noundef @.str.1218, ptr noundef %call2)
  %6 = load ptr, ptr %pCtx.addr, align 8
  %call4 = call i32 @ph7_result_bool(ptr noundef %6, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return

if.end:                                           ; preds = %lor.lhs.false
  %7 = load ptr, ptr %pCtx.addr, align 8
  %call5 = call i32 @ph7_result_string(ptr noundef %7, ptr noundef @.str.4, i32 noundef 0)
  %8 = load ptr, ptr %pVfs, align 8
  %xGetcwd6 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %8, i32 0, i32 4
  %9 = load ptr, ptr %xGetcwd6, align 8
  %10 = load ptr, ptr %pCtx.addr, align 8
  %call7 = call i32 %9(ptr noundef %10)
...
if.then9:                                         ; preds = %if.end
  ...
  %call10 = call i32 @ph7_result_bool(ptr noundef %12, i32 noundef 0)
  br label %if.end11
