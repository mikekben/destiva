...
; Function Attrs: nounwind uwtable
define hidden ptr @HashmapExtractNodeValue(ptr noundef %pNode) #0 {
entry:
  ...
  %nValIdx = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %3, i32 0, i32 5
  %4 = load i32, ptr %nValIdx, align 8
  %call = call ptr @SySetAt(ptr noundef %aMemObj, i32 noundef %4)
