...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_key_exists(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end4:                                          ; preds = %if.end
  ...
  %call7 = call i32 @PH7_HashmapLookup(ptr noundef %7, ptr noundef %9, ptr noundef null)
  ...
  %call9 = call i32 @ph7_result_bool(ptr noundef %10, i32 noundef %cond)
  store i32 0, ptr %retval, align 4
  br label %return
