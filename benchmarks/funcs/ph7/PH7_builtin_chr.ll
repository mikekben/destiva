...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_chr(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @ph7_result_string(ptr noundef %4, ptr noundef %c, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
