...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ph7_version(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %call = call i32 @ph7_result_string(ptr noundef %0, ptr noundef @.str, i32 noundef 5)
  ret i32 0
}
