...
define hidden i32 @SySetTruncate(ptr noundef %pSet, i32 noundef %nNewSize) #0 {
entry:
  %pSet.addr = alloca ptr, align 8
  %nNewSize.addr = alloca i32, align 4
  store ptr %pSet, ptr %pSet.addr, align 8
  store i32 %nNewSize, ptr %nNewSize.addr, align 4
  %0 = load i32, ptr %nNewSize.addr, align 4
