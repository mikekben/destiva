...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_get_declared_classes(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then10:                                        ; preds = %while.body
  ...
  %sName11 = getelementptr inbounds nuw %struct.ph7_class, ptr %16, i32 0, i32 2
  %nByte = getelementptr inbounds nuw %struct.SyString, ptr %sName11, i32 0, i32 1
  %17 = load i32, ptr %nByte, align 8
  %call12 = call i32 @ph7_value_string(ptr noundef %13, ptr noundef %15, i32 noundef %17)
  %18 = load ptr, ptr %pArray, align 8
  %19 = load ptr, ptr %pName, align 8
  %call13 = call i32 @ph7_array_add_elem(ptr noundef %18, ptr noundef null, ptr noundef %19)
  %20 = load ptr, ptr %pName, align 8
  %call14 = call i32 @ph7_value_reset_string_cursor(ptr noundef %20)
  br label %if.end15

if.end15:                                         ; preds = %if.then10, %while.body
  br label %while.cond, !llvm.loop !6

while.end:                                        ; preds = %while.cond
  %21 = load ptr, ptr %pCtx.addr, align 8
  %22 = load ptr, ptr %pArray, align 8
  %call16 = call i32 @ph7_result_value(ptr noundef %21, ptr noundef %22)
  store i32 0, ptr %retval, align 4
  br label %return
