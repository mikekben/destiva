...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_print_r(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then8:                                         ; preds = %if.end5
  ...
  %call10 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef 1)
  br label %if.end14
