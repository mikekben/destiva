...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_flush(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @VmObFlush(ptr noundef %4, ptr noundef %5, i32 noundef 0)
