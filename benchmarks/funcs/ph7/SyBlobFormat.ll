...
define hidden i32 @SyBlobFormat(ptr noundef %pBlob, ptr noundef %zFormat, ...) #1 {
entry:
  ...
  %call = call i32 @FormatMount(i32 noundef 6, ptr noundef %0, ptr noundef null, ptr noundef null, ptr noundef %n, ptr noundef %1, ptr noundef %arraydecay1)
