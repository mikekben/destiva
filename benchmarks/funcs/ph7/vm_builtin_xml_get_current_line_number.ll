...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_get_current_line_number(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end9:                                          ; preds = %lor.lhs.false5
  ...
  %nLine = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %11, i32 0, i32 9
  %12 = load i32, ptr %nLine, align 8
