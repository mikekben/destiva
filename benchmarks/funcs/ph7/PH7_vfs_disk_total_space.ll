...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_disk_total_space(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xTotalSpace = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 17
  %7 = load ptr, ptr %xTotalSpace, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xTotalSpace13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 17
  %14 = load ptr, ptr %xTotalSpace13, align 8
  %15 = load ptr, ptr %zPath, align 8
  %call14 = call i64 %14(ptr noundef %15)
  store i64 %call14, ptr %iSize, align 8
  %16 = load ptr, ptr %pCtx.addr, align 8
  %17 = load i64, ptr %iSize, align 8
