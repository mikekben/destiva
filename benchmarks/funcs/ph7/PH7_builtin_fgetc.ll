...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fgetc(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end19:                                         ; preds = %if.end11
  ...
  %call20 = call i64 @StreamRead(ptr noundef %21, ptr noundef %c, i64 noundef 1)
...
if.else:                                          ; preds = %if.end19
  ...
  %call25 = call i32 @ph7_result_string(ptr noundef %24, ptr noundef %c, i32 noundef 1)
  br label %if.end26
