...
@.str.961 = external hidden unnamed_addr constant [3 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_dechex(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  store i32 %call1, ptr %iVal, align 4
  %4 = load ptr, ptr %pCtx.addr, align 8
  %5 = load i32, ptr %iVal, align 4
  %call2 = call i32 (ptr, ptr, ...) @ph7_result_string_format(ptr noundef %4, ptr noundef @.str.961, i32 noundef %5)
  store i32 0, ptr %retval, align 4
  br label %return
