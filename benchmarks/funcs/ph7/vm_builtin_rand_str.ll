...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_rand_str(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  %pCtx.addr = alloca ptr, align 8
  %nArg.addr = alloca i32, align 4
  %apArg.addr = alloca ptr, align 8
  %zString = alloca [1024 x i8], align 16
  %iLen = alloca i32, align 4
  store ptr %pCtx, ptr %pCtx.addr, align 8
  store i32 %nArg, ptr %nArg.addr, align 4
  store ptr %apArg, ptr %apArg.addr, align 8
  store i32 16, ptr %iLen, align 4
...
if.end4:                                          ; preds = %if.end, %entry
  ...
  %arraydecay = getelementptr inbounds [1024 x i8], ptr %zString, i64 0, i64 0
  %7 = load i32, ptr %iLen, align 4
  call void @PH7_VmRandomString(ptr noundef %6, ptr noundef %arraydecay, i32 noundef %7)
  %8 = load ptr, ptr %pCtx.addr, align 8
  %arraydecay5 = getelementptr inbounds [1024 x i8], ptr %zString, i64 0, i64 0
  %9 = load i32, ptr %iLen, align 4
  %call6 = call i32 @ph7_result_string(ptr noundef %8, ptr noundef %arraydecay5, i32 noundef %9)
  ret i32 0
}
