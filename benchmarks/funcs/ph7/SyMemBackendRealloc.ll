...
define hidden ptr @SyMemBackendRealloc(ptr noundef %pBackend, ptr noundef %pOld, i32 noundef %nByte) #0 {
entry:
...
if.end5:                                          ; preds = %if.end, %entry
  ...
  %11 = load i32, ptr %nByte.addr, align 4
  %call = call ptr @MemBackendRealloc(ptr noundef %9, ptr noundef %10, i32 noundef %11)
  store ptr %call, ptr %pChunk, align 8
  %12 = load ptr, ptr %pBackend.addr, align 8
  %pMutexMethods6 = getelementptr inbounds nuw %struct.SyMemBackend, ptr %12, i32 0, i32 0
  %13 = load ptr, ptr %pMutexMethods6, align 8
  %tobool7 = icmp ne ptr %13, null
  br i1 %tobool7, label %if.then8, label %if.end15

if.then8:                                         ; preds = %if.end5
  %14 = load ptr, ptr %pBackend.addr, align 8
  %pMutex9 = getelementptr inbounds nuw %struct.SyMemBackend, ptr %14, i32 0, i32 6
  %15 = load ptr, ptr %pMutex9, align 8
  %tobool10 = icmp ne ptr %15, null
  br i1 %tobool10, label %if.then11, label %if.end14

if.then11:                                        ; preds = %if.then8
  %16 = load ptr, ptr %pBackend.addr, align 8
  %pMutexMethods12 = getelementptr inbounds nuw %struct.SyMemBackend, ptr %16, i32 0, i32 0
  %17 = load ptr, ptr %pMutexMethods12, align 8
  ...
  %pMutex13 = getelementptr inbounds nuw %struct.SyMemBackend, ptr %19, i32 0, i32 6
  %20 = load ptr, ptr %pMutex13, align 8
...
if.end15:                                         ; preds = %if.end14, %if.end5
  %21 = load ptr, ptr %pChunk, align 8
  ret ptr %21
}

; Function Attrs: nounwind uwtable
declare hidden ptr @MemBackendRealloc(ptr noundef, ptr noundef, i32 noundef) #0
