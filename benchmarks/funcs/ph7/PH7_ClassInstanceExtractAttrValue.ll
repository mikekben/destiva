...
define hidden ptr @PH7_ClassInstanceExtractAttrValue(ptr noundef %pThis, ptr noundef %pAttr) #0 {
entry:
  ...
  %pVm = getelementptr inbounds nuw %struct.ph7_class_instance, ptr %0, i32 0, i32 0
  %1 = load ptr, ptr %pVm, align 8
  %2 = load ptr, ptr %pAttr.addr, align 8
  %call = call ptr @ExtractClassAttrValue(ptr noundef %1, ptr noundef %2)
