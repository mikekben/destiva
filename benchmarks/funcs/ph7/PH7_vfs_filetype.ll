...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_filetype(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call1 = call i32 @ph7_result_string(ptr noundef %3, ptr noundef @.str.21, i32 noundef 7)
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xFiletype = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 29
  %7 = load ptr, ptr %xFiletype, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %call13 = call i32 @ph7_result_string(ptr noundef %13, ptr noundef @.str.4, i32 noundef 0)
  %14 = load ptr, ptr %pVfs, align 8
  %xFiletype14 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %14, i32 0, i32 29
  %15 = load ptr, ptr %xFiletype14, align 8
  %16 = load ptr, ptr %zPath, align 8
  %17 = load ptr, ptr %pCtx.addr, align 8
  %call15 = call i32 %15(ptr noundef %16, ptr noundef %17)
  store i32 0, ptr %retval, align 4
  br label %return
