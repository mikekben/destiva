...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fpassthru(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end23:                                         ; preds = %for.cond
  ...
  %arraydecay24 = getelementptr inbounds [8192 x i8], ptr %zBuf, i64 0, i64 0
  %26 = load i64, ptr %nRead, align 8
  %conv = trunc i64 %26 to i32
  %call25 = call i32 @ph7_context_output(ptr noundef %25, ptr noundef %arraydecay24, i32 noundef %conv)
  store i32 %call25, ptr %rc, align 4
  %27 = load i32, ptr %rc, align 4
  %cmp26 = icmp eq i32 %27, -10
...
for.end:                                          ; preds = %if.then28, %if.then22
  ...
  %call30 = call i32 @ph7_result_int64(ptr noundef %28, i64 noundef %29)
  store i32 0, ptr %retval, align 4
  br label %return
