...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_set_default_handler(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then11:                                        ; preds = %if.end9
  ...
  %arrayidx13 = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 4
