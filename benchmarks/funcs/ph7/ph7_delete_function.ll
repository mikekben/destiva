...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_delete_function(ptr noundef %pVm, ptr noundef %zName) #0 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %hHostFunction = getelementptr inbounds nuw %struct.ph7_vm, ptr %3, i32 0, i32 12
  %4 = load ptr, ptr %zName.addr, align 8
  %5 = load ptr, ptr %zName.addr, align 8
  %call = call i32 @SyStrlen(ptr noundef %5)
  %call2 = call i32 @SyHashDeleteEntry(ptr noundef %hHostFunction, ptr noundef %4, i32 noundef %call, ptr noundef %pFunc)
...
if.then4:                                         ; preds = %if.end
  ...
  %aAux = getelementptr inbounds nuw %struct.ph7_user_func, ptr %7, i32 0, i32 4
  %call5 = call i32 @SySetRelease(ptr noundef %aAux)
  %8 = load ptr, ptr %pVm.addr, align 8
  %sAllocator = getelementptr inbounds nuw %struct.ph7_vm, ptr %8, i32 0, i32 0
  %9 = load ptr, ptr %pFunc, align 8
  %sName = getelementptr inbounds nuw %struct.ph7_user_func, ptr %9, i32 0, i32 1
  %zString = getelementptr inbounds nuw %struct.SyString, ptr %sName, i32 0, i32 0
  %10 = load ptr, ptr %zString, align 8
  %call6 = call i32 @SyMemBackendFree(ptr noundef %sAllocator, ptr noundef %10)
  %11 = load ptr, ptr %pVm.addr, align 8
  %sAllocator7 = getelementptr inbounds nuw %struct.ph7_vm, ptr %11, i32 0, i32 0
  %12 = load ptr, ptr %pFunc, align 8
  %call8 = call i32 @SyMemBackendPoolFree(ptr noundef %sAllocator7, ptr noundef %12)
  br label %if.end9
