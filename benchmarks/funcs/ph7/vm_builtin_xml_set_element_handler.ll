...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_set_element_handler(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then11:                                        ; preds = %if.end9
  ...
  %arrayidx12 = getelementptr inbounds ptr, ptr %11, i64 1
  %12 = load ptr, ptr %arrayidx12, align 8
  %13 = load ptr, ptr %pEngine, align 8
  %aCB = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %13, i32 0, i32 3
  %arrayidx13 = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 0
  %call14 = call i32 @PH7_MemObjStore(ptr noundef %12, ptr noundef %arrayidx13)
...
if.then16:                                        ; preds = %if.then11
  ...
  %arrayidx17 = getelementptr inbounds ptr, ptr %15, i64 2
  %16 = load ptr, ptr %arrayidx17, align 8
  %17 = load ptr, ptr %pEngine, align 8
  %aCB18 = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %17, i32 0, i32 3
  %arrayidx19 = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB18, i64 0, i64 1
  %call20 = call i32 @PH7_MemObjStore(ptr noundef %16, ptr noundef %arrayidx19)
  br label %if.end21
...
if.end22:                                         ; preds = %if.end21, %if.end9
  ...
  %call23 = call i32 @ph7_result_bool(ptr noundef %18, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
