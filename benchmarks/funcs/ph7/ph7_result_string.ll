...
define dso_local i32 @ph7_result_string(ptr noundef %pCtx, ptr noundef %zString, i32 noundef %nLen) #0 {
entry:
  ...
  %call = call i32 @ph7_value_string(ptr noundef %1, ptr noundef %2, i32 noundef %3)
  ret i32 %call
}
