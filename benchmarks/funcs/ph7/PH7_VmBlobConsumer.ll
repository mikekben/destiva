...
define hidden i32 @PH7_VmBlobConsumer(ptr noundef %pOut, i32 noundef %nLen, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @SyBlobAppend(ptr noundef %0, ptr noundef %1, i32 noundef %2)
