...
@.str.510 = external hidden unnamed_addr constant [10 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_get_resource_type(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %call3 = call i32 (ptr, ptr, ...) @ph7_result_string_format(ptr noundef %4, ptr noundef @.str.510, ptr noundef %7)
  store i32 0, ptr %retval, align 4
  br label %return
