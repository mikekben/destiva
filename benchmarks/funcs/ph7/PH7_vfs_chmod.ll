...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_chmod(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xChmod = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 13
  %7 = load ptr, ptr %xChmod, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  store i32 %call14, ptr %iMode, align 4
  %15 = load ptr, ptr %pVfs, align 8
  %xChmod15 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %15, i32 0, i32 13
  %16 = load ptr, ptr %xChmod15, align 8
  %17 = load ptr, ptr %zPath, align 8
  %18 = load i32, ptr %iMode, align 4
  %call16 = call i32 %16(ptr noundef %17, i32 noundef %18)
