...
define hidden void @MemOSFree(ptr noundef %pBlock) #0 {
entry:
  ...
  store ptr %add.ptr, ptr %pChunk, align 8
  %1 = load ptr, ptr %pChunk, align 8
  call void @SyOSHeapFree(ptr noundef %1)
  ret void
}

; Function Attrs: nounwind uwtable
declare hidden void @SyOSHeapFree(ptr noundef) #0
