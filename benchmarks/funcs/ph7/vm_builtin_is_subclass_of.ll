...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_is_subclass_of(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %pVm1 = getelementptr inbounds nuw %struct.ph7_context, ptr %5, i32 0, i32 4
  ...
  %call3 = call ptr @VmExtractClassFromValue(ptr noundef %6, ptr noundef %8)
  store ptr %call3, ptr %pMain, align 8
  %9 = load ptr, ptr %pClass, align 8
  %tobool = icmp ne ptr %9, null
  br i1 %tobool, label %land.lhs.true, label %if.end

land.lhs.true:                                    ; preds = %if.then
  %10 = load ptr, ptr %pMain, align 8
  %tobool4 = icmp ne ptr %10, null
  br i1 %tobool4, label %if.then5, label %if.end

if.then5:                                         ; preds = %land.lhs.true
  %11 = load ptr, ptr %pClass, align 8
  %12 = load ptr, ptr %pMain, align 8
  %call6 = call i32 @VmSubclassOf(ptr noundef %11, ptr noundef %12)
...
if.end7:                                          ; preds = %if.end, %entry
  ...
  %call8 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef %14)
  ret i32 0
}

; Function Attrs: nounwind uwtable
declare hidden i32 @VmSubclassOf(ptr noundef, ptr noundef) #0
