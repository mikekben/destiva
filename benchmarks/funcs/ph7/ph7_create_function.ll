...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_create_function(ptr noundef %pVm, ptr noundef %zName, ptr noundef %xFunc, ptr noundef %pUserData) #0 {
entry:
...
lor.lhs.false48:                                  ; preds = %while.end44
  %27 = load ptr, ptr %xFunc.addr, align 8
  %cmp49 = icmp eq ptr %27, null
  br i1 %cmp49, label %if.then51, label %if.end52

if.then51:                                        ; preds = %lor.lhs.false48, %while.end44
  store i32 -24, ptr %retval, align 4
  br label %return

if.end52:                                         ; preds = %lor.lhs.false48
  %28 = load ptr, ptr %pVm.addr, align 8
  %29 = load ptr, ptr %xFunc.addr, align 8
  %30 = load ptr, ptr %pUserData.addr, align 8
  %call53 = call i32 @PH7_VmInstallForeignFunction(ptr noundef %28, ptr noundef %sName, ptr noundef %29, ptr noundef %30)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @PH7_VmInstallForeignFunction(ptr noundef, ptr noundef, ptr noundef, ptr noundef) #0
