...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_eval(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %nByte = getelementptr inbounds nuw %struct.SyString, ptr %sChunk, i32 0, i32 1
  ...
  %nByte2 = getelementptr inbounds nuw %struct.SyString, ptr %sChunk, i32 0, i32 1
...
if.end6:                                          ; preds = %if.end
  ...
  %call7 = call i32 @VmEvalChunk(ptr noundef %7, ptr noundef %8, ptr noundef %sChunk, i32 noundef 1, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
