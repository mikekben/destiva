...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_is_executable(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xExecutable = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 28
  %7 = load ptr, ptr %xExecutable, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xExecutable13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 28
  %14 = load ptr, ptr %xExecutable13, align 8
  %15 = load ptr, ptr %zPath, align 8
  %call14 = call i32 %14(ptr noundef %15)
  store i32 %call14, ptr %rc, align 4
  %16 = load ptr, ptr %pCtx.addr, align 8
  %17 = load i32, ptr %rc, align 4
  %cmp15 = icmp eq i32 %17, 0
  %conv = zext i1 %cmp15 to i32
  %call16 = call i32 @ph7_result_bool(ptr noundef %16, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
