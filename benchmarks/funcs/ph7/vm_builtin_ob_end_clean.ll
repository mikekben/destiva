...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_end_clean(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  call void @VmObRestore(ptr noundef %5, ptr noundef %6)
  %7 = load ptr, ptr %pCtx.addr, align 8
  %call3 = call i32 @ph7_result_bool(ptr noundef %7, i32 noundef 1)
  br label %if.end
