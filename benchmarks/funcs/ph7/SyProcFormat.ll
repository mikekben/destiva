...
; Function Attrs: nounwind uwtable
define hidden i32 @SyProcFormat(ptr noundef %xConsumer, ptr noundef %pData, ptr noundef %zFormat, ...) #1 {
entry:
  ...
  %0 = load ptr, ptr %xConsumer.addr, align 8
  %1 = load ptr, ptr %pData.addr, align 8
  %2 = load ptr, ptr %zFormat.addr, align 8
  %arraydecay1 = getelementptr inbounds [1 x %struct.__va_list_tag], ptr %ap, i64 0, i64 0
  %call = call i32 @FormatMount(i32 noundef 1, ptr noundef null, ptr noundef %0, ptr noundef %1, ptr noundef null, ptr noundef %2, ptr noundef %arraydecay1)
