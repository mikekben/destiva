...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_chroot(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xChroot = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 3
  %7 = load ptr, ptr %xChroot, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xChroot13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 3
  %14 = load ptr, ptr %xChroot13, align 8
