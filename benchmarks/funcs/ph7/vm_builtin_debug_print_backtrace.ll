...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_debug_print_backtrace(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %call = call i32 @SyBlobInit(ptr noundef %sDump, ptr noundef %sAllocator)
  %3 = load ptr, ptr %pVm, align 8
  %call2 = call i32 @VmMiniBacktrace(ptr noundef %3, ptr noundef %sDump)
  ...
  %call3 = call i32 @ph7_context_output(ptr noundef %4, ptr noundef %5, i32 noundef %6)
  %call4 = call i32 @SyBlobRelease(ptr noundef %sDump)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @VmMiniBacktrace(ptr noundef, ptr noundef) #0
