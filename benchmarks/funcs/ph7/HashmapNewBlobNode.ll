...
; Function Attrs: nounwind uwtable
define hidden ptr @HashmapNewBlobNode(ptr noundef %pMap, ptr noundef %pKey, i32 noundef %nKeyLen, i32 noundef %nHash, i32 noundef %nValIdx) #0 {
entry:
  ...
  %nValIdx.addr = alloca i32, align 4
  %pNode = alloca ptr, align 8
  store ptr %pMap, ptr %pMap.addr, align 8
  store ptr %pKey, ptr %pKey.addr, align 8
  store i32 %nKeyLen, ptr %nKeyLen.addr, align 4
  store i32 %nHash, ptr %nHash.addr, align 4
  store i32 %nValIdx, ptr %nValIdx.addr, align 4
  ...
  %call = call ptr @SyMemBackendPoolAlloc(ptr noundef %sAllocator, i32 noundef 96)
...
if.end:                                           ; preds = %entry
  ...
  call void @SyZero(ptr noundef %3, i32 noundef 96)
  ...
  store ptr %4, ptr %pMap1, align 8
  %6 = load ptr, ptr %pNode, align 8
  %iType = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %6, i32 0, i32 1
  store i32 2, ptr %iType, align 8
  %7 = load i32, ptr %nHash.addr, align 4
  %8 = load ptr, ptr %pNode, align 8
  %nHash2 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %8, i32 0, i32 4
  store i32 %7, ptr %nHash2, align 4
  %9 = load ptr, ptr %pNode, align 8
  %xKey = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %9, i32 0, i32 2
  ...
  %call5 = call i32 @SyBlobInit(ptr noundef %xKey, ptr noundef %sAllocator4)
  %12 = load ptr, ptr %pNode, align 8
  %xKey6 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %12, i32 0, i32 2
  %13 = load ptr, ptr %pKey.addr, align 8
  %14 = load i32, ptr %nKeyLen.addr, align 4
  %call7 = call i32 @SyBlobAppend(ptr noundef %xKey6, ptr noundef %13, i32 noundef %14)
  %15 = load i32, ptr %nValIdx.addr, align 4
  %16 = load ptr, ptr %pNode, align 8
  %nValIdx8 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %16, i32 0, i32 5
  store i32 %15, ptr %nValIdx8, align 8
