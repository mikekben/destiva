...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_parse_ini_string(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  %retval = alloca i32, align 4
  %pCtx.addr = alloca ptr, align 8
  %nArg.addr = alloca i32, align 4
  %apArg.addr = alloca ptr, align 8
  %zIni = alloca ptr, align 8
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %call3 = call ptr @ph7_value_to_string(ptr noundef %5, ptr noundef %nByte)
  store ptr %call3, ptr %zIni, align 8
  %6 = load ptr, ptr %pCtx.addr, align 8
  %7 = load ptr, ptr %zIni, align 8
...
cond.true:                                        ; preds = %if.end
  ...
  %call6 = call i32 @ph7_value_to_bool(ptr noundef %11)
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call7 = call i32 @PH7_ParseIniString(ptr noundef %6, ptr noundef %7, i32 noundef %8, i32 noundef %cond)
  store i32 0, ptr %retval, align 4
  br label %return
