...
define hidden i32 @PH7_MemObjToReal(ptr noundef %pObj) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call double @MemObjRealValue(ptr noundef %2)
  %3 = load ptr, ptr %pObj.addr, align 8
  %rVal = getelementptr inbounds nuw %struct.ph7_value, ptr %3, i32 0, i32 0
  store double %call, ptr %rVal, align 8
  %4 = load ptr, ptr %pObj.addr, align 8
  %sBlob = getelementptr inbounds nuw %struct.ph7_value, ptr %4, i32 0, i32 4
  %call1 = call i32 @SyBlobRelease(ptr noundef %sBlob)
  %5 = load ptr, ptr %pObj.addr, align 8
  %iFlags2 = getelementptr inbounds nuw %struct.ph7_value, ptr %5, i32 0, i32 2
  %6 = load i32, ptr %iFlags2, align 8
  %and3 = and i32 %6, -496
  %or = or i32 %and3, 4
  %7 = load ptr, ptr %pObj.addr, align 8
  %iFlags4 = getelementptr inbounds nuw %struct.ph7_value, ptr %7, i32 0, i32 2
  store i32 %or, ptr %iFlags4, align 8
  %8 = load ptr, ptr %pObj.addr, align 8
  %call5 = call i32 @MemObjTryIntger(ptr noundef %8)
  br label %if.end
...
; Function Attrs: nounwind uwtable
declare hidden double @MemObjRealValue(ptr noundef) #0
