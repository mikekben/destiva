...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_class_exists(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
land.lhs.true:                                    ; preds = %if.then
  ...
  %call2 = call ptr @SyHashGet(ptr noundef %hClass, ptr noundef %6, i32 noundef %7)
...
if.end5:                                          ; preds = %if.end, %entry
  ...
  %call6 = call i32 @ph7_result_bool(ptr noundef %8, i32 noundef %9)
  ret i32 0
}
