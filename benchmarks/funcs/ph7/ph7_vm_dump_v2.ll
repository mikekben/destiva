...
define dso_local i32 @ph7_vm_dump_v2(ptr noundef %pVm, ptr noundef %xConsumer, ptr noundef %pUserData) #0 {
entry:
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %4 = load ptr, ptr %xConsumer.addr, align 8
  %5 = load ptr, ptr %pUserData.addr, align 8
  %call = call i32 @PH7_VmDump(ptr noundef %3, ptr noundef %4, ptr noundef %5)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @PH7_VmDump(ptr noundef, ptr noundef, ptr noundef) #0
