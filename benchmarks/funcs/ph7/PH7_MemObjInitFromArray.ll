...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_MemObjInitFromArray(ptr noundef %pVm, ptr noundef %pObj, ptr noundef %pArray) #0 {
entry:
  ...
  %iFlags = getelementptr inbounds nuw %struct.ph7_value, ptr %5, i32 0, i32 2
  store i32 64, ptr %iFlags, align 8
  %6 = load ptr, ptr %pArray.addr, align 8
