...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_file_exists(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xFileExists = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 12
  %7 = load ptr, ptr %xFileExists, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xFileExists13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 12
  %14 = load ptr, ptr %xFileExists13, align 8
