...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_gmdate(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then9:                                         ; preds = %if.end7
  ...
  %call11 = call ptr @gmtime(ptr noundef %t) #2
...
if.then26:                                        ; preds = %if.else
  ...
  %call29 = call ptr @gmtime(ptr noundef %t21) #2
...
if.end36:                                         ; preds = %if.else34, %if.end33
  %call37 = call ptr @gmtime(ptr noundef %t21) #2
...
if.end59:                                         ; preds = %if.end36, %if.then9
  ...
  %call60 = call i32 @DateFormat(ptr noundef %50, ptr noundef %51, i32 noundef %52, ptr noundef %sTm)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @DateFormat(ptr noundef, ptr noundef, i32 noundef, ptr noundef) #0
