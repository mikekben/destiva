...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_rewind(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %xSeek22 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %23, i32 0, i32 9
  %24 = load ptr, ptr %xSeek22, align 8
  ...
  %call23 = call i32 %24(ptr noundef %26, i64 noundef 0, i32 noundef 0)
...
if.then25:                                        ; preds = %if.end21
  ...
  call void @ResetIOPrivate(ptr noundef %28)
  br label %if.end26
...
if.end26:                                         ; preds = %if.then25, %if.end21
  ...
  %call28 = call i32 @ph7_result_bool(ptr noundef %29, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end26, %cond.end, %if.then8, %if.then
