...
; Function Attrs: nounwind uwtable
define hidden void @ReleaseIOPrivate(ptr noundef %pCtx, ptr noundef %pDev) #0 {
entry:
  ...
  %call = call i32 @SyBlobRelease(ptr noundef %sBuffer)
  %1 = load ptr, ptr %pDev.addr, align 8
  %iMagic = getelementptr inbounds nuw %struct.io_private, ptr %1, i32 0, i32 4
  store i32 8486, ptr %iMagic, align 4
  %2 = load ptr, ptr %pCtx.addr, align 8
  %3 = load ptr, ptr %pDev.addr, align 8
  call void @ph7_context_free_chunk(ptr noundef %2, ptr noundef %3)
  ret void
}
