...
; Function Attrs: nounwind uwtable
define hidden i32 @SySha1Compute(ptr noundef %pIn, i32 noundef %nLen, ptr noundef %zDigest) #0 {
entry:
  ...
  call void @SHA1Update(ptr noundef %sCtx, ptr noundef %0, i32 noundef %1)
  %2 = load ptr, ptr %zDigest.addr, align 8
  call void @SHA1Final(ptr noundef %sCtx, ptr noundef %2)
  ret i32 0
}
