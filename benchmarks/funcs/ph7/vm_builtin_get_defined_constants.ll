...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_get_defined_constants(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %pVm = getelementptr inbounds nuw %struct.ph7_context, ptr %3, i32 0, i32 4
  %4 = load ptr, ptr %pVm, align 8
  %hConstant = getelementptr inbounds nuw %struct.ph7_vm, ptr %4, i32 0, i32 11
  %5 = load ptr, ptr %pArray, align 8
  %call2 = call i32 @SyHashForEach(ptr noundef %hConstant, ptr noundef @VmHashConstStep, ptr noundef %5)
  %6 = load ptr, ptr %pCtx.addr, align 8
  %7 = load ptr, ptr %pArray, align 8
  %call3 = call i32 @ph7_result_value(ptr noundef %6, ptr noundef %7)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @VmHashConstStep(ptr noundef, ptr noundef) #0
