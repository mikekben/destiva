...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_method_exists(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then5:                                         ; preds = %if.then1
  ...
  %hMethod = getelementptr inbounds nuw %struct.ph7_class, ptr %9, i32 0, i32 5
  %10 = load ptr, ptr %zName, align 8
  %11 = load i32, ptr %nLen, align 4
  %call6 = call ptr @SyHashGet(ptr noundef %hMethod, ptr noundef %10, i32 noundef %11)
...
if.end11:                                         ; preds = %if.end10, %entry
  ...
  %call12 = call i32 @ph7_result_bool(ptr noundef %12, i32 noundef %13)
  ret i32 0
}
