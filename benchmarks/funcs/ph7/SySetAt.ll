...
define hidden ptr @SySetAt(ptr noundef %pSet, i32 noundef %nIdx) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  store ptr %4, ptr %zBase, align 8
  %5 = load ptr, ptr %zBase, align 8
  %6 = load i32, ptr %nIdx.addr, align 4
  %7 = load ptr, ptr %pSet.addr, align 8
  %eSize = getelementptr inbounds nuw %struct.SySet, ptr %7, i32 0, i32 4
  %8 = load i32, ptr %eSize, align 8
  %mul = mul i32 %6, %8
