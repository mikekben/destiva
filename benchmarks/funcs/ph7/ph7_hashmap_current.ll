...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_current(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end4:                                          ; preds = %if.end
  ...
  %call6 = call i32 @HashmapCurrentValue(ptr noundef %5, ptr noundef %8, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
