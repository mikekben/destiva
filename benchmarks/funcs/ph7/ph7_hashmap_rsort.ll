...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_rsort(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end12:                                         ; preds = %if.end11, %if.then4
  ...
  %call13 = call i32 @HashmapMergeSort(ptr noundef %13, ptr noundef @HashmapCmpCallback3, ptr noundef %15)
  %16 = load ptr, ptr %pMap, align 8
  call void @HashmapSortRehash(ptr noundef %16)
  br label %if.end14

if.end14:                                         ; preds = %if.end12, %if.end
  %17 = load ptr, ptr %pCtx.addr, align 8
  %call15 = call i32 @ph7_result_bool(ptr noundef %17, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @HashmapCmpCallback3(ptr noundef, ptr noundef, ptr noundef) #0
