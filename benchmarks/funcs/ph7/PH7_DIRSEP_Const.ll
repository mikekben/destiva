...
; Function Attrs: nounwind uwtable
define hidden void @PH7_DIRSEP_Const(ptr noundef %pVal, ptr noundef %pUnused) #0 {
entry:
  ...
  %call = call i32 @ph7_value_string(ptr noundef %0, ptr noundef @.str.155, i32 noundef 1)
  ret void
}
