...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_chgrp(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xChgrp = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 15
  %7 = load ptr, ptr %xChgrp, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  store ptr %call14, ptr %zGroup, align 8
  %15 = load ptr, ptr %pVfs, align 8
  %xChgrp15 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %15, i32 0, i32 15
  %16 = load ptr, ptr %xChgrp15, align 8
  %17 = load ptr, ptr %zPath, align 8
  %18 = load ptr, ptr %zGroup, align 8
