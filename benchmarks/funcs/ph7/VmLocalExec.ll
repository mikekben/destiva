...
; Function Attrs: nounwind uwtable
define hidden i32 @VmLocalExec(ptr noundef %pVm, ptr noundef %pByteCode, ptr noundef %pResult) #0 {
entry:
  ...
  %1 = load ptr, ptr %pByteCode.addr, align 8
  %nUsed = getelementptr inbounds nuw %struct.SySet, ptr %1, i32 0, i32 2
  %2 = load i32, ptr %nUsed, align 8
  %call = call ptr @VmNewOperandStack(ptr noundef %0, i32 noundef %2)
...
if.end:                                           ; preds = %entry
  ...
  %5 = load ptr, ptr %pByteCode.addr, align 8
  ...
  %call1 = call i32 @VmByteCodeExec(ptr noundef %4, ptr noundef %6, ptr noundef %7, i32 noundef -1, ptr noundef %8, ptr noundef null, i32 noundef 0)
  ...
  %call2 = call i32 @SyMemBackendFree(ptr noundef %sAllocator, ptr noundef %10)
