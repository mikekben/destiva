...
; Function Attrs: nounwind uwtable
define hidden ptr @VmNewRefObj(ptr noundef %pVm, i32 noundef %nIdx) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  call void @SyZero(ptr noundef %2, i32 noundef 120)
  %3 = load ptr, ptr %pRef, align 8
  %aReference = getelementptr inbounds nuw %struct.VmRefObj, ptr %3, i32 0, i32 0
  %4 = load ptr, ptr %pVm.addr, align 8
  %sAllocator1 = getelementptr inbounds nuw %struct.ph7_vm, ptr %4, i32 0, i32 0
  %call2 = call i32 @SySetInit(ptr noundef %aReference, ptr noundef %sAllocator1, i32 noundef 8)
  %5 = load ptr, ptr %pRef, align 8
  %aArrEntries = getelementptr inbounds nuw %struct.VmRefObj, ptr %5, i32 0, i32 1
  %6 = load ptr, ptr %pVm.addr, align 8
  %sAllocator3 = getelementptr inbounds nuw %struct.ph7_vm, ptr %6, i32 0, i32 0
  %call4 = call i32 @SySetInit(ptr noundef %aArrEntries, ptr noundef %sAllocator3, i32 noundef 8)
  %7 = load i32, ptr %nIdx.addr, align 4
  %8 = load ptr, ptr %pRef, align 8
  %nIdx5 = getelementptr inbounds nuw %struct.VmRefObj, ptr %8, i32 0, i32 2
  store i32 %7, ptr %nIdx5, align 8
