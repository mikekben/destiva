...
@.str.496 = external hidden unnamed_addr constant [22 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_defined(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 @ph7_context_throw_error(ptr noundef %1, i32 noundef 3, ptr noundef @.str.496)
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call ptr @ph7_value_to_string(ptr noundef %4, ptr noundef %nLen)
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %hConstant = getelementptr inbounds nuw %struct.ph7_vm, ptr %7, i32 0, i32 11
  %8 = load ptr, ptr %zName, align 8
  %9 = load i32, ptr %nLen, align 4
  %call4 = call ptr @SyHashGet(ptr noundef %hConstant, ptr noundef %8, i32 noundef %9)
...
if.end7:                                          ; preds = %if.then6, %land.lhs.true, %if.end
  ...
  %call8 = call i32 @ph7_result_bool(ptr noundef %10, i32 noundef %11)
  store i32 0, ptr %retval, align 4
  br label %return
