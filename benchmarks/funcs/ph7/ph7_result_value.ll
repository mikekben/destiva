...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_result_value(ptr noundef %pCtx, ptr noundef %pValue) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %pRet = getelementptr inbounds nuw %struct.ph7_context, ptr %1, i32 0, i32 1
...
if.else:                                          ; preds = %entry
  ...
  %pRet1 = getelementptr inbounds nuw %struct.ph7_context, ptr %4, i32 0, i32 1
  %5 = load ptr, ptr %pRet1, align 8
  %call2 = call i32 @PH7_MemObjStore(ptr noundef %3, ptr noundef %5)
