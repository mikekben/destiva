...
; Function Attrs: nounwind uwtable
define hidden i32 @VmXMLPIHandler(ptr noundef %pTargetStr, ptr noundef %pDataStr, ptr noundef %pUserData) #0 {
entry:
  %retval = alloca i32, align 4
  %pTargetStr.addr = alloca ptr, align 8
  %pDataStr.addr = alloca ptr, align 8
  ...
  store ptr %pTargetStr, ptr %pTargetStr.addr, align 8
  store ptr %pDataStr, ptr %pDataStr.addr, align 8
  ...
  %arrayidx = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 3
...
if.end5:                                          ; preds = %lor.lhs.false
  ...
  %15 = load ptr, ptr %pTarget, align 8
  ...
  %19 = load ptr, ptr %pTarget, align 8
