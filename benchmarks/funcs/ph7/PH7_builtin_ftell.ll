...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_ftell(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xTell = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 12
  %16 = load ptr, ptr %xTell, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %xTell22 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %23, i32 0, i32 12
  %24 = load ptr, ptr %xTell22, align 8
  ...
  %call23 = call i64 %24(ptr noundef %26)
  store i64 %call23, ptr %iOfft, align 8
  %27 = load ptr, ptr %pCtx.addr, align 8
  %28 = load i64, ptr %iOfft, align 8
  %call24 = call i32 @ph7_result_int64(ptr noundef %27, i64 noundef %28)
  store i32 0, ptr %retval, align 4
  br label %return
