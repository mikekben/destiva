...
; Function Attrs: nounwind uwtable
define hidden ptr @VmExtractSuper(ptr noundef %pVm, ptr noundef %zName, i32 noundef %nByte) #0 {
entry:
  ...
  %hSuper = getelementptr inbounds nuw %struct.ph7_vm, ptr %0, i32 0, i32 14
  %1 = load ptr, ptr %zName.addr, align 8
  %2 = load i32, ptr %nByte.addr, align 4
  %call = call ptr @SyHashGet(ptr noundef %hSuper, ptr noundef %1, i32 noundef %2)
...
if.end:                                           ; preds = %entry
  ...
  %aMemObj = getelementptr inbounds nuw %struct.ph7_vm, ptr %7, i32 0, i32 6
  %8 = load i32, ptr %nIdx, align 4
  %call1 = call ptr @SySetAt(ptr noundef %aMemObj, i32 noundef %8)
