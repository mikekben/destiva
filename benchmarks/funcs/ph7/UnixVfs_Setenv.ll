...
define hidden i32 @UnixVfs_Setenv(ptr noundef %zName, ptr noundef %zValue) #0 {
entry:
  ...
  %1 = load ptr, ptr %zValue.addr, align 8
  %call = call i32 @setenv(ptr noundef %0, ptr noundef %1, i32 noundef 1) #2
