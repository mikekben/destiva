...
; Function Attrs: nounwind uwtable
define hidden void @PHPStreamData_Close(ptr noundef %pHandle) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %pVm1 = getelementptr inbounds nuw %struct.ph7_stream_data, ptr %2, i32 0, i32 0
  ...
  %call = call i32 @SyMemBackendFree(ptr noundef %sAllocator, ptr noundef %5)
  br label %return
