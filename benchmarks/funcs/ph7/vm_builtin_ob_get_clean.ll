...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_get_clean(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %call = call ptr @SySetPop(ptr noundef %aOB)
  store ptr %call, ptr %pOb, align 8
  %3 = load ptr, ptr %pOb, align 8
...
if.else:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr %pOb, align 8
  %sOB = getelementptr inbounds nuw %struct.VmObEntry, ptr %6, i32 0, i32 1
  %pBlob = getelementptr inbounds nuw %struct.SyBlob, ptr %sOB, i32 0, i32 1
  %7 = load ptr, ptr %pBlob, align 8
  %8 = load ptr, ptr %pOb, align 8
  %sOB3 = getelementptr inbounds nuw %struct.VmObEntry, ptr %8, i32 0, i32 1
  %nByte = getelementptr inbounds nuw %struct.SyBlob, ptr %sOB3, i32 0, i32 2
  %9 = load i32, ptr %nByte, align 8
  %call4 = call i32 @ph7_result_string(ptr noundef %5, ptr noundef %7, i32 noundef %9)
  %10 = load ptr, ptr %pVm, align 8
  %11 = load ptr, ptr %pOb, align 8
  call void @VmObRestore(ptr noundef %10, ptr noundef %11)
  br label %if.end
