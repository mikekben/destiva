...
define dso_local ptr @ph7_context_realloc_chunk(ptr noundef %pCtx, ptr noundef %pChunk, i32 noundef %nByte) #0 {
entry:
  ...
  %2 = load ptr, ptr %pChunk.addr, align 8
  %3 = load i32, ptr %nByte.addr, align 4
  %call = call ptr @SyMemBackendRealloc(ptr noundef %sAllocator, ptr noundef %2, i32 noundef %3)
...
if.then:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr %pChunk.addr, align 8
  %call1 = call ptr @ContextFindChunk(ptr noundef %5, ptr noundef %6)
  store ptr %call1, ptr %pAux, align 8
  %7 = load ptr, ptr %pAux, align 8
...
; Function Attrs: nounwind uwtable
declare hidden ptr @ContextFindChunk(ptr noundef, ptr noundef) #0
