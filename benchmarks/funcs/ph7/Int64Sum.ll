...
if.then5:                                         ; preds = %if.then
  ...
  %13 = load i64, ptr %nSum, align 8
  %add = add nsw i64 %13, %conv
  store i64 %add, ptr %nSum, align 8
  br label %if.end26
...
if.then9:                                         ; preds = %if.else
  ...
  %18 = load i64, ptr %nSum, align 8
  %add10 = add nsw i64 %18, %17
  store i64 %add10, ptr %nSum, align 8
  br label %if.end25
...
if.then18:                                        ; preds = %if.then15
  ...
  %28 = load i64, ptr %nSum, align 8
  %add23 = add nsw i64 %28, %27
  store i64 %add23, ptr %nSum, align 8
  br label %if.end
