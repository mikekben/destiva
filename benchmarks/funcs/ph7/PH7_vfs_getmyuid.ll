...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_getmyuid(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %xUid = getelementptr inbounds nuw %struct.ph7_vfs, ptr %2, i32 0, i32 39
  %3 = load ptr, ptr %xUid, align 8
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %xUid5 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %7, i32 0, i32 39
  %8 = load ptr, ptr %xUid5, align 8
  %call6 = call i32 %8()
  store i32 %call6, ptr %nUid, align 4
  %9 = load ptr, ptr %pCtx.addr, align 8
  %10 = load i32, ptr %nUid, align 4
