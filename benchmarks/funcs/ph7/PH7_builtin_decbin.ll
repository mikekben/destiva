...
@.str.963 = external hidden unnamed_addr constant [3 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_decbin(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 (ptr, ptr, ...) @ph7_result_string_format(ptr noundef %4, ptr noundef @.str.963, i32 noundef %5)
  store i32 0, ptr %retval, align 4
  br label %return
