...
declare dso_local ptr @ph7_new_scalar(ptr noundef) #0

; Function Attrs: nounwind uwtable
define dso_local ptr @ph7_context_new_scalar(ptr noundef %pCtx) #0 {
entry:
  ...
  %call = call ptr @ph7_new_scalar(ptr noundef %1)
