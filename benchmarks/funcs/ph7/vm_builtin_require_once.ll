...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_require_once(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then13:                                        ; preds = %if.end11
  ...
  %call14 = call i32 (ptr, i32, ptr, ...) @ph7_context_throw_error_format(ptr noundef %10, i32 noundef 1, ptr noundef @.str.622, ptr noundef %sFile)
...
return:                                           ; preds = %if.end16, %if.then13, %if.then9, %if.then4, %if.then
