...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_chdir(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xChdir = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 2
  %7 = load ptr, ptr %xChdir, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xChdir13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 2
  %14 = load ptr, ptr %xChdir13, align 8
