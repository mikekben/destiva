...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_get_current_byte_index(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end14:                                         ; preds = %if.end9
  ...
  %call16 = call i32 @ph7_result_int64(ptr noundef %14, i64 noundef %sub.ptr.sub)
  store i32 0, ptr %retval, align 4
  br label %return
