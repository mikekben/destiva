...
; Function Attrs: nounwind uwtable
define hidden i32 @VmJsonDefaultDecoder(ptr noundef %pCtx, ptr noundef %pKey, ptr noundef %pWorker, ptr noundef %pUserData) #0 {
entry:
  ...
  %1 = load ptr, ptr %pWorker.addr, align 8
  %call = call i32 @ph7_result_value(ptr noundef %0, ptr noundef %1)
