...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_md5(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end12:                                         ; preds = %if.then9, %land.lhs.true, %if.end5
  ...
  %arraydecay = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  %call13 = call i32 @SyMD5Compute(ptr noundef %11, i32 noundef %12, ptr noundef %arraydecay)
...
if.then15:                                        ; preds = %if.end12
  ...
  %arraydecay16 = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  %call17 = call i32 @ph7_result_string(ptr noundef %14, ptr noundef %arraydecay16, i32 noundef 16)
  br label %if.end20

if.else:                                          ; preds = %if.end12
  %arraydecay18 = getelementptr inbounds [16 x i8], ptr %zDigest, i64 0, i64 0
  %15 = load ptr, ptr %pCtx.addr, align 8
  %call19 = call i32 @SyBinToHexConsumer(ptr noundef %arraydecay18, i32 noundef 16, ptr noundef @HashConsumer, ptr noundef %15)
  br label %if.end20
...
; Function Attrs: nounwind uwtable
declare hidden i32 @SyMD5Compute(ptr noundef, i32 noundef, ptr noundef) #0
