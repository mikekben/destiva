...
; Function Attrs: nounwind uwtable
define hidden void @Int64Prod(ptr noundef %pCtx, ptr noundef %pMap) #0 {
entry:
  %pCtx.addr = alloca ptr, align 8
  %pMap.addr = alloca ptr, align 8
  %pEntry = alloca ptr, align 8
  %pObj = alloca ptr, align 8
  %nProd = alloca i64, align 8
...
if.then5:                                         ; preds = %if.then
  ...
  %13 = load i64, ptr %nProd, align 8
  %mul = mul nsw i64 %13, %conv
  store i64 %mul, ptr %nProd, align 8
  br label %if.end26
...
if.then9:                                         ; preds = %if.else
  ...
  %18 = load i64, ptr %nProd, align 8
  %mul10 = mul nsw i64 %18, %17
  store i64 %mul10, ptr %nProd, align 8
  br label %if.end25
...
if.then18:                                        ; preds = %if.then15
  ...
  %call22 = call i32 @SyStrToInt64(ptr noundef %24, i32 noundef %26, ptr noundef %nv, ptr noundef null)
  %27 = load i64, ptr %nv, align 8
  %28 = load i64, ptr %nProd, align 8
  %mul23 = mul nsw i64 %28, %27
  store i64 %mul23, ptr %nProd, align 8
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  ...
  %33 = load i64, ptr %nProd, align 8
  %call28 = call i32 @ph7_result_int64(ptr noundef %32, i64 noundef %33)
  ret void
}
