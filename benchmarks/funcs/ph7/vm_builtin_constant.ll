...
@.str.500 = external hidden unnamed_addr constant [30 x i8], align 1
@.str.501 = external hidden unnamed_addr constant [27 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_constant(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  %call1 = call i32 @ph7_context_throw_error(ptr noundef %3, i32 noundef 3, ptr noundef @.str.500)
  %4 = load ptr, ptr %pCtx.addr, align 8
  %call2 = call i32 @ph7_result_null(ptr noundef %4)
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  store ptr %call4, ptr %zName, align 8
  ...
  %hConstant = getelementptr inbounds nuw %struct.ph7_vm, ptr %8, i32 0, i32 11
  %9 = load ptr, ptr %zName, align 8
  %10 = load i32, ptr %nLen, align 4
  %call5 = call ptr @SyHashGet(ptr noundef %hConstant, ptr noundef %9, i32 noundef %10)
  store ptr %call5, ptr %pEntry, align 8
...
if.then7:                                         ; preds = %if.end
  ...
  %call8 = call i32 (ptr, i32, ptr, ...) @ph7_context_throw_error_format(ptr noundef %12, i32 noundef 3, ptr noundef @.str.501, i32 noundef %13, ptr noundef %14)
  %15 = load ptr, ptr %pCtx.addr, align 8
  %call9 = call i32 @ph7_result_null(ptr noundef %15)
  store i32 0, ptr %retval, align 4
  br label %return

if.end10:                                         ; preds = %if.end
  %16 = load ptr, ptr %pCtx.addr, align 8
  %pVm11 = getelementptr inbounds nuw %struct.ph7_context, ptr %16, i32 0, i32 4
  %17 = load ptr, ptr %pVm11, align 8
  %call12 = call i32 @PH7_MemObjInit(ptr noundef %17, ptr noundef %sVal)
  %18 = load ptr, ptr %pEntry, align 8
  %pUserData = getelementptr inbounds nuw %struct.SyHashEntry, ptr %18, i32 0, i32 2
  %19 = load ptr, ptr %pUserData, align 8
  store ptr %19, ptr %pCons, align 8
  %20 = load ptr, ptr %pCons, align 8
  %xExpand = getelementptr inbounds nuw %struct.ph7_constant, ptr %20, i32 0, i32 1
  %21 = load ptr, ptr %xExpand, align 8
  %22 = load ptr, ptr %pCons, align 8
  %pUserData13 = getelementptr inbounds nuw %struct.ph7_constant, ptr %22, i32 0, i32 2
  %23 = load ptr, ptr %pUserData13, align 8
  call void %21(ptr noundef %sVal, ptr noundef %23)
  %24 = load ptr, ptr %pCtx.addr, align 8
  %call14 = call i32 @ph7_result_value(ptr noundef %24, ptr noundef %sVal)
  %call15 = call i32 @PH7_MemObjRelease(ptr noundef %sVal)
  store i32 0, ptr %retval, align 4
  br label %return
