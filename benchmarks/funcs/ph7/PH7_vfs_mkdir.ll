...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_mkdir(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  %retval = alloca i32, align 4
  %pCtx.addr = alloca ptr, align 8
  %nArg.addr = alloca i32, align 4
  %apArg.addr = alloca ptr, align 8
  %iRecursive = alloca i32, align 4
  ...
  store i32 0, ptr %iRecursive, align 4
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xMkdir = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 5
  %7 = load ptr, ptr %xMkdir, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  store i32 511, ptr %iMode, align 4
...
if.then14:                                        ; preds = %if.end10
  ...
  %call16 = call i32 @ph7_value_to_int(ptr noundef %15)
  store i32 %call16, ptr %iMode, align 4
...
if.then18:                                        ; preds = %if.then14
  ...
  %arrayidx19 = getelementptr inbounds ptr, ptr %17, i64 2
  %18 = load ptr, ptr %arrayidx19, align 8
  %call20 = call i32 @ph7_value_to_bool(ptr noundef %18)
  store i32 %call20, ptr %iRecursive, align 4
  br label %if.end21
...
if.end22:                                         ; preds = %if.end21, %if.end10
  ...
  %xMkdir23 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %19, i32 0, i32 5
  %20 = load ptr, ptr %xMkdir23, align 8
  %21 = load ptr, ptr %zPath, align 8
  %22 = load i32, ptr %iMode, align 4
  %23 = load i32, ptr %iRecursive, align 4
  %call24 = call i32 %20(ptr noundef %21, i32 noundef %22, i32 noundef %23)
  store i32 %call24, ptr %rc, align 4
  %24 = load ptr, ptr %pCtx.addr, align 8
  %25 = load i32, ptr %rc, align 4
  %cmp25 = icmp eq i32 %25, 0
  %conv = zext i1 %cmp25 to i32
  %call26 = call i32 @ph7_result_bool(ptr noundef %24, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
