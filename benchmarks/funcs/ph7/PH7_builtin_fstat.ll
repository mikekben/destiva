...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fstat(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xStat = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 15
  %16 = load ptr, ptr %xStat, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %call22 = call ptr @ph7_context_new_array(ptr noundef %23)
  store ptr %call22, ptr %pArray, align 8
  %24 = load ptr, ptr %pCtx.addr, align 8
  %call23 = call ptr @ph7_context_new_scalar(ptr noundef %24)
  store ptr %call23, ptr %pValue, align 8
...
lor.lhs.false25:                                  ; preds = %if.end21
  %26 = load ptr, ptr %pValue, align 8
  %cmp26 = icmp eq ptr %26, null
  br i1 %cmp26, label %if.then27, label %if.end30

if.then27:                                        ; preds = %lor.lhs.false25, %if.end21
  %27 = load ptr, ptr %pCtx.addr, align 8
  %call28 = call i32 @ph7_context_throw_error(ptr noundef %27, i32 noundef 1, ptr noundef @.str.536)
  %28 = load ptr, ptr %pCtx.addr, align 8
  %call29 = call i32 @ph7_result_bool(ptr noundef %28, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return

if.end30:                                         ; preds = %lor.lhs.false25
  %29 = load ptr, ptr %pStream, align 8
  %xStat31 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %29, i32 0, i32 15
  %30 = load ptr, ptr %xStat31, align 8
  %31 = load ptr, ptr %pDev, align 8
  %pHandle = getelementptr inbounds nuw %struct.io_private, ptr %31, i32 0, i32 1
  %32 = load ptr, ptr %pHandle, align 8
  %33 = load ptr, ptr %pArray, align 8
  %34 = load ptr, ptr %pValue, align 8
  %call32 = call i32 %30(ptr noundef %32, ptr noundef %33, ptr noundef %34)
  %35 = load ptr, ptr %pCtx.addr, align 8
  %36 = load ptr, ptr %pArray, align 8
  %call33 = call i32 @ph7_result_value(ptr noundef %35, ptr noundef %36)
  store i32 0, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end30, %if.then27, %cond.end, %if.then8, %if.then
