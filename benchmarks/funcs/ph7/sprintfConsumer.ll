...
; Function Attrs: nounwind uwtable
define hidden i32 @sprintfConsumer(ptr noundef %pCtx, ptr noundef %zInput, i32 noundef %nLen, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call i32 @ph7_result_string(ptr noundef %0, ptr noundef %1, i32 noundef %2)
