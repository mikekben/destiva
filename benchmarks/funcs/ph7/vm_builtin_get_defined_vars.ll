...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_get_defined_vars(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %hSuper = getelementptr inbounds nuw %struct.ph7_vm, ptr %5, i32 0, i32 14
  %6 = load ptr, ptr %pArray, align 8
  %call3 = call i32 @SyHashForEach(ptr noundef %hSuper, ptr noundef @VmHashVarWalker, ptr noundef %6)
  %7 = load ptr, ptr %pVm, align 8
  %pFrame = getelementptr inbounds nuw %struct.ph7_vm, ptr %7, i32 0, i32 4
  %8 = load ptr, ptr %pFrame, align 8
  %hVar = getelementptr inbounds nuw %struct.VmFrame, ptr %8, i32 0, i32 5
  %9 = load ptr, ptr %pArray, align 8
  %call4 = call i32 @SyHashForEach(ptr noundef %hVar, ptr noundef @VmHashVarWalker, ptr noundef %9)
  %10 = load ptr, ptr %pCtx.addr, align 8
  %11 = load ptr, ptr %pArray, align 8
  %call5 = call i32 @ph7_result_value(ptr noundef %10, ptr noundef %11)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @VmHashVarWalker(ptr noundef, ptr noundef) #0
