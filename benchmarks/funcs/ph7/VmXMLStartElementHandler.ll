...
; Function Attrs: nounwind uwtable
define hidden i32 @VmXMLStartElementHandler(ptr noundef %pStart, ptr noundef %pNS, i32 noundef %nAttr, ptr noundef %aAttr, ptr noundef %pUserData) #0 {
entry:
  %retval = alloca i32, align 4
  %pStart.addr = alloca ptr, align 8
  %pNS.addr = alloca ptr, align 8
  ...
  store ptr %pNS, ptr %pNS.addr, align 8
  ...
  %arrayidx = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 0
...
if.end:                                           ; preds = %entry
  ...
  %6 = load ptr, ptr %pStart.addr, align 8
  %7 = load ptr, ptr %pNS.addr, align 8
  %call1 = call ptr @VmXMLValue(ptr noundef %5, ptr noundef %6, ptr noundef %7)
  store ptr %call1, ptr %pTag, align 8
  %8 = load ptr, ptr %pEngine, align 8
  %9 = load ptr, ptr %aAttr.addr, align 8
  %10 = load i32, ptr %nAttr.addr, align 4
  %call2 = call ptr @VmXMLAttrValue(ptr noundef %8, ptr noundef %9, i32 noundef %10)
  store ptr %call2, ptr %pAttr, align 8
  %11 = load ptr, ptr %pTag, align 8
...
if.then4:                                         ; preds = %lor.lhs.false, %if.end
  store ptr null, ptr %pNS.addr, align 8
  store i32 0, ptr %retval, align 4
  br label %return

if.end5:                                          ; preds = %lor.lhs.false
  %13 = load ptr, ptr %pEngine, align 8
  %pVm6 = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %13, i32 0, i32 0
  %14 = load ptr, ptr %pVm6, align 8
  %15 = load ptr, ptr %pCallback, align 8
  %16 = load ptr, ptr %pEngine, align 8
  %sParserValue = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %16, i32 0, i32 4
  %17 = load ptr, ptr %pTag, align 8
  %18 = load ptr, ptr %pAttr, align 8
  %call7 = call i32 (ptr, ptr, ptr, ...) @PH7_VmCallUserFunctionAp(ptr noundef %14, ptr noundef %15, ptr noundef null, ptr noundef %sParserValue, ptr noundef %17, ptr noundef %18, i32 noundef 0)
  %19 = load ptr, ptr %pEngine, align 8
  %pCtx = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %19, i32 0, i32 1
  %20 = load ptr, ptr %pCtx, align 8
  %21 = load ptr, ptr %pTag, align 8
  call void @ph7_context_release_value(ptr noundef %20, ptr noundef %21)
  %22 = load ptr, ptr %pEngine, align 8
  %pCtx8 = getelementptr inbounds nuw %struct.ph7_xml_engine, ptr %22, i32 0, i32 1
  %23 = load ptr, ptr %pCtx8, align 8
  %24 = load ptr, ptr %pAttr, align 8
  call void @ph7_context_release_value(ptr noundef %23, ptr noundef %24)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden ptr @VmXMLAttrValue(ptr noundef, ptr noundef, i32 noundef) #0
