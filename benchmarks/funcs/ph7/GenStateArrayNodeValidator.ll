...
@.str.214 = external hidden unnamed_addr constant [86 x i8], align 1
@.str.215 = external hidden unnamed_addr constant [59 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @GenStateArrayNodeValidator(ptr noundef %pGen, ptr noundef %pRoot) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call = call i32 (ptr, i32, i32, ptr, ...) @PH7_GenCompileError(ptr noundef %14, i32 noundef 1, i32 noundef %cond, ptr noundef @.str.214)
...
cond.end27:                                       ; preds = %cond.false26, %cond.true23
  ...
  %call29 = call i32 (ptr, i32, i32, ptr, ...) @PH7_GenCompileError(ptr noundef %23, i32 noundef 1, i32 noundef %cond28, ptr noundef @.str.215)
