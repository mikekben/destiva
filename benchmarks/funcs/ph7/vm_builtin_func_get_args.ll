...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_func_get_args(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %pVm13 = getelementptr inbounds nuw %struct.ph7_context, ptr %22, i32 0, i32 4
  %23 = load ptr, ptr %pVm13, align 8
  %aMemObj = getelementptr inbounds nuw %struct.ph7_vm, ptr %23, i32 0, i32 6
  ...
  %call14 = call ptr @SySetAt(ptr noundef %aMemObj, i32 noundef %26)
  store ptr %call14, ptr %pObj, align 8
  %27 = load ptr, ptr %pObj, align 8
...
if.then16:                                        ; preds = %for.body
  ...
  %call17 = call i32 @ph7_array_add_elem(ptr noundef %28, ptr noundef null, ptr noundef %29)
  br label %if.end18
...
for.end:                                          ; preds = %for.cond
  ...
  %call19 = call i32 @ph7_result_value(ptr noundef %31, ptr noundef %32)
  store i32 0, ptr %retval, align 4
  br label %return
