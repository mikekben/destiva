...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_walk_recursive(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call6 = call i32 @HashmapWalkRecursive(ptr noundef %7, ptr noundef %9, ptr noundef %cond, i32 noundef 0)
  store i32 %call6, ptr %rc, align 4
  %13 = load ptr, ptr %pCtx.addr, align 8
  %14 = load i32, ptr %rc, align 4
  %cmp7 = icmp eq i32 %14, 0
  %conv = zext i1 %cmp7 to i32
  %call8 = call i32 @ph7_result_bool(ptr noundef %13, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden i32 @HashmapWalkRecursive(ptr noundef, ptr noundef, ptr noundef, i32 noundef) #0
