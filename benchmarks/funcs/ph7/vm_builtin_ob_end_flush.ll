...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_ob_end_flush(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @VmObFlush(ptr noundef %5, ptr noundef %6, i32 noundef 1)
  store i32 %call3, ptr %rc, align 4
  %7 = load ptr, ptr %pCtx.addr, align 8
  %call4 = call i32 @ph7_result_bool(ptr noundef %7, i32 noundef 1)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @VmObFlush(ptr noundef, ptr noundef, i32 noundef) #0
