...
; Function Attrs: nounwind uwtable
define hidden ptr @HashmapNewIntNode(ptr noundef %pMap, i64 noundef %iKey, i32 noundef %nHash, i32 noundef %nValIdx) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %9 = load i64, ptr %iKey.addr, align 8
  %10 = load ptr, ptr %pNode, align 8
  %xKey = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %10, i32 0, i32 2
  store i64 %9, ptr %xKey, align 8
  %11 = load i32, ptr %nValIdx.addr, align 4
  %12 = load ptr, ptr %pNode, align 8
  %nValIdx3 = getelementptr inbounds nuw %struct.ph7_hashmap_node, ptr %12, i32 0, i32 5
  store i32 %11, ptr %nValIdx3, align 8
