...
define dso_local i32 @ph7_result_int64(ptr noundef %pCtx, i64 noundef %iValue) #0 {
entry:
  ...
  %2 = load i64, ptr %iValue.addr, align 8
  %call = call i32 @ph7_value_int64(ptr noundef %1, i64 noundef %2)
  ret i32 %call
}
