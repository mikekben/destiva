...
; Function Attrs: nounwind uwtable
define hidden i32 @VmXMLNSEndHandler(ptr noundef %pPrefixStr, ptr noundef %pUserData) #0 {
entry:
  ...
  %arrayidx = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 9
...
if.end:                                           ; preds = %entry
  ...
  %6 = load ptr, ptr %pPrefixStr.addr, align 8
