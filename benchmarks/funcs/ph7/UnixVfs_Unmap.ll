...
define hidden void @UnixVfs_Unmap(ptr noundef %pView, i64 noundef %nSize) #0 {
entry:
  ...
  %0 = load ptr, ptr %pView.addr, align 8
  %1 = load i64, ptr %nSize.addr, align 8
  %call = call i32 @munmap(ptr noundef %0, i64 noundef %1) #2
  ret void
}
