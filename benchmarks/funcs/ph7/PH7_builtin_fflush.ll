...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_fflush(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false14:                                  ; preds = %if.end11
  ...
  %xSync = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %15, i32 0, i32 14
  %16 = load ptr, ptr %xSync, align 8
...
if.end21:                                         ; preds = %lor.lhs.false14
  ...
  %xSync22 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %23, i32 0, i32 14
  %24 = load ptr, ptr %xSync22, align 8
  ...
  %call23 = call i32 %24(ptr noundef %26)
  ...
  %call25 = call i32 @ph7_result_bool(ptr noundef %27, i32 noundef %conv)
  store i32 0, ptr %retval, align 4
  br label %return
