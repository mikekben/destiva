...
@aHashmapFunc = external hidden constant [61 x %struct.ph7_builtin_func], align 16

; Function Attrs: nounwind uwtable
declare dso_local i32 @ph7_create_function(ptr noundef, ptr noundef, ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @PH7_RegisterHashmapFunctions(ptr noundef %pVm) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds nuw [61 x %struct.ph7_builtin_func], ptr @aHashmapFunc, i64 0, i64 %idxprom
  ...
  %arrayidx3 = getelementptr inbounds nuw [61 x %struct.ph7_builtin_func], ptr @aHashmapFunc, i64 0, i64 %idxprom2
