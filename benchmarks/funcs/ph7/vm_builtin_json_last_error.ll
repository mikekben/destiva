...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_json_last_error(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %json_rc = getelementptr inbounds nuw %struct.ph7_vm, ptr %3, i32 0, i32 39
  %4 = load i32, ptr %json_rc, align 8
  %call = call i32 @ph7_result_int(ptr noundef %2, i32 noundef %4)
