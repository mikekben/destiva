...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_disk_free_space(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false4:                                   ; preds = %if.end
  ...
  %xFreeSpace = getelementptr inbounds nuw %struct.ph7_vfs, ptr %6, i32 0, i32 16
  %7 = load ptr, ptr %xFreeSpace, align 8
...
if.end10:                                         ; preds = %lor.lhs.false4
  ...
  %xFreeSpace13 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %13, i32 0, i32 16
  %14 = load ptr, ptr %xFreeSpace13, align 8
