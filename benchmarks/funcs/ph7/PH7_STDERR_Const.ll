...
; Function Attrs: nounwind uwtable
define hidden void @PH7_STDERR_Const(ptr noundef %pVal, ptr noundef %pUserData) #0 {
entry:
  ...
  %call = call ptr @PH7_ExportStderr(ptr noundef %1)
...
; Function Attrs: nounwind uwtable
declare hidden ptr @PH7_ExportStderr(ptr noundef) #0
