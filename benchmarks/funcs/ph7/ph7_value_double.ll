...
; Function Attrs: nounwind uwtable
define dso_local i32 @ph7_value_double(ptr noundef %pVal, double noundef %Value) #0 {
entry:
  ...
  store double %1, ptr %rVal, align 8
  ...
  %call2 = call i32 @PH7_MemObjTryInteger(ptr noundef %6)
  ret i32 0
}
