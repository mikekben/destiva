...
; Function Attrs: nounwind uwtable
define hidden ptr @PH7_NewClassInstance(ptr noundef %pVm, ptr noundef %pClass) #0 {
entry:
  ...
  %call = call ptr @NewClassInstance(ptr noundef %0, ptr noundef %1)
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i32 @PH7_VmCreateClassInstanceFrame(ptr noundef %3, ptr noundef %4)
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = call i32 @SyMemBackendPoolFree(ptr noundef %sAllocator, ptr noundef %7)
  store ptr null, ptr %retval, align 8
  br label %return
