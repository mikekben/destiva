...
@aVmFunc = external hidden constant [124 x %struct.ph7_builtin_func], align 16

; Function Attrs: nounwind uwtable
declare dso_local i32 @ph7_create_function(ptr noundef, ptr noundef, ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden i32 @VmRegisterSpecialFunction(ptr noundef %pVm) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds nuw [124 x %struct.ph7_builtin_func], ptr @aVmFunc, i64 0, i64 %idxprom
  ...
  %arrayidx3 = getelementptr inbounds nuw [124 x %struct.ph7_builtin_func], ptr @aVmFunc, i64 0, i64 %idxprom2
  ...
  %call = call i32 @ph7_create_function(ptr noundef %1, ptr noundef %3, ptr noundef %5, ptr noundef %6)
