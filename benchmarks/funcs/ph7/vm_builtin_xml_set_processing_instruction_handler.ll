...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_set_processing_instruction_handler(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then11:                                        ; preds = %if.end9
  ...
  %arrayidx13 = getelementptr inbounds [10 x %struct.ph7_value], ptr %aCB, i64 0, i64 3
...
if.end15:                                         ; preds = %if.then11, %if.end9
  ...
  %call16 = call i32 @ph7_result_bool(ptr noundef %14, i32 noundef 1)
  store i32 0, ptr %retval, align 4
  br label %return
