...
define hidden void @PH7_StreamCloseHandle(ptr noundef %pStream, ptr noundef %pHandle) #0 {
entry:
  ...
  %xClose = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %0, i32 0, i32 4
  %1 = load ptr, ptr %xClose, align 8
  %tobool = icmp ne ptr %1, null
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load ptr, ptr %pStream.addr, align 8
  %xClose1 = getelementptr inbounds nuw %struct.ph7_io_stream, ptr %2, i32 0, i32 4
  %3 = load ptr, ptr %xClose1, align 8
