...
; Function Attrs: nounwind uwtable
define hidden i32 @ph7_hashmap_erase(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  store ptr %4, ptr %pMap, align 8
  %5 = load ptr, ptr %pMap, align 8
  %call1 = call i32 @PH7_HashmapRelease(ptr noundef %5, i32 noundef 0)
  store i32 0, ptr %retval, align 4
  br label %return
