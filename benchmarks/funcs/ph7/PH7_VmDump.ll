...
define hidden i32 @PH7_VmDump(ptr noundef %pVm, ptr noundef %xConsumer, ptr noundef %pUserData) #0 {
entry:
  ...
  %2 = load ptr, ptr %xConsumer.addr, align 8
  %3 = load ptr, ptr %pUserData.addr, align 8
  %call = call i32 @VmByteCodeDump(ptr noundef %1, ptr noundef %2, ptr noundef %3)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @VmByteCodeDump(ptr noundef, ptr noundef, ptr noundef) #0
