...
define hidden i32 @PH7_MemObjToBool(ptr noundef %pObj) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 @MemObjBooleanValue(ptr noundef %2)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @MemObjBooleanValue(ptr noundef) #0
