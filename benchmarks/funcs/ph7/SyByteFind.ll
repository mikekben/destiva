...
define hidden i32 @SyByteFind(ptr noundef %zStr, i32 noundef %nLen, i32 noundef %c, ptr noundef %pPos) #0 {
entry:
...
if.then5:                                         ; preds = %if.then4
  ...
  %10 = load ptr, ptr %zStr.addr, align 8
...
if.then37:                                        ; preds = %if.then35
  ...
  %30 = load ptr, ptr %zStr.addr, align 8
...
if.end43:                                         ; preds = %if.end30
  ...
  %incdec.ptr44 = getelementptr inbounds nuw i8, ptr %32, i32 1
...
if.then55:                                        ; preds = %if.then53
  ...
  %40 = load ptr, ptr %zStr.addr, align 8
...
if.end61:                                         ; preds = %if.end48
  ...
  %incdec.ptr62 = getelementptr inbounds nuw i8, ptr %42, i32 1
  store ptr %incdec.ptr62, ptr %zIn, align 8
  br label %for.cond
