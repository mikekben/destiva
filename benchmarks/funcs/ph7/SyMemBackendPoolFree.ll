...
define hidden i32 @SyMemBackendPoolFree(ptr noundef %pBackend, ptr noundef %pChunk) #0 {
entry:
...
if.end5:                                          ; preds = %if.end, %entry
  ...
  %10 = load ptr, ptr %pChunk.addr, align 8
  %call = call i32 @MemBackendPoolFree(ptr noundef %9, ptr noundef %10)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @MemBackendPoolFree(ptr noundef, ptr noundef) #0
