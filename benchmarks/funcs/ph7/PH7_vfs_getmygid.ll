...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_vfs_getmygid(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %xGid = getelementptr inbounds nuw %struct.ph7_vfs, ptr %2, i32 0, i32 40
  %3 = load ptr, ptr %xGid, align 8
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %xGid5 = getelementptr inbounds nuw %struct.ph7_vfs, ptr %7, i32 0, i32 40
  %8 = load ptr, ptr %xGid5, align 8
  %call6 = call i32 %8()
  store i32 %call6, ptr %nGid, align 4
  %9 = load ptr, ptr %pCtx.addr, align 8
  %10 = load i32, ptr %nGid, align 4
  %call7 = call i32 @ph7_result_int(ptr noundef %9, i32 noundef %10)
  store i32 0, ptr %retval, align 4
  br label %return
