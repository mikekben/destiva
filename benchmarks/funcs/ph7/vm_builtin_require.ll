...
@.str.622 = external hidden unnamed_addr constant [37 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_require(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end6:                                          ; preds = %if.end
  ...
  %call7 = call i32 @VmExecIncludedFile(ptr noundef %6, ptr noundef %sFile, i32 noundef 0)
...
if.then9:                                         ; preds = %if.end6
  ...
  %call10 = call i32 (ptr, i32, ptr, ...) @ph7_context_throw_error_format(ptr noundef %8, i32 noundef 1, ptr noundef @.str.622, ptr noundef %sFile)
  %9 = load ptr, ptr %pCtx.addr, align 8
  %call11 = call i32 @ph7_result_bool(ptr noundef %9, i32 noundef 0)
