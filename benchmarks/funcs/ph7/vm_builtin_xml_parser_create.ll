...
; Function Attrs: nounwind uwtable
define hidden i32 @vm_builtin_xml_parser_create(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
  ...
  %call = call ptr @VmCreateXMLEngine(ptr noundef %0, i32 noundef 0, i32 noundef 58)
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 @ph7_context_throw_error(ptr noundef %2, i32 noundef 1, ptr noundef @.str.536)
  %3 = load ptr, ptr %pCtx.addr, align 8
  %call2 = call i32 @ph7_result_null(ptr noundef %3)
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @ph7_result_resource(ptr noundef %4, ptr noundef %5)
  store i32 0, ptr %retval, align 4
  br label %return
