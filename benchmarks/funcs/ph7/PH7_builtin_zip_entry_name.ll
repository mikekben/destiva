...
; Function Attrs: nounwind uwtable
define hidden i32 @PH7_builtin_zip_entry_name(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.end11:                                         ; preds = %lor.lhs.false6
  ...
  %sFileName = getelementptr inbounds nuw %struct.SyArchiveEntry, ptr %12, i32 0, i32 8
  store ptr %sFileName, ptr %pName, align 8
  %13 = load ptr, ptr %pCtx.addr, align 8
  %14 = load ptr, ptr %pName, align 8
  %zString = getelementptr inbounds nuw %struct.SyString, ptr %14, i32 0, i32 0
  ...
  %call12 = call i32 @ph7_result_string(ptr noundef %13, ptr noundef %15, i32 noundef %17)
  store i32 0, ptr %retval, align 4
  br label %return
