...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @getopt_long_only(i32 noundef %argc, ptr noundef %argv, ptr noundef %options, ptr noundef %long_options, ptr noundef %opt_index) #0 {
entry:
  ...
  %call = call i32 @_getopt_internal(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, i32 noundef 1), !mymd !21
