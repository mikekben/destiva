...
@.str.633 = external hidden unnamed_addr constant [19 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden ptr @windowFind(ptr noundef %pParse, ptr noundef %pList, ptr noundef %zName) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %zName1 = getelementptr inbounds nuw %struct.Window, ptr %2, i32 0, i32 0
  %3 = load ptr, ptr %zName1, align 8
  %4 = load ptr, ptr %zName.addr, align 8
  %call = call i32 @sqlite3StrICmp(ptr noundef %3, ptr noundef %4)
...
for.inc:                                          ; preds = %if.end
  ...
  %pNextWin = getelementptr inbounds nuw %struct.Window, ptr %5, i32 0, i32 12
  %6 = load ptr, ptr %pNextWin, align 8
...
if.then3:                                         ; preds = %for.end
  ...
  call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef %8, ptr noundef @.str.633, ptr noundef %9)
  br label %if.end4
