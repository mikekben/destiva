...
; Function Attrs: nounwind uwtable
define hidden void @totalFinalize(ptr noundef %context) #0 {
entry:
...
cond.true:                                        ; preds = %entry
  ...
  %rSum = getelementptr inbounds nuw %struct.SumCtx, ptr %3, i32 0, i32 0
  %4 = load double, ptr %rSum, align 8
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi double [ %4, %cond.true ], [ 0.000000e+00, %cond.false ]
  call void @sqlite3_result_double(ptr noundef %1, double noundef %cond)
  ret void
}
