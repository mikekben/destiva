...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_create_function_v2(ptr noundef %db, ptr noundef %zFunc, i32 noundef %nArg, i32 noundef %enc, ptr noundef %p, ptr noundef %xSFunc, ptr noundef %xStep, ptr noundef %xFinal, ptr noundef %xDestroy) #0 {
entry:
  ...
  %call = call i32 @createFunctionApi(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, ptr noundef %7, ptr noundef null, ptr noundef null, ptr noundef %8)
  ret i32 %call
}
