...
; Function Attrs: nounwind uwtable
define hidden ptr @sqlite3FkReferences(ptr noundef %pTab) #0 {
entry:
  %pTab.addr = alloca ptr, align 8
  store ptr %pTab, ptr %pTab.addr, align 8
  %0 = load ptr, ptr %pTab.addr, align 8
  %pSchema = getelementptr inbounds nuw %struct.Table, ptr %0, i32 0, i32 20
  %1 = load ptr, ptr %pSchema, align 8
  %fkeyHash = getelementptr inbounds nuw %struct.Schema, ptr %1, i32 0, i32 5
  %2 = load ptr, ptr %pTab.addr, align 8
  %zName = getelementptr inbounds nuw %struct.Table, ptr %2, i32 0, i32 0
  %3 = load ptr, ptr %zName, align 8
  %call = call ptr @sqlite3HashFind(ptr noundef %fkeyHash, ptr noundef %3)
  ret ptr %call
}
