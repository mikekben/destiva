...
define dso_local void @sqlite3_log(i32 noundef %iErrCode, ptr noundef %zFormat, ...) #1 {
entry:
  ...
  %0 = load ptr, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 34), align 8
...
if.then:                                          ; preds = %entry
  ...
  call void @renderLogMsg(i32 noundef %1, ptr noundef %2, ptr noundef %arraydecay1)
...
; Function Attrs: nounwind uwtable
declare hidden void @renderLogMsg(i32 noundef, ptr noundef, ptr noundef) #1
