...
; Function Attrs: nounwind uwtable
define hidden i32 @nameInUsingClause(ptr noundef %pUsing, ptr noundef %zCol) #0 {
entry:
  ...
  %0 = load ptr, ptr %pUsing.addr, align 8
...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  %2 = load ptr, ptr %pUsing.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %8 = load ptr, ptr %zCol.addr, align 8
