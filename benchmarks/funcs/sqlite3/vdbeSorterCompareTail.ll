...
; Function Attrs: nounwind uwtable
define hidden i32 @vdbeSorterCompareTail(ptr noundef %pTask, ptr noundef %pbKey2Cached, ptr noundef %pKey1, i32 noundef %nKey1, ptr noundef %pKey2, i32 noundef %nKey2) #0 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call = call i32 @sqlite3VdbeRecordCompareWithSkip(i32 noundef %11, ptr noundef %12, ptr noundef %13, i32 noundef 1)
  ret i32 %call
}
