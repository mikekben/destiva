...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3VectorErrorMsg(ptr noundef %pParse, ptr noundef %pExpr) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %x = getelementptr inbounds nuw %struct.Expr, ptr %3, i32 0, i32 6
  ...
  call void @sqlite3SubselectError(ptr noundef %2, i32 noundef %6, i32 noundef 1)
  br label %if.end

if.else:                                          ; preds = %entry
  %7 = load ptr, ptr %pParse.addr, align 8
  call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef %7, ptr noundef @.str.566)
  br label %if.end
