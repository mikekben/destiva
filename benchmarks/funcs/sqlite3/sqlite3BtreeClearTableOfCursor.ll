...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeClearTableOfCursor(ptr noundef %pCur) #0 {
entry:
  ...
  %pgnoRoot = getelementptr inbounds nuw %struct.BtCursor, ptr %2, i32 0, i32 12
  %3 = load i32, ptr %pgnoRoot, align 8
  %call = call i32 @sqlite3BtreeClearTable(ptr noundef %1, i32 noundef %3, ptr noundef null)
  ret i32 %call
}
