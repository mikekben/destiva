...
define hidden ptr @sqlite3PcacheFetch(ptr noundef %pCache, i32 noundef %pgno, i32 noundef %createFlag) #0 {
entry:
  %pCache.addr = alloca ptr, align 8
  %pgno.addr = alloca i32, align 4
  %createFlag.addr = alloca i32, align 4
  %eCreate = alloca i32, align 4
  ...
  %0 = load i32, ptr %createFlag.addr, align 4
  %1 = load ptr, ptr %pCache.addr, align 8
  %eCreate1 = getelementptr inbounds nuw %struct.PCache, ptr %1, i32 0, i32 9
  %2 = load i8, ptr %eCreate1, align 1
  %conv = zext i8 %2 to i32
  %and = and i32 %0, %conv
  store i32 %and, ptr %eCreate, align 4
  %3 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_pcache_methods2, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 14), i32 0, i32 7), align 8
  %4 = load ptr, ptr %pCache.addr, align 8
  %pCache2 = getelementptr inbounds nuw %struct.PCache, ptr %4, i32 0, i32 12
  %5 = load ptr, ptr %pCache2, align 8
  %6 = load i32, ptr %pgno.addr, align 4
  %7 = load i32, ptr %eCreate, align 4
  %call = call ptr %3(ptr noundef %5, i32 noundef %6, i32 noundef %7)
  store ptr %call, ptr %pRes, align 8
  %8 = load ptr, ptr %pRes, align 8
  ret ptr %8
}
