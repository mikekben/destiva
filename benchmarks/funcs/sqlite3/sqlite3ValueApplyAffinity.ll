...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ValueApplyAffinity(ptr noundef %pVal, i8 noundef zeroext %affinity, i8 noundef zeroext %enc) #0 {
entry:
  ...
  %1 = load i8, ptr %affinity.addr, align 1
  %2 = load i8, ptr %enc.addr, align 1
  call void @applyAffinity(ptr noundef %0, i8 noundef signext %1, i8 noundef zeroext %2)
  ret void
}
