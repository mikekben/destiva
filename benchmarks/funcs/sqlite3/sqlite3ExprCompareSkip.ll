...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3ExprCompareSkip(ptr noundef %pA, ptr noundef %pB, i32 noundef %iTab) #0 {
entry:
  ...
  %call1 = call ptr @sqlite3ExprSkipCollateAndLikely(ptr noundef %1)
  %2 = load i32, ptr %iTab.addr, align 4
  %call2 = call i32 @sqlite3ExprCompare(ptr noundef null, ptr noundef %call, ptr noundef %call1, i32 noundef %2)
  ret i32 %call2
}
