...
define hidden i32 @sqlite3PcachePagecount(ptr noundef %pCache) #0 {
entry:
  %pCache.addr = alloca ptr, align 8
  store ptr %pCache, ptr %pCache.addr, align 8
  %0 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_pcache_methods2, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 14), i32 0, i32 6), align 8
  %1 = load ptr, ptr %pCache.addr, align 8
  %pCache1 = getelementptr inbounds nuw %struct.PCache, ptr %1, i32 0, i32 12
  %2 = load ptr, ptr %pCache1, align 8
  %call = call i32 %0(ptr noundef %2)
  ret i32 %call
}
