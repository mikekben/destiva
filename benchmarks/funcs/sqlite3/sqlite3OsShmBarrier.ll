...
define hidden void @sqlite3OsShmBarrier(ptr noundef %id) #0 {
entry:
  ...
  %xShmBarrier = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 15
  %2 = load ptr, ptr %xShmBarrier, align 8
