...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3MallocAlarm(i32 noundef %nByte) #0 {
entry:
  %nByte.addr = alloca i32, align 4
  store i32 %nByte, ptr %nByte.addr, align 4
  %0 = load i64, ptr getelementptr inbounds nuw (%struct.Mem0Global, ptr @mem0, i32 0, i32 1), align 8
...
if.end:                                           ; preds = %entry
  ...
  call void @sqlite3_mutex_leave(ptr noundef %1)
  %2 = load i32, ptr %nByte.addr, align 4
  %call = call i32 @sqlite3_release_memory(i32 noundef %2)
