...
define hidden i32 @sqlite3OsFileSize(ptr noundef %id, ptr noundef %pSize) #0 {
entry:
  ...
  %xFileSize = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 6
  %2 = load ptr, ptr %xFileSize, align 8
