...
define hidden i32 @getPageError(ptr noundef %pPager, i32 noundef %pgno, ptr noundef %ppPage, i32 noundef %flags) #0 {
entry:
  ...
  %errCode = getelementptr inbounds nuw %struct.Pager, ptr %3, i32 0, i32 25
