...
define hidden i32 @sqlite3BtreeCursorHasHint(ptr noundef %pCsr, i32 noundef %mask) #0 {
entry:
  ...
  %hints = getelementptr inbounds nuw %struct.BtCursor, ptr %0, i32 0, i32 3
  %1 = load i8, ptr %hints, align 1
