...
define hidden i32 @sqlite3WhereBreakLabel(ptr noundef %pWInfo) #0 {
entry:
  %pWInfo.addr = alloca ptr, align 8
  store ptr %pWInfo, ptr %pWInfo.addr, align 8
  %0 = load ptr, ptr %pWInfo.addr, align 8
  %iBreak = getelementptr inbounds nuw %struct.WhereInfo, ptr %0, i32 0, i32 8
  %1 = load i32, ptr %iBreak, align 8
  ret i32 %1
}
