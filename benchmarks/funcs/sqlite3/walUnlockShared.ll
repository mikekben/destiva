...
define hidden void @walUnlockShared(ptr noundef %pWal, i32 noundef %lockIdx) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call i32 @sqlite3OsShmLock(ptr noundef %3, i32 noundef %4, i32 noundef 1, i32 noundef 5)
  br label %return
