...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_vmprintf(ptr noundef %zFormat, ptr noundef %ap) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  call void @sqlite3StrAccumInit(ptr noundef %acc, ptr noundef null, ptr noundef %arraydecay, i32 noundef 70, i32 noundef 1000000000)
  ...
  %call1 = call ptr @sqlite3StrAccumFinish(ptr noundef %acc)
