...
define hidden i32 @sqlite3WhereIsDistinct(ptr noundef %pWInfo) #0 {
entry:
  %pWInfo.addr = alloca ptr, align 8
  store ptr %pWInfo, ptr %pWInfo.addr, align 8
  %0 = load ptr, ptr %pWInfo.addr, align 8
  %eDistinct = getelementptr inbounds nuw %struct.WhereInfo, ptr %0, i32 0, i32 16
  %1 = load i8, ptr %eDistinct, align 1
