...
; Function Attrs: nounwind uwtable
define hidden void @codeOffset(ptr noundef %v, i32 noundef %iOffset, i32 noundef %iContinue) #0 {
entry:
  ...
  %0 = load i32, ptr %iOffset.addr, align 4
...
if.then:                                          ; preds = %entry
  ...
  %3 = load i32, ptr %iContinue.addr, align 4
  %call = call i32 @sqlite3VdbeAddOp3(ptr noundef %1, i32 noundef 47, i32 noundef %2, i32 noundef %3, i32 noundef 1)
  br label %if.end
