...
define hidden void @pcacheUnpin(ptr noundef %p) #0 {
entry:
  ...
  %bPurgeable = getelementptr inbounds nuw %struct.PCache, ptr %1, i32 0, i32 8
  %2 = load i8, ptr %bPurgeable, align 4
  %tobool = icmp ne i8 %2, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %3 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_pcache_methods2, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 14), i32 0, i32 8), align 8
  %4 = load ptr, ptr %p.addr, align 8
  %pCache1 = getelementptr inbounds nuw %struct.PgHdr, ptr %4, i32 0, i32 3
  %5 = load ptr, ptr %pCache1, align 8
  %pCache2 = getelementptr inbounds nuw %struct.PCache, ptr %5, i32 0, i32 12
  %6 = load ptr, ptr %pCache2, align 8
  %7 = load ptr, ptr %p.addr, align 8
  %pPage = getelementptr inbounds nuw %struct.PgHdr, ptr %7, i32 0, i32 0
  %8 = load ptr, ptr %pPage, align 8
  call void %3(ptr noundef %6, ptr noundef %8, i32 noundef 0)
  br label %if.end
