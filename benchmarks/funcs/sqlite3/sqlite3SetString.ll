...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3SetString(ptr noundef %pz, ptr noundef %db, ptr noundef %zNew) #0 {
entry:
  ...
  %call = call ptr @sqlite3DbStrDup(ptr noundef %3, ptr noundef %4)
  %5 = load ptr, ptr %pz.addr, align 8
