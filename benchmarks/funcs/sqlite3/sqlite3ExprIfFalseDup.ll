...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprIfFalseDup(ptr noundef %pParse, ptr noundef %pExpr, i32 noundef %dest, i32 noundef %jumpIfNull) #0 {
entry:
  ...
  store ptr %call, ptr %pCopy, align 8
...
if.then:                                          ; preds = %entry
  ...
  %7 = load ptr, ptr %pCopy, align 8
  %8 = load i32, ptr %dest.addr, align 4
  %9 = load i32, ptr %jumpIfNull.addr, align 4
  call void @sqlite3ExprIfFalse(ptr noundef %6, ptr noundef %7, i32 noundef %8, i32 noundef %9)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %10 = load ptr, ptr %db, align 8
  %11 = load ptr, ptr %pCopy, align 8
  call void @sqlite3ExprDelete(ptr noundef %10, ptr noundef %11)
  ret void
}
