...
; Function Attrs: nounwind uwtable
define hidden i32 @renameTableExprCb(ptr noundef %pWalker, ptr noundef %pExpr) #0 {
entry:
...
land.lhs.true:                                    ; preds = %entry
  ...
  %pTab = getelementptr inbounds nuw %struct.RenameCtx, ptr %4, i32 0, i32 3
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %y4 = getelementptr inbounds nuw %struct.Expr, ptr %11, i32 0, i32 14
  call void @renameTokenFind(ptr noundef %9, ptr noundef %10, ptr noundef %y4)
  br label %if.end
