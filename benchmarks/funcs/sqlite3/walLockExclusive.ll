...
define hidden i32 @walLockExclusive(ptr noundef %pWal, i32 noundef %lockIdx, i32 noundef %n) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call i32 @sqlite3OsShmLock(ptr noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef 10)
