...
define dso_local void @sqlite3_result_int(ptr noundef %pCtx, i32 noundef %iVal) #0 {
entry:
  ...
  %2 = load i32, ptr %iVal.addr, align 4
  %conv = sext i32 %2 to i64
  call void @sqlite3VdbeMemSetInt64(ptr noundef %1, i64 noundef %conv)
  ret void
}
