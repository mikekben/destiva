...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3TokenInit(ptr noundef %p, ptr noundef %z) #0 {
entry:
  ...
  %z1 = getelementptr inbounds nuw %struct.Token, ptr %1, i32 0, i32 0
  store ptr %0, ptr %z1, align 8
