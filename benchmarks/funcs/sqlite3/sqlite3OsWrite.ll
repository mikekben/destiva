...
define hidden i32 @sqlite3OsWrite(ptr noundef %id, ptr noundef %pBuf, i32 noundef %amt, i64 noundef %offset) #0 {
entry:
  ...
  %xWrite = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 3
  %2 = load ptr, ptr %xWrite, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load ptr, ptr %pBuf.addr, align 8
