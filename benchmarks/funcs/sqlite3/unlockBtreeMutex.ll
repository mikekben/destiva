...
; Function Attrs: nounwind uwtable
define hidden void @unlockBtreeMutex(ptr noundef %p) #0 {
entry:
  ...
  %mutex = getelementptr inbounds nuw %struct.BtShared, ptr %2, i32 0, i32 21
  %3 = load ptr, ptr %mutex, align 8
  call void @sqlite3_mutex_leave(ptr noundef %3)
  %4 = load ptr, ptr %p.addr, align 8
  %locked = getelementptr inbounds nuw %struct.Btree, ptr %4, i32 0, i32 4
  store i8 0, ptr %locked, align 2
  ret void
}
