...
define hidden void @disableLookaside(ptr noundef %pParse) #0 {
entry:
  %pParse.addr = alloca ptr, align 8
  store ptr %pParse, ptr %pParse.addr, align 8
  %0 = load ptr, ptr %pParse.addr, align 8
  %disableLookaside = getelementptr inbounds nuw %struct.Parse, ptr %0, i32 0, i32 12
  %1 = load i8, ptr %disableLookaside, align 4
  %inc = add i8 %1, 1
  ...
  %inc1 = add i32 %4, 1
  store i32 %inc1, ptr %bDisable, align 8
  ret void
}
