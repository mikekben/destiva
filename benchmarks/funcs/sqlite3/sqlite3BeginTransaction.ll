...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3BeginTransaction(ptr noundef %pParse, i32 noundef %type) #0 {
entry:
  ...
  %call = call i32 @sqlite3AuthCheck(ptr noundef %2, i32 noundef 22, ptr noundef @.str.386, ptr noundef null, ptr noundef null)
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call ptr @sqlite3GetVdbe(ptr noundef %3)
...
for.body:                                         ; preds = %for.cond
  ...
  %call9 = call i32 @sqlite3VdbeAddOp2(ptr noundef %9, i32 noundef 2, i32 noundef %10, i32 noundef %add)
  %12 = load ptr, ptr %v, align 8
  %13 = load i32, ptr %i, align 4
  call void @sqlite3VdbeUsesBtree(ptr noundef %12, i32 noundef %13)
  br label %for.inc
...
if.end10:                                         ; preds = %for.end, %if.end5
  ...
  %call11 = call i32 @sqlite3VdbeAddOp0(ptr noundef %15, i32 noundef 1)
  br label %return
