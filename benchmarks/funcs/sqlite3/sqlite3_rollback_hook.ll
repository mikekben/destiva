...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_rollback_hook(ptr noundef %db, ptr noundef %xCallback, ptr noundef %pArg) #0 {
entry:
  ...
  %pRollbackArg = getelementptr inbounds nuw %struct.sqlite3, ptr %2, i32 0, i32 49
  %3 = load ptr, ptr %pRollbackArg, align 8
  store ptr %3, ptr %pRet, align 8
  %4 = load ptr, ptr %xCallback.addr, align 8
  %5 = load ptr, ptr %db.addr, align 8
  %xRollbackCallback = getelementptr inbounds nuw %struct.sqlite3, ptr %5, i32 0, i32 50
  store ptr %4, ptr %xRollbackCallback, align 8
  %6 = load ptr, ptr %pArg.addr, align 8
  %7 = load ptr, ptr %db.addr, align 8
  %pRollbackArg1 = getelementptr inbounds nuw %struct.sqlite3, ptr %7, i32 0, i32 49
  store ptr %6, ptr %pRollbackArg1, align 8
