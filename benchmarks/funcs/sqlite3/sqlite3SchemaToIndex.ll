...
define hidden i32 @sqlite3SchemaToIndex(ptr noundef %db, ptr noundef %pSchema) #0 {
entry:
  ...
  store i32 -1000000, ptr %i, align 4
  %0 = load ptr, ptr %pSchema.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load ptr, ptr %pSchema1, align 8
  %5 = load ptr, ptr %pSchema.addr, align 8
  %cmp = icmp eq ptr %4, %5
