...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprCodeCopy(ptr noundef %pParse, ptr noundef %pExpr, i32 noundef %target) #0 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @sqlite3ExprDelete(ptr noundef %9, ptr noundef %10)
  ret void
}
