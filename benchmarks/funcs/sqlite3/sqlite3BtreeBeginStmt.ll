...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeBeginStmt(ptr noundef %p, i32 noundef %iStatement) #0 {
entry:
  %p.addr = alloca ptr, align 8
  %iStatement.addr = alloca i32, align 4
  %rc = alloca i32, align 4
  %pBt = alloca ptr, align 8
  store ptr %p, ptr %p.addr, align 8
  store i32 %iStatement, ptr %iStatement.addr, align 4
  ...
  %5 = load i32, ptr %iStatement.addr, align 4
  %call = call i32 @sqlite3PagerOpenSavepoint(ptr noundef %4, i32 noundef %5)
