...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeCommit(ptr noundef %p) #0 {
entry:
  ...
  %call = call i32 @sqlite3BtreeCommitPhaseOne(ptr noundef %1, ptr noundef null)
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i32 @sqlite3BtreeCommitPhaseTwo(ptr noundef %3, i32 noundef 0)
