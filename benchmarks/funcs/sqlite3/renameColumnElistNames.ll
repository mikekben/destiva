...
; Function Attrs: nounwind uwtable
define hidden void @renameColumnElistNames(ptr noundef %pParse, ptr noundef %pCtx, ptr noundef %pEList, ptr noundef %zOld) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %zName1 = getelementptr inbounds nuw %struct.ExprList_item, ptr %arrayidx, i32 0, i32 1
  %6 = load ptr, ptr %zName1, align 8
  store ptr %6, ptr %zName, align 8
  %7 = load ptr, ptr %zName, align 8
  %8 = load ptr, ptr %zOld.addr, align 8
  %call = call i32 @sqlite3_stricmp(ptr noundef %7, ptr noundef %8)
...
if.then3:                                         ; preds = %for.body
  ...
  call void @renameTokenFind(ptr noundef %9, ptr noundef %10, ptr noundef %11)
  br label %if.end
