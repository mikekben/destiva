...
define hidden i32 @sqlite3OsTruncate(ptr noundef %id, i64 noundef %size) #0 {
entry:
  ...
  %xTruncate = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 4
  %2 = load ptr, ptr %xTruncate, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i64, ptr %size.addr, align 8
  %call = call i32 %2(ptr noundef %3, i64 noundef %4)
  ret i32 %call
}
