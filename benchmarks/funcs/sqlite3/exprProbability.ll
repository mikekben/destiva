...
; Function Attrs: nounwind uwtable
define hidden i32 @exprProbability(ptr noundef %p) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @sqlite3AtoF(ptr noundef %3, ptr noundef %r, i32 noundef %call, i8 noundef zeroext 1)
  %6 = load double, ptr %r, align 8
  %cmp4 = fcmp ogt double %6, 1.000000e+00
...
if.end7:                                          ; preds = %if.end
  ...
  %mul = fmul double %7, 0x41A0000000000000
