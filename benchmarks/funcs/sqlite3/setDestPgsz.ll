...
define hidden i32 @setDestPgsz(ptr noundef %p) #0 {
entry:
  ...
  %call = call i32 @sqlite3BtreeGetPageSize(ptr noundef %3)
  %call1 = call i32 @sqlite3BtreeSetPageSize(ptr noundef %1, i32 noundef %call, i32 noundef -1, i32 noundef 0)
