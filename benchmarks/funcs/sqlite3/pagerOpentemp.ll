...
; Function Attrs: nounwind uwtable
define hidden i32 @pagerOpentemp(ptr noundef %pPager, ptr noundef %pFile, i32 noundef %vfsFlags) #0 {
entry:
  ...
  %0 = load i32, ptr %vfsFlags.addr, align 4
  %or = or i32 %0, 30
  store i32 %or, ptr %vfsFlags.addr, align 4
  %1 = load ptr, ptr %pPager.addr, align 8
  %pVfs = getelementptr inbounds nuw %struct.Pager, ptr %1, i32 0, i32 0
  %2 = load ptr, ptr %pVfs, align 8
  %3 = load ptr, ptr %pFile.addr, align 8
  %4 = load i32, ptr %vfsFlags.addr, align 4
  %call = call i32 @sqlite3OsOpen(ptr noundef %2, ptr noundef null, ptr noundef %3, i32 noundef %4, ptr noundef null)
