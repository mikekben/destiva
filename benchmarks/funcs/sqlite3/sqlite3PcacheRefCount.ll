...
define hidden i32 @sqlite3PcacheRefCount(ptr noundef %pCache) #0 {
entry:
  %pCache.addr = alloca ptr, align 8
  store ptr %pCache, ptr %pCache.addr, align 8
  %0 = load ptr, ptr %pCache.addr, align 8
  %nRefSum = getelementptr inbounds nuw %struct.PCache, ptr %0, i32 0, i32 3
  %1 = load i32, ptr %nRefSum, align 8
  ret i32 %1
}
