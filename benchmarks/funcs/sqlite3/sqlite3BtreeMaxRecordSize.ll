...
define hidden i64 @sqlite3BtreeMaxRecordSize(ptr noundef %pCur) #0 {
entry:
  ...
  %pageSize = getelementptr inbounds nuw %struct.BtShared, ptr %1, i32 0, i32 15
  %2 = load i32, ptr %pageSize, align 8
  %conv = zext i32 %2 to i64
  %3 = load ptr, ptr %pCur.addr, align 8
  %pBt1 = getelementptr inbounds nuw %struct.BtCursor, ptr %3, i32 0, i32 8
