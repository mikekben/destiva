...
; Function Attrs: nounwind uwtable
define hidden void @setSectorSize(ptr noundef %pPager) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %call = call i32 @sqlite3OsDeviceCharacteristics(ptr noundef %3)
...
if.else:                                          ; preds = %lor.lhs.false
  ...
  %call3 = call i32 @sqlite3SectorSize(ptr noundef %6)
  %7 = load ptr, ptr %pPager.addr, align 8
  %sectorSize4 = getelementptr inbounds nuw %struct.Pager, ptr %7, i32 0, i32 46
  store i32 %call3, ptr %sectorSize4, align 8
  br label %if.end
...
; Function Attrs: nounwind uwtable
declare hidden i32 @sqlite3SectorSize(ptr noundef) #0
