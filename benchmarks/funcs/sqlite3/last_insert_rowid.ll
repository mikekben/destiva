...
; Function Attrs: nounwind uwtable
declare dso_local i64 @sqlite3_last_insert_rowid(ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @last_insert_rowid(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %NotUsed2) #0 {
entry:
  ...
  %call1 = call i64 @sqlite3_last_insert_rowid(ptr noundef %4)
  call void @sqlite3_result_int64(ptr noundef %3, i64 noundef %call1)
  ret void
}
