...
; Function Attrs: nounwind uwtable
define hidden void @errlogFunc(ptr noundef %context, i32 noundef %argc, ptr noundef %argv) #0 {
entry:
  ...
  %call = call i32 @sqlite3_value_int(ptr noundef %3)
  ...
  call void (i32, ptr, ...) @sqlite3_log(i32 noundef %call, ptr noundef @.str.20, ptr noundef %call2)
  ret void
}
