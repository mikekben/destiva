...
define hidden void @analyzeAggregatesInSelectEnd(ptr noundef %pWalker, ptr noundef %pSelect) #0 {
entry:
  ...
  %walkerDepth = getelementptr inbounds nuw %struct.Walker, ptr %1, i32 0, i32 4
  %2 = load i32, ptr %walkerDepth, align 8
  %dec = add nsw i32 %2, -1
  store i32 %dec, ptr %walkerDepth, align 8
  ret void
}
