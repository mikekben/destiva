...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_db_filename(ptr noundef %db, ptr noundef %zDbName) #0 {
entry:
  ...
  %1 = load ptr, ptr %zDbName.addr, align 8
  %call = call ptr @sqlite3DbNameToBtree(ptr noundef %0, ptr noundef %1)
  store ptr %call, ptr %pBt, align 8
...
cond.true:                                        ; preds = %entry
  ...
  %call1 = call ptr @sqlite3BtreeGetFilename(ptr noundef %3)
  br label %cond.end
