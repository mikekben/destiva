...
define hidden i32 @sqlite3VdbeRecordCompare(i32 noundef %nKey1, ptr noundef %pKey1, ptr noundef %pPKey2) #0 {
entry:
  ...
  %2 = load ptr, ptr %pPKey2.addr, align 8
  %call = call i32 @sqlite3VdbeRecordCompareWithSkip(i32 noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef 0)
  ret i32 %call
}
