...
define dso_local i32 @sqlite3_enable_shared_cache(i32 noundef %enable) #0 {
entry:
  %enable.addr = alloca i32, align 4
  store i32 %enable, ptr %enable.addr, align 4
  %0 = load i32, ptr %enable.addr, align 4
  store i32 %0, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 25), align 4
  ret i32 0
}
