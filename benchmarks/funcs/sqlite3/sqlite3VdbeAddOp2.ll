...
define hidden i32 @sqlite3VdbeAddOp2(ptr noundef %p, i32 noundef %op, i32 noundef %p1, i32 noundef %p2) #0 {
entry:
  ...
  %call = call i32 @sqlite3VdbeAddOp3(ptr noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef 0)
  ret i32 %call
}
