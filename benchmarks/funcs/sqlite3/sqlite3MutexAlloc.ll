...
define hidden ptr @sqlite3MutexAlloc(i32 noundef %id) #0 {
entry:
  %retval = alloca ptr, align 8
  %id.addr = alloca i32, align 4
  store i32 %id, ptr %id.addr, align 4
  %0 = load i8, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 1), align 4
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_mutex_methods, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 13), i32 0, i32 2), align 8
  %2 = load i32, ptr %id.addr, align 4
  %call = call ptr %1(i32 noundef %2)
