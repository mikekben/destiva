...
define hidden void @storeLastErrno(ptr noundef %pFile, i32 noundef %error) #0 {
entry:
  ...
  %lastErrno = getelementptr inbounds nuw %struct.unixFile, ptr %1, i32 0, i32 6
  store i32 %0, ptr %lastErrno, align 8
  ret void
}
