...
define hidden i32 @sqlite3OsUnlock(ptr noundef %id, i32 noundef %lockType) #0 {
entry:
  ...
  %xUnlock = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 8
  %2 = load ptr, ptr %xUnlock, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i32, ptr %lockType.addr, align 4
