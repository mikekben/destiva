...
; Function Attrs: nounwind uwtable
define hidden void @groupConcatFinalize(ptr noundef %context) #0 {
entry:
...
if.else8:                                         ; preds = %if.else
  ...
  %call9 = call ptr @sqlite3StrAccumFinish(ptr noundef %9)
  call void @sqlite3_result_text(ptr noundef %8, ptr noundef %call9, i32 noundef -1, ptr noundef @sqlite3_free)
  br label %if.end
