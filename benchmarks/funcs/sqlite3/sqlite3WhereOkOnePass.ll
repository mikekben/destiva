...
define hidden i32 @sqlite3WhereOkOnePass(ptr noundef %pWInfo, ptr noundef %aiCur) #1 {
entry:
  %pWInfo.addr = alloca ptr, align 8
  %aiCur.addr = alloca ptr, align 8
  store ptr %pWInfo, ptr %pWInfo.addr, align 8
  store ptr %aiCur, ptr %aiCur.addr, align 8
  %0 = load ptr, ptr %aiCur.addr, align 8
  %1 = load ptr, ptr %pWInfo.addr, align 8
  %aiCurOnePass = getelementptr inbounds nuw %struct.WhereInfo, ptr %1, i32 0, i32 6
  %arraydecay = getelementptr inbounds [2 x i32], ptr %aiCurOnePass, i64 0, i64 0
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %0, ptr align 4 %arraydecay, i64 8, i1 false)
  %2 = load ptr, ptr %pWInfo.addr, align 8
  %eOnePass = getelementptr inbounds nuw %struct.WhereInfo, ptr %2, i32 0, i32 14
  %3 = load i8, ptr %eOnePass, align 1
