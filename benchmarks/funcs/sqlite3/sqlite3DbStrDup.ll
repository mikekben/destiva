...
define hidden ptr @sqlite3DbStrDup(ptr noundef %db, ptr noundef %z) #2 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call ptr @sqlite3DbMallocRaw(ptr noundef %2, i64 noundef %3)
  store ptr %call1, ptr %zNew, align 8
...
; Function Attrs: nounwind uwtable
declare hidden ptr @sqlite3DbMallocRaw(ptr noundef, i64 noundef) #2
