...
define hidden i32 @binCollFunc(ptr noundef %NotUsed, i32 noundef %nKey1, ptr noundef %pKey1, i32 noundef %nKey2, ptr noundef %pKey2) #1 {
entry:
  ...
  %1 = load i32, ptr %nKey1.addr, align 4
  %2 = load i32, ptr %nKey2.addr, align 4
...
cond.false:                                       ; preds = %entry
  %4 = load i32, ptr %nKey2.addr, align 4
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %3, %cond.true ], [ %4, %cond.false ]
  store i32 %cond, ptr %n, align 4
  %5 = load ptr, ptr %pKey1.addr, align 8
  %6 = load ptr, ptr %pKey2.addr, align 8
  %7 = load i32, ptr %n, align 4
  %conv = sext i32 %7 to i64
  %call = call i32 @memcmp(ptr noundef %5, ptr noundef %6, i64 noundef %conv) #2
...
if.then:                                          ; preds = %cond.end
  %9 = load i32, ptr %nKey1.addr, align 4
