...
define dso_local void @sqlite3_mutex_free(ptr noundef %p) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_mutex_methods, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 13), i32 0, i32 3), align 8
