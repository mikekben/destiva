...
define hidden i32 @sqlite3MutexEnd() #0 {
entry:
  %rc = alloca i32, align 4
  store i32 0, ptr %rc, align 4
  %0 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_mutex_methods, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 13), i32 0, i32 1), align 8
  %tobool = icmp ne ptr %0, null
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %1 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_mutex_methods, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 13), i32 0, i32 1), align 8
  %call = call i32 %1()
