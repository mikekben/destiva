...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeSetPagerFlags(ptr noundef %p, i32 noundef %pgFlags) #0 {
entry:
  ...
  %5 = load i32, ptr %pgFlags.addr, align 4
  call void @sqlite3PagerSetFlags(ptr noundef %4, i32 noundef %5)
...
; Function Attrs: nounwind uwtable
declare hidden void @sqlite3PagerSetFlags(ptr noundef, i32 noundef) #0
