...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3RenameExprUnmap(ptr noundef %pParse, ptr noundef %pExpr) #1 {
entry:
  ...
  store ptr @renameUnmapSelectCb, ptr %xSelectCallback, align 8
  %1 = load ptr, ptr %pExpr.addr, align 8
  %call = call i32 @sqlite3WalkExpr(ptr noundef %sWalker, ptr noundef %1)
  ret void
}
...
; Function Attrs: nounwind uwtable
declare hidden i32 @renameUnmapSelectCb(ptr noundef, ptr noundef) #1
