...
define hidden void @setPageReferenced(ptr noundef %pCheck, i32 noundef %iPg) #0 {
entry:
  ...
  %0 = load i32, ptr %iPg.addr, align 4
  %and = and i32 %0, 7
  %shl = shl i32 1, %and
  %1 = load ptr, ptr %pCheck.addr, align 8
  %aPgRef = getelementptr inbounds nuw %struct.IntegrityCk, ptr %1, i32 0, i32 2
  %2 = load ptr, ptr %aPgRef, align 8
  %3 = load i32, ptr %iPg.addr, align 4
  %div = udiv i32 %3, 8
