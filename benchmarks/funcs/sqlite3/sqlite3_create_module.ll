...
define dso_local i32 @sqlite3_create_module(ptr noundef %db, ptr noundef %zName, ptr noundef %pModule, ptr noundef %pAux) #0 {
entry:
  ...
  %call = call i32 @createModule(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef null)
  ret i32 %call
}
