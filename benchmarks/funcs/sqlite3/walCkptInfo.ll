...
define hidden ptr @walCkptInfo(ptr noundef %pWal) #0 {
entry:
  %pWal.addr = alloca ptr, align 8
  store ptr %pWal, ptr %pWal.addr, align 8
  %0 = load ptr, ptr %pWal.addr, align 8
  %apWiData = getelementptr inbounds nuw %struct.Wal, ptr %0, i32 0, i32 7
  %1 = load ptr, ptr %apWiData, align 8
  %arrayidx = getelementptr inbounds ptr, ptr %1, i64 0
  %2 = load ptr, ptr %arrayidx, align 8
  %arrayidx1 = getelementptr inbounds nuw i32, ptr %2, i64 24
  ret ptr %arrayidx1
}
