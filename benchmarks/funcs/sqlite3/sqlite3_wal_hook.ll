...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_wal_hook(ptr noundef %db, ptr noundef %xCallback, ptr noundef %pArg) #0 {
entry:
  ...
  %pWalArg = getelementptr inbounds nuw %struct.sqlite3, ptr %2, i32 0, i32 55
  %3 = load ptr, ptr %pWalArg, align 8
  store ptr %3, ptr %pRet, align 8
  %4 = load ptr, ptr %xCallback.addr, align 8
  %5 = load ptr, ptr %db.addr, align 8
  %xWalCallback = getelementptr inbounds nuw %struct.sqlite3, ptr %5, i32 0, i32 54
  store ptr %4, ptr %xWalCallback, align 8
  %6 = load ptr, ptr %pArg.addr, align 8
  %7 = load ptr, ptr %db.addr, align 8
  %pWalArg1 = getelementptr inbounds nuw %struct.sqlite3, ptr %7, i32 0, i32 55
  store ptr %6, ptr %pWalArg1, align 8
