...
define hidden void @sqlite3MayAbort(ptr noundef %pParse) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %mayAbort = getelementptr inbounds nuw %struct.Parse, ptr %5, i32 0, i32 9
  store i8 1, ptr %mayAbort, align 1
  ret void
}
