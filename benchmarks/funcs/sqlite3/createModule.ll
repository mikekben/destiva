...
; Function Attrs: nounwind uwtable
define hidden i32 @createModule(ptr noundef %db, ptr noundef %zName, ptr noundef %pModule, ptr noundef %pAux, ptr noundef %xDestroy) #0 {
entry:
  ...
  %4 = load ptr, ptr %pModule.addr, align 8
  %5 = load ptr, ptr %pAux.addr, align 8
  %6 = load ptr, ptr %xDestroy.addr, align 8
  %call = call ptr @sqlite3VtabCreateModule(ptr noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6)
  %7 = load ptr, ptr %db.addr, align 8
  %8 = load i32, ptr %rc, align 4
  %call1 = call i32 @sqlite3ApiExit(ptr noundef %7, i32 noundef %8)
...
land.lhs.true:                                    ; preds = %entry
  %10 = load ptr, ptr %xDestroy.addr, align 8
  %tobool = icmp ne ptr %10, null
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %11 = load ptr, ptr %xDestroy.addr, align 8
  %12 = load ptr, ptr %pAux.addr, align 8
  call void %11(ptr noundef %12)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %13 = load ptr, ptr %db.addr, align 8
  %mutex2 = getelementptr inbounds nuw %struct.sqlite3, ptr %13, i32 0, i32 3
  %14 = load ptr, ptr %mutex2, align 8
