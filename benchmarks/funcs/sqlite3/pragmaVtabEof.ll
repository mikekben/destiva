...
define hidden i32 @pragmaVtabEof(ptr noundef %pVtabCursor) #0 {
entry:
  ...
  %pPragma = getelementptr inbounds nuw %struct.PragmaVtabCursor, ptr %1, i32 0, i32 1
  %2 = load ptr, ptr %pPragma, align 8
