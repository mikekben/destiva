...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3TransferBindings(ptr noundef %pFromStmt, ptr noundef %pToStmt) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %aVar2 = getelementptr inbounds nuw %struct.Vdbe, ptr %11, i32 0, i32 22
  %12 = load ptr, ptr %aVar2, align 8
  %13 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %13 to i64
  %arrayidx4 = getelementptr inbounds %struct.sqlite3_value, ptr %12, i64 %idxprom3
  call void @sqlite3VdbeMemMove(ptr noundef %arrayidx, ptr noundef %arrayidx4)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %15 = load ptr, ptr %pTo, align 8
  %db5 = getelementptr inbounds nuw %struct.Vdbe, ptr %15, i32 0, i32 0
  %16 = load ptr, ptr %db5, align 8
  %mutex6 = getelementptr inbounds nuw %struct.sqlite3, ptr %16, i32 0, i32 3
  %17 = load ptr, ptr %mutex6, align 8
