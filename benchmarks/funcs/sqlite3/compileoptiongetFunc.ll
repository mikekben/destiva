...
; Function Attrs: nounwind uwtable
define hidden void @compileoptiongetFunc(ptr noundef %context, i32 noundef %argc, ptr noundef %argv) #0 {
entry:
  ...
  %call1 = call ptr @sqlite3_compileoption_get(i32 noundef %4)
  call void @sqlite3_result_text(ptr noundef %3, ptr noundef %call1, i32 noundef -1, ptr noundef null)
  ret void
}
