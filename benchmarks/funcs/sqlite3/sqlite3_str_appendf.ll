...
; Function Attrs: nounwind uwtable
define dso_local void @sqlite3_str_appendf(ptr noundef %p, ptr noundef %zFormat, ...) #0 {
entry:
  ...
  call void @sqlite3_str_vappendf(ptr noundef %0, ptr noundef %1, ptr noundef %arraydecay1)
