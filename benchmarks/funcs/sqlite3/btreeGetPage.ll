...
; Function Attrs: nounwind uwtable
define hidden i32 @btreeGetPage(ptr noundef %pBt, i32 noundef %pgno, ptr noundef %ppPage, i32 noundef %flags) #0 {
entry:
  ...
  %call = call i32 @sqlite3PagerGet(ptr noundef %1, i32 noundef %2, ptr noundef %pDbPage, i32 noundef %3)
...
if.end:                                           ; preds = %entry
  %6 = load ptr, ptr %pDbPage, align 8
  %7 = load i32, ptr %pgno.addr, align 4
  %8 = load ptr, ptr %pBt.addr, align 8
  %call1 = call ptr @btreePageFromDbPage(ptr noundef %6, i32 noundef %7, ptr noundef %8)
