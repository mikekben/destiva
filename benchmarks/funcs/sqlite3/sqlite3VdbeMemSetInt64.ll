...
define hidden void @sqlite3VdbeMemSetInt64(ptr noundef %pMem, i64 noundef %val) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @vdbeReleaseAndSetInt64(ptr noundef %2, i64 noundef %3)
  br label %if.end
...
if.else:                                          ; preds = %entry
  ...
  %flags2 = getelementptr inbounds nuw %struct.sqlite3_value, ptr %6, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
declare hidden void @vdbeReleaseAndSetInt64(ptr noundef, i64 noundef) #0
