...
declare hidden void @timeFunc(ptr noundef, i32 noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @ctimeFunc(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %NotUsed2) #0 {
entry:
  ...
  call void @timeFunc(ptr noundef %2, i32 noundef 0, ptr noundef null)
  ret void
}
