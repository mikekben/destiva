...
define hidden i32 @sqlite3OsDeviceCharacteristics(ptr noundef %id) #0 {
entry:
  ...
  %xDeviceCharacteristics = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 12
  %2 = load ptr, ptr %xDeviceCharacteristics, align 8
