...
define dso_local i32 @sqlite3_open(ptr noundef %zFilename, ptr noundef %ppDb) #0 {
entry:
  ...
  %call = call i32 @openDatabase(ptr noundef %0, ptr noundef %1, i32 noundef 6, ptr noundef null)
  ret i32 %call
}
