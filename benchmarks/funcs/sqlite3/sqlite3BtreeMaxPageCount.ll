...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeMaxPageCount(ptr noundef %p, i32 noundef %mxPage) #0 {
entry:
  ...
  %4 = load i32, ptr %mxPage.addr, align 4
  %call = call i32 @sqlite3PagerMaxPageCount(ptr noundef %3, i32 noundef %4)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @sqlite3PagerMaxPageCount(ptr noundef, i32 noundef) #0
