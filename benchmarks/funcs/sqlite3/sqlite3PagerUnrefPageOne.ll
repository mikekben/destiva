...
declare hidden void @pagerUnlockIfUnused(ptr noundef) #0

; Function Attrs: nounwind uwtable
declare hidden void @sqlite3PcacheRelease(ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @sqlite3PagerUnrefPageOne(ptr noundef %pPg) #0 {
entry:
  ...
  call void @sqlite3PcacheRelease(ptr noundef %2)
  %3 = load ptr, ptr %pPager, align 8
  call void @pagerUnlockIfUnused(ptr noundef %3)
  ret void
}
