...
define hidden i32 @sqlite3OsCheckReservedLock(ptr noundef %id, ptr noundef %pResOut) #0 {
entry:
  ...
  %xCheckReservedLock = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 9
  %2 = load ptr, ptr %xCheckReservedLock, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load ptr, ptr %pResOut.addr, align 8
