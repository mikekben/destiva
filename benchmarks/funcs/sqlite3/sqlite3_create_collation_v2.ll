...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_create_collation_v2(ptr noundef %db, ptr noundef %zName, i32 noundef %enc, ptr noundef %pCtx, ptr noundef %xCompare, ptr noundef %xDel) #0 {
entry:
  ...
  %6 = load ptr, ptr %xCompare.addr, align 8
  %7 = load ptr, ptr %xDel.addr, align 8
  %call = call i32 @createCollation(ptr noundef %2, ptr noundef %3, i8 noundef zeroext %conv, ptr noundef %5, ptr noundef %6, ptr noundef %7)
  store i32 %call, ptr %rc, align 4
  %8 = load ptr, ptr %db.addr, align 8
  %9 = load i32, ptr %rc, align 4
  %call1 = call i32 @sqlite3ApiExit(ptr noundef %8, i32 noundef %9)
  store i32 %call1, ptr %rc, align 4
  %10 = load ptr, ptr %db.addr, align 8
  %mutex2 = getelementptr inbounds nuw %struct.sqlite3, ptr %10, i32 0, i32 3
  %11 = load ptr, ptr %mutex2, align 8
