...
define hidden void @sqlite3OsDlClose(ptr noundef %pVfs, ptr noundef %pHandle) #0 {
entry:
  ...
  %xDlClose = getelementptr inbounds nuw %struct.sqlite3_vfs, ptr %0, i32 0, i32 13
  %1 = load ptr, ptr %xDlClose, align 8
