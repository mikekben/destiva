...
define hidden i32 @sqlite3FaultSim(i32 noundef %iTest) #0 {
entry:
  %iTest.addr = alloca i32, align 4
  %xCallback = alloca ptr, align 8
  store i32 %iTest, ptr %iTest.addr, align 4
  %0 = load ptr, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 36), align 8
  store ptr %0, ptr %xCallback, align 8
  %1 = load ptr, ptr %xCallback, align 8
  %tobool = icmp ne ptr %1, null
  br i1 %tobool, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %2 = load ptr, ptr %xCallback, align 8
  %3 = load i32, ptr %iTest.addr, align 4
