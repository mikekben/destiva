...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3PcacheSetCachesize(ptr noundef %pCache, i32 noundef %mxPage) #0 {
entry:
  ...
  %szCache = getelementptr inbounds nuw %struct.PCache, ptr %1, i32 0, i32 4
  store i32 %0, ptr %szCache, align 4
  %2 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_pcache_methods2, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 14), i32 0, i32 5), align 8
  %3 = load ptr, ptr %pCache.addr, align 8
  %pCache1 = getelementptr inbounds nuw %struct.PCache, ptr %3, i32 0, i32 12
  %4 = load ptr, ptr %pCache1, align 8
  %5 = load ptr, ptr %pCache.addr, align 8
  %call = call i32 @numberOfCachePages(ptr noundef %5)
  call void %2(ptr noundef %4, i32 noundef %call)
  ret void
}
