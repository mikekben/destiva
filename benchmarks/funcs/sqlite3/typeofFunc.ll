...
@typeofFunc.azType = external hidden global [5 x ptr], align 16
...
; Function Attrs: nounwind uwtable
define hidden void @typeofFunc(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %argv) #0 {
entry:
  ...
  %arrayidx1 = getelementptr inbounds [5 x ptr], ptr @typeofFunc.azType, i64 0, i64 %idxprom
  %5 = load ptr, ptr %arrayidx1, align 8
  call void @sqlite3_result_text(ptr noundef %3, ptr noundef %5, i32 noundef -1, ptr noundef null)
  ret void
}
