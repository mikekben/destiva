...
define hidden void @substExprList(ptr noundef %pSubst, ptr noundef %pList) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call ptr @substExpr(ptr noundef %4, ptr noundef %7)
  %8 = load ptr, ptr %pList.addr, align 8
  %a2 = getelementptr inbounds nuw %struct.ExprList, ptr %8, i32 0, i32 1
  %9 = load i32, ptr %i, align 4
  %idxprom3 = sext i32 %9 to i64
  %arrayidx4 = getelementptr inbounds [1 x %struct.ExprList_item], ptr %a2, i64 0, i64 %idxprom3
  %pExpr5 = getelementptr inbounds nuw %struct.ExprList_item, ptr %arrayidx4, i32 0, i32 0
  store ptr %call, ptr %pExpr5, align 8
  br label %for.inc
