...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3VdbeMemAggValue(ptr noundef %pAccum, ptr noundef %pOut, ptr noundef %pFunc) #1 {
entry:
  ...
  %pOut2 = getelementptr inbounds nuw %struct.sqlite3_context, ptr %ctx, i32 0, i32 0
  store ptr %3, ptr %pOut2, align 8
  %4 = load ptr, ptr %pAccum.addr, align 8
  %pMem = getelementptr inbounds nuw %struct.sqlite3_context, ptr %ctx, i32 0, i32 2
  store ptr %4, ptr %pMem, align 8
  %5 = load ptr, ptr %pFunc.addr, align 8
  %pFunc3 = getelementptr inbounds nuw %struct.sqlite3_context, ptr %ctx, i32 0, i32 1
  store ptr %5, ptr %pFunc3, align 8
  %6 = load ptr, ptr %pFunc.addr, align 8
  %xValue = getelementptr inbounds nuw %struct.FuncDef, ptr %6, i32 0, i32 6
  %7 = load ptr, ptr %xValue, align 8
  call void %7(ptr noundef %ctx)
  %isError = getelementptr inbounds nuw %struct.sqlite3_context, ptr %ctx, i32 0, i32 5
  %8 = load i32, ptr %isError, align 4
  ret i32 %8
}
