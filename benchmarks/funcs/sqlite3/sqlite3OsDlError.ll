...
define hidden void @sqlite3OsDlError(ptr noundef %pVfs, i32 noundef %nByte, ptr noundef %zBufOut) #0 {
entry:
  ...
  %xDlError = getelementptr inbounds nuw %struct.sqlite3_vfs, ptr %0, i32 0, i32 11
  %1 = load ptr, ptr %xDlError, align 8
  %2 = load ptr, ptr %pVfs.addr, align 8
  %3 = load i32, ptr %nByte.addr, align 4
  %4 = load ptr, ptr %zBufOut.addr, align 8
  call void %1(ptr noundef %2, i32 noundef %3, ptr noundef %4)
  ret void
}
