...
define hidden i32 @memjrnlFileSize(ptr noundef %pJfd, ptr noundef %pSize) #0 {
entry:
  ...
  %endpoint = getelementptr inbounds nuw %struct.MemJournal, ptr %1, i32 0, i32 5
  %iOffset = getelementptr inbounds nuw %struct.FilePoint, ptr %endpoint, i32 0, i32 0
  %2 = load i64, ptr %iOffset, align 8
