...
define dso_local ptr @sqlite3_aggregate_context(ptr noundef %p, i32 noundef %nByte) #0 {
entry:
  ...
  %pMem = getelementptr inbounds nuw %struct.sqlite3_context, ptr %0, i32 0, i32 2
...
if.then:                                          ; preds = %entry
  ...
  %call = call ptr @createAggContext(ptr noundef %3, i32 noundef %4)
  store ptr %call, ptr %retval, align 8
  br label %return

if.else:                                          ; preds = %entry
  %5 = load ptr, ptr %p.addr, align 8
  %pMem2 = getelementptr inbounds nuw %struct.sqlite3_context, ptr %5, i32 0, i32 2
  %6 = load ptr, ptr %pMem2, align 8
...
; Function Attrs: nounwind uwtable
declare hidden ptr @createAggContext(ptr noundef, i32 noundef) #0
