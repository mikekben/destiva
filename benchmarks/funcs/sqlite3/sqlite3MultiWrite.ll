...
define hidden void @sqlite3MultiWrite(ptr noundef %pParse) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %isMultiWrite = getelementptr inbounds nuw %struct.Parse, ptr %5, i32 0, i32 8
  store i8 1, ptr %isMultiWrite, align 8
  ret void
}
