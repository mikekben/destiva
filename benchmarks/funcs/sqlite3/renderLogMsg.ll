...
; Function Attrs: nounwind uwtable
define hidden void @renderLogMsg(i32 noundef %iErrCode, ptr noundef %zFormat, ptr noundef %ap) #0 {
entry:
  %iErrCode.addr = alloca i32, align 4
  %zFormat.addr = alloca ptr, align 8
  %ap.addr = alloca ptr, align 8
  %acc = alloca %struct.sqlite3_str, align 8
  %zMsg = alloca [210 x i8], align 16
  store i32 %iErrCode, ptr %iErrCode.addr, align 4
  store ptr %zFormat, ptr %zFormat.addr, align 8
  store ptr %ap, ptr %ap.addr, align 8
  %arraydecay = getelementptr inbounds [210 x i8], ptr %zMsg, i64 0, i64 0
  call void @sqlite3StrAccumInit(ptr noundef %acc, ptr noundef null, ptr noundef %arraydecay, i32 noundef 210, i32 noundef 0)
  %0 = load ptr, ptr %zFormat.addr, align 8
  %1 = load ptr, ptr %ap.addr, align 8
  call void @sqlite3_str_vappendf(ptr noundef %acc, ptr noundef %0, ptr noundef %1)
  %2 = load ptr, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 34), align 8
  %3 = load ptr, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 35), align 8
  %4 = load i32, ptr %iErrCode.addr, align 4
  %call = call ptr @sqlite3StrAccumFinish(ptr noundef %acc)
  call void %2(ptr noundef %3, i32 noundef %4, ptr noundef %call)
  ret void
}
