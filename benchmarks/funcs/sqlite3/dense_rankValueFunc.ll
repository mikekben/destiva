...
; Function Attrs: nounwind uwtable
define hidden void @dense_rankValueFunc(ptr noundef %pCtx) #0 {
entry:
...
if.then2:                                         ; preds = %if.then
  ...
  %5 = load i64, ptr %nValue, align 8
  %inc = add nsw i64 %5, 1
  store i64 %inc, ptr %nValue, align 8
  %6 = load ptr, ptr %p, align 8
  %nStep3 = getelementptr inbounds nuw %struct.CallCount, ptr %6, i32 0, i32 1
  store i64 0, ptr %nStep3, align 8
  br label %if.end

if.end:                                           ; preds = %if.then2, %if.then
  %7 = load ptr, ptr %pCtx.addr, align 8
  %8 = load ptr, ptr %p, align 8
  %nValue4 = getelementptr inbounds nuw %struct.CallCount, ptr %8, i32 0, i32 0
  %9 = load i64, ptr %nValue4, align 8
  call void @sqlite3_result_int64(ptr noundef %7, i64 noundef %9)
  br label %if.end5
