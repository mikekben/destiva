...
define hidden i32 @sqlite3WalkExpr(ptr noundef %pWalker, ptr noundef %pExpr) #0 {
entry:
...
cond.true:                                        ; preds = %entry
  ...
  %call = call i32 @walkExpr(ptr noundef %1, ptr noundef %2)
  br label %cond.end
...
; Function Attrs: nounwind uwtable
declare hidden i32 @walkExpr(ptr noundef, ptr noundef) #0
