...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_mutex_alloc(i32 noundef %id) #0 {
entry:
...
land.lhs.true2:                                   ; preds = %if.end
  %call3 = call i32 @sqlite3MutexInit()
...
if.end6:                                          ; preds = %land.lhs.true2, %if.end
  %2 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_mutex_methods, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 13), i32 0, i32 2), align 8
  %3 = load i32, ptr %id.addr, align 4
  %call7 = call ptr %2(i32 noundef %3)
