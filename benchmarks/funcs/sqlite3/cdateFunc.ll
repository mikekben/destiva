...
declare hidden void @dateFunc(ptr noundef, i32 noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @cdateFunc(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %NotUsed2) #0 {
entry:
  ...
  call void @dateFunc(ptr noundef %2, i32 noundef 0, ptr noundef null)
  ret void
}
