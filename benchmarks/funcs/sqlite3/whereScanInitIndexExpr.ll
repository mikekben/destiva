...
; Function Attrs: nounwind uwtable
define hidden ptr @whereScanInitIndexExpr(ptr noundef %pScan) #0 {
entry:
  %pScan.addr = alloca ptr, align 8
  store ptr %pScan, ptr %pScan.addr, align 8
  %0 = load ptr, ptr %pScan.addr, align 8
  %pIdxExpr = getelementptr inbounds nuw %struct.WhereScan, ptr %0, i32 0, i32 3
  %1 = load ptr, ptr %pIdxExpr, align 8
  %call = call signext i8 @sqlite3ExprAffinity(ptr noundef %1)
  %2 = load ptr, ptr %pScan.addr, align 8
  %idxaff = getelementptr inbounds nuw %struct.WhereScan, ptr %2, i32 0, i32 4
  store i8 %call, ptr %idxaff, align 8
  %3 = load ptr, ptr %pScan.addr, align 8
  %call1 = call ptr @whereScanNext(ptr noundef %3)
  ret ptr %call1
}
