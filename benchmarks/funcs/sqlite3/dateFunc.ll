...
@.str.1033 = external hidden unnamed_addr constant [15 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden void @dateFunc(ptr noundef %context, i32 noundef %argc, ptr noundef %argv) #0 {
entry:
...
if.then:                                          ; preds = %entry
  call void @computeYMD(ptr noundef %x)
  ...
  %call1 = call ptr (i32, ptr, ptr, ...) @sqlite3_snprintf(i32 noundef 100, ptr noundef %arraydecay, ptr noundef @.str.1033, i32 noundef %3, i32 noundef %4, i32 noundef %5)
