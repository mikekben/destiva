...
define hidden void @sqlite3WalLimit(ptr noundef %pWal, i64 noundef %iLimit) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %mxWalSize = getelementptr inbounds nuw %struct.Wal, ptr %2, i32 0, i32 4
  store i64 %1, ptr %mxWalSize, align 8
  br label %if.end
