...
@.str.803 = external hidden unnamed_addr constant [23 x i8], align 1

; Function Attrs: nounwind uwtable
declare hidden void @sqlite3ErrorMsg(ptr noundef, ptr noundef, ...) #0

; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprListCheckLength(ptr noundef %pParse, ptr noundef %pEList, ptr noundef %zObject) #0 {
entry:
  %pParse.addr = alloca ptr, align 8
  %pEList.addr = alloca ptr, align 8
  %zObject.addr = alloca ptr, align 8
  %mx = alloca i32, align 4
  store ptr %pParse, ptr %pParse.addr, align 8
  store ptr %pEList, ptr %pEList.addr, align 8
  store ptr %zObject, ptr %zObject.addr, align 8
...
land.lhs.true:                                    ; preds = %entry
  ...
  %6 = load i32, ptr %mx, align 4
  %cmp = icmp sgt i32 %5, %6
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  %7 = load ptr, ptr %pParse.addr, align 8
  %8 = load ptr, ptr %zObject.addr, align 8
  call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef %7, ptr noundef @.str.803, ptr noundef %8)
  br label %if.end
