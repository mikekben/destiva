...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeDropTable(ptr noundef %p, i32 noundef %iTable, ptr noundef %piMoved) #0 {
entry:
  ...
  %3 = load ptr, ptr %piMoved.addr, align 8
  %call = call i32 @btreeDropTable(ptr noundef %1, i32 noundef %2, ptr noundef %3)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @btreeDropTable(ptr noundef, i32 noundef, ptr noundef) #0
