...
; Function Attrs: nounwind uwtable
define hidden void @rankStepFunc(ptr noundef %pCtx, i32 noundef %nArg, ptr noundef %apArg) #0 {
entry:
...
if.then1:                                         ; preds = %if.then
  ...
  %nStep2 = getelementptr inbounds nuw %struct.CallCount, ptr %6, i32 0, i32 1
  %7 = load i64, ptr %nStep2, align 8
  %8 = load ptr, ptr %p, align 8
  %nValue3 = getelementptr inbounds nuw %struct.CallCount, ptr %8, i32 0, i32 0
  store i64 %7, ptr %nValue3, align 8
  br label %if.end
