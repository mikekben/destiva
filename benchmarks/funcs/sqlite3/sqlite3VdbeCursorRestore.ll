...
define hidden i32 @sqlite3VdbeCursorRestore(ptr noundef %p) #0 {
entry:
  ...
  %call = call i32 @sqlite3BtreeCursorHasMoved(ptr noundef %1)
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load ptr, ptr %p.addr, align 8
  %call1 = call i32 @handleMovedCursor(ptr noundef %2)
