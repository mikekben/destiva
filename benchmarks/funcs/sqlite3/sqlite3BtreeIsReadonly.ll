...
define hidden i32 @sqlite3BtreeIsReadonly(ptr noundef %p) #0 {
entry:
  ...
  %btsFlags = getelementptr inbounds nuw %struct.BtShared, ptr %1, i32 0, i32 10
  %2 = load i16, ptr %btsFlags, align 2
