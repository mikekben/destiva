...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3RowSetDelete(ptr noundef %pArg) #0 {
entry:
  %pArg.addr = alloca ptr, align 8
  store ptr %pArg, ptr %pArg.addr, align 8
  %0 = load ptr, ptr %pArg.addr, align 8
  call void @sqlite3RowSetClear(ptr noundef %0)
  %1 = load ptr, ptr %pArg.addr, align 8
  %db = getelementptr inbounds nuw %struct.RowSet, ptr %1, i32 0, i32 1
  %2 = load ptr, ptr %db, align 8
  %3 = load ptr, ptr %pArg.addr, align 8
  call void @sqlite3DbFree(ptr noundef %2, ptr noundef %3)
  ret void
}
