...
define hidden void @sqlite3PcacheShrink(ptr noundef %pCache) #0 {
entry:
  %pCache.addr = alloca ptr, align 8
  store ptr %pCache, ptr %pCache.addr, align 8
  %0 = load ptr, ptr getelementptr inbounds nuw (%struct.sqlite3_pcache_methods2, ptr getelementptr inbounds nuw (%struct.Sqlite3Config, ptr @sqlite3Config, i32 0, i32 14), i32 0, i32 12), align 8
