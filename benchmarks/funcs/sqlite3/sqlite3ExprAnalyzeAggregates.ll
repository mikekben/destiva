...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprAnalyzeAggregates(ptr noundef %pNC, ptr noundef %pExpr) #0 {
entry:
  ...
  store ptr @analyzeAggregate, ptr %xExprCallback, align 8
  %xSelectCallback = getelementptr inbounds nuw %struct.Walker, ptr %w, i32 0, i32 2
  store ptr @analyzeAggregatesInSelect, ptr %xSelectCallback, align 8
  %xSelectCallback2 = getelementptr inbounds nuw %struct.Walker, ptr %w, i32 0, i32 3
  store ptr @analyzeAggregatesInSelectEnd, ptr %xSelectCallback2, align 8
...
; Function Attrs: nounwind uwtable
declare hidden i32 @analyzeAggregate(ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
declare hidden i32 @analyzeAggregatesInSelect(ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
declare hidden void @analyzeAggregatesInSelectEnd(ptr noundef, ptr noundef) #0
