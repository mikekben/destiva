...
declare dso_local i32 @sqlite3_value_bytes16(ptr noundef) #0
...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_column_bytes16(ptr noundef %pStmt, i32 noundef %i) #0 {
entry:
  ...
  %call1 = call i32 @sqlite3_value_bytes16(ptr noundef %call)
