...
define hidden void @sqlite3BackupUpdate(ptr noundef %pBackup, i32 noundef %iPage, ptr noundef %aData) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %1 = load ptr, ptr %pBackup.addr, align 8
  %2 = load i32, ptr %iPage.addr, align 4
  %3 = load ptr, ptr %aData.addr, align 8
  call void @backupUpdate(ptr noundef %1, i32 noundef %2, ptr noundef %3)
  br label %if.end
...
; Function Attrs: nounwind uwtable
declare hidden void @backupUpdate(ptr noundef, i32 noundef, ptr noundef) #0
