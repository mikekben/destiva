...
define hidden i32 @sqlite3WhereContinueLabel(ptr noundef %pWInfo) #0 {
entry:
  %pWInfo.addr = alloca ptr, align 8
  store ptr %pWInfo, ptr %pWInfo.addr, align 8
  %0 = load ptr, ptr %pWInfo.addr, align 8
  %iContinue = getelementptr inbounds nuw %struct.WhereInfo, ptr %0, i32 0, i32 7
  %1 = load i32, ptr %iContinue, align 4
  ret i32 %1
}
