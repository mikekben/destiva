...
; Function Attrs: nounwind uwtable
define hidden void @avgFinalize(ptr noundef %context) #0 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %rSum = getelementptr inbounds nuw %struct.SumCtx, ptr %5, i32 0, i32 0
  %6 = load double, ptr %rSum, align 8
  %7 = load ptr, ptr %p, align 8
  %cnt1 = getelementptr inbounds nuw %struct.SumCtx, ptr %7, i32 0, i32 2
  %8 = load i64, ptr %cnt1, align 8
  %conv = sitofp i64 %8 to double
  %div = fdiv double %6, %conv
  call void @sqlite3_result_double(ptr noundef %4, double noundef %div)
  br label %if.end
