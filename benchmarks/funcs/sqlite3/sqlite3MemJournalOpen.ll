...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3MemJournalOpen(ptr noundef %pJfd) #0 {
entry:
  %pJfd.addr = alloca ptr, align 8
  store ptr %pJfd, ptr %pJfd.addr, align 8
  %0 = load ptr, ptr %pJfd.addr, align 8
  %call = call i32 @sqlite3JournalOpen(ptr noundef null, ptr noundef null, ptr noundef %0, i32 noundef 0, i32 noundef -1)
  ret void
}
