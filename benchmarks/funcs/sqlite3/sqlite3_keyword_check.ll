...
define dso_local i32 @sqlite3_keyword_check(ptr noundef %zName, i32 noundef %nName) #0 {
entry:
  ...
  %1 = load i32, ptr %nName.addr, align 4
  %call = call i32 @sqlite3KeywordCode(ptr noundef %0, i32 noundef %1)
  %cmp = icmp ne i32 59, %call
