...
define hidden i32 @sqlite3ErrorToParser(ptr noundef %db, i32 noundef %errCode) #0 {
entry:
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %pParse1 = getelementptr inbounds nuw %struct.sqlite3, ptr %1, i32 0, i32 53
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %rc = getelementptr inbounds nuw %struct.Parse, ptr %5, i32 0, i32 3
  store i32 %4, ptr %rc, align 8
