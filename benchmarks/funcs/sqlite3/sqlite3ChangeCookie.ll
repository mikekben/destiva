...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ChangeCookie(ptr noundef %pParse, i32 noundef %iDb) #0 {
entry:
  ...
  %schema_cookie = getelementptr inbounds nuw %struct.Schema, ptr %9, i32 0, i32 0
  %10 = load i32, ptr %schema_cookie, align 8
  %add = add i32 1, %10
  %call = call i32 @sqlite3VdbeAddOp3(ptr noundef %4, i32 noundef 95, i32 noundef %5, i32 noundef 1, i32 noundef %add)
  ret void
}
