...
define hidden void @sqlite3VdbeChangeP2(ptr noundef %p, i32 noundef %addr, i32 noundef %val) #0 {
entry:
  ...
  %p2 = getelementptr inbounds nuw %struct.VdbeOp, ptr %call, i32 0, i32 4
