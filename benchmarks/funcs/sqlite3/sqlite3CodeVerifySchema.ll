...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3CodeVerifySchema(ptr noundef %pParse, i32 noundef %iDb) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %cookieMask = getelementptr inbounds nuw %struct.Parse, ptr %5, i32 0, i32 27
  %6 = load i32, ptr %cookieMask, align 4
...
if.then:                                          ; preds = %cond.end
  ...
  %cookieMask6 = getelementptr inbounds nuw %struct.Parse, ptr %9, i32 0, i32 27
  %10 = load i32, ptr %cookieMask6, align 4
  %or = or i32 %10, %shl5
  store i32 %or, ptr %cookieMask6, align 4
...
if.then9:                                         ; preds = %if.then
  ...
  %call = call i32 @sqlite3OpenTempDatabase(ptr noundef %12)
  br label %if.end
