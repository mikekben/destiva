...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3SelectAddTypeInfo(ptr noundef %pParse, ptr noundef %pSelect) #0 {
entry:
  ...
  store ptr @selectAddSubqueryTypeInfo, ptr %xSelectCallback2, align 8
...
; Function Attrs: nounwind uwtable
declare hidden void @selectAddSubqueryTypeInfo(ptr noundef, ptr noundef) #0
