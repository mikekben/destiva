...
; Function Attrs: nounwind uwtable
declare dso_local ptr @sqlite3_vmprintf(ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_mprintf(ptr noundef %zFormat, ...) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call ptr @sqlite3_vmprintf(ptr noundef %0, ptr noundef %arraydecay1)
