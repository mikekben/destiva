...
define hidden void @sqlite3BtreeIncrblobCursor(ptr noundef %pCur) #0 {
entry:
  %pCur.addr = alloca ptr, align 8
  store ptr %pCur, ptr %pCur.addr, align 8
  %0 = load ptr, ptr %pCur.addr, align 8
  %curFlags = getelementptr inbounds nuw %struct.BtCursor, ptr %0, i32 0, i32 1
  %1 = load i8, ptr %curFlags, align 1
  %conv = zext i8 %1 to i32
  %or = or i32 %conv, 16
  %conv1 = trunc i32 %or to i8
  store i8 %conv1, ptr %curFlags, align 1
  %2 = load ptr, ptr %pCur.addr, align 8
  %pBtree = getelementptr inbounds nuw %struct.BtCursor, ptr %2, i32 0, i32 5
  %3 = load ptr, ptr %pBtree, align 8
  %hasIncrblobCur = getelementptr inbounds nuw %struct.Btree, ptr %3, i32 0, i32 5
  store i8 1, ptr %hasIncrblobCur, align 1
  ret void
}
