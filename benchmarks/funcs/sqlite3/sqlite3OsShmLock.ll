...
define hidden i32 @sqlite3OsShmLock(ptr noundef %id, i32 noundef %offset, i32 noundef %n, i32 noundef %flags) #0 {
entry:
  ...
  %xShmLock = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 14
  %2 = load ptr, ptr %xShmLock, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i32, ptr %offset.addr, align 4
  %5 = load i32, ptr %n.addr, align 4
  %6 = load i32, ptr %flags.addr, align 4
  %call = call i32 %2(ptr noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6)
  ret i32 %call
}
