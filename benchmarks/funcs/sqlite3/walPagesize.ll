...
define hidden i32 @walPagesize(ptr noundef %pWal) #0 {
entry:
  ...
  %szPage2 = getelementptr inbounds nuw %struct.WalIndexHdr, ptr %hdr1, i32 0, i32 5
  %3 = load i16, ptr %szPage2, align 2
