...
define dso_local i32 @sqlite3_bind_blob(ptr noundef %pStmt, i32 noundef %i, ptr noundef %zData, i32 noundef %nData, ptr noundef %xDel) #0 {
entry:
  ...
  %call = call i32 @bindText(ptr noundef %0, i32 noundef %1, ptr noundef %2, i32 noundef %3, ptr noundef %4, i8 noundef zeroext 0)
  ret i32 %call
}
