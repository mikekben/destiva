...
define hidden i32 @sqlite3ExprTruthValue(ptr noundef %pExpr) #0 {
entry:
  %pExpr.addr = alloca ptr, align 8
  store ptr %pExpr, ptr %pExpr.addr, align 8
  %0 = load ptr, ptr %pExpr.addr, align 8
  %call = call ptr @sqlite3ExprSkipCollate(ptr noundef %0)
  store ptr %call, ptr %pExpr.addr, align 8
  %1 = load ptr, ptr %pExpr.addr, align 8
  %u = getelementptr inbounds nuw %struct.Expr, ptr %1, i32 0, i32 3
