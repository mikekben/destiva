...
define dso_local i32 @sqlite3_prepare(ptr noundef %db, ptr noundef %zSql, i32 noundef %nBytes, ptr noundef %ppStmt, ptr noundef %pzTail) #0 {
entry:
  ...
  %call = call i32 @sqlite3LockAndPrepare(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef 0, ptr noundef null, ptr noundef %3, ptr noundef %4)
