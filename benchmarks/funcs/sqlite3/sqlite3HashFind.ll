...
define hidden ptr @sqlite3HashFind(ptr noundef %pH, ptr noundef %pKey) #0 {
entry:
  ...
  %call = call ptr @findElementWithHash(ptr noundef %0, ptr noundef %1, ptr noundef null)
  %data = getelementptr inbounds nuw %struct.HashElem, ptr %call, i32 0, i32 2
