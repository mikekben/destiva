...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3VdbeMemSetRowSet(ptr noundef %pMem) #0 {
entry:
  ...
  %db1 = getelementptr inbounds nuw %struct.sqlite3_value, ptr %0, i32 0, i32 9
  %1 = load ptr, ptr %db1, align 8
  store ptr %1, ptr %db, align 8
  %2 = load ptr, ptr %pMem.addr, align 8
  call void @sqlite3VdbeMemRelease(ptr noundef %2)
  %3 = load ptr, ptr %db, align 8
  %call = call ptr @sqlite3RowSetInit(ptr noundef %3)
...
if.end:                                           ; preds = %entry
  ...
  store i16 1040, ptr %flags, align 8
  %8 = load ptr, ptr %pMem.addr, align 8
  %xDel = getelementptr inbounds nuw %struct.sqlite3_value, ptr %8, i32 0, i32 10
  store ptr @sqlite3RowSetDelete, ptr %xDel, align 8
...
; Function Attrs: nounwind uwtable
declare hidden ptr @sqlite3RowSetInit(ptr noundef) #0

; Function Attrs: nounwind uwtable
declare hidden void @sqlite3RowSetDelete(ptr noundef) #0
