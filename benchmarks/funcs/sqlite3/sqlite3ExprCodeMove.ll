...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprCodeMove(ptr noundef %pParse, i32 noundef %iFrom, i32 noundef %iTo, i32 noundef %nReg) #0 {
entry:
  ...
  %2 = load i32, ptr %iFrom.addr, align 4
  %3 = load i32, ptr %iTo.addr, align 4
  %4 = load i32, ptr %nReg.addr, align 4
  %call = call i32 @sqlite3VdbeAddOp3(ptr noundef %1, i32 noundef 77, i32 noundef %2, i32 noundef %3, i32 noundef %4)
  ret void
}
