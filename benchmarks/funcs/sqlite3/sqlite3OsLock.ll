...
define hidden i32 @sqlite3OsLock(ptr noundef %id, i32 noundef %lockType) #0 {
entry:
  ...
  %xLock = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 7
  %2 = load ptr, ptr %xLock, align 8
