...
; Function Attrs: nounwind uwtable
define hidden i32 @dotlockClose(ptr noundef %id) #0 {
entry:
  ...
  %call = call i32 @dotlockUnlock(ptr noundef %1, i32 noundef 0)
  ...
  %call1 = call i32 @closeUnixFile(ptr noundef %4)
  ret i32 %call1
}

; Function Attrs: nounwind uwtable
declare hidden i32 @dotlockUnlock(ptr noundef, i32 noundef) #0
