...
; Function Attrs: nounwind uwtable
declare dso_local i32 @sqlite3_changes(ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @changes(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %NotUsed2) #0 {
entry:
  ...
  %call1 = call i32 @sqlite3_changes(ptr noundef %4)
