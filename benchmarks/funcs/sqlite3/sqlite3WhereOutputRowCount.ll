...
define hidden signext i16 @sqlite3WhereOutputRowCount(ptr noundef %pWInfo) #0 {
entry:
  %pWInfo.addr = alloca ptr, align 8
  store ptr %pWInfo, ptr %pWInfo.addr, align 8
  %0 = load ptr, ptr %pWInfo.addr, align 8
  %nRowOut = getelementptr inbounds nuw %struct.WhereInfo, ptr %0, i32 0, i32 21
  %1 = load i16, ptr %nRowOut, align 8
  ret i16 %1
}
