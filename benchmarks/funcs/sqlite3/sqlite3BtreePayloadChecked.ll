...
define hidden i32 @sqlite3BtreePayloadChecked(ptr noundef %pCur, i32 noundef %offset, i32 noundef %amt, ptr noundef %pBuf) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 @accessPayload(ptr noundef %2, i32 noundef %3, i32 noundef %4, ptr noundef %5, i32 noundef 0)
...
if.else:                                          ; preds = %entry
  ...
  %call2 = call i32 @accessPayloadChecked(ptr noundef %6, i32 noundef %7, i32 noundef %8, ptr noundef %9)
...
; Function Attrs: nounwind uwtable
declare hidden i32 @accessPayloadChecked(ptr noundef, i32 noundef, i32 noundef, ptr noundef) #0
