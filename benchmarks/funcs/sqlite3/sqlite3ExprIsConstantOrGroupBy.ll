...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3ExprIsConstantOrGroupBy(ptr noundef %pParse, ptr noundef %p, ptr noundef %pGroupBy) #0 {
entry:
  ...
  %eCode2 = getelementptr inbounds nuw %struct.Walker, ptr %w, i32 0, i32 5
  %3 = load i8, ptr %eCode2, align 4
  %conv = zext i8 %3 to i32
  ret i32 %conv
}

; Function Attrs: nounwind uwtable
declare hidden i32 @exprNodeIsConstantOrGroupBy(ptr noundef, ptr noundef) #0
