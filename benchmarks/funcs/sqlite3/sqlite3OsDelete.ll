...
define hidden i32 @sqlite3OsDelete(ptr noundef %pVfs, ptr noundef %zPath, i32 noundef %dirSync) #0 {
entry:
  ...
  %xDelete = getelementptr inbounds nuw %struct.sqlite3_vfs, ptr %0, i32 0, i32 7
  %1 = load ptr, ptr %xDelete, align 8
  %2 = load ptr, ptr %pVfs.addr, align 8
  %3 = load ptr, ptr %zPath.addr, align 8
  %4 = load i32, ptr %dirSync.addr, align 4
