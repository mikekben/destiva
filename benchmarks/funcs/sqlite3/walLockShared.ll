...
; Function Attrs: nounwind uwtable
define hidden i32 @walLockShared(ptr noundef %pWal, i32 noundef %lockIdx) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call i32 @sqlite3OsShmLock(ptr noundef %3, i32 noundef %4, i32 noundef 1, i32 noundef 6)
