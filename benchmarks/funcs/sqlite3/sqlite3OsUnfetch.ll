...
define hidden i32 @sqlite3OsUnfetch(ptr noundef %id, i64 noundef %iOff, ptr noundef %p) #0 {
entry:
  ...
  %xUnfetch = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 18
  %2 = load ptr, ptr %xUnfetch, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i64, ptr %iOff.addr, align 8
  %5 = load ptr, ptr %p.addr, align 8
  %call = call i32 %2(ptr noundef %3, i64 noundef %4, ptr noundef %5)
  ret i32 %call
}
