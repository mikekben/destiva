...
; Function Attrs: nounwind uwtable
define hidden void @vdbeClrCopy(ptr noundef %pTo, ptr noundef %pFrom, i32 noundef %eType) #0 {
entry:
  ...
  call void @vdbeMemClearExternAndSetNull(ptr noundef %0)
  %1 = load ptr, ptr %pTo.addr, align 8
  %2 = load ptr, ptr %pFrom.addr, align 8
  %3 = load i32, ptr %eType.addr, align 4
  call void @sqlite3VdbeMemShallowCopy(ptr noundef %1, ptr noundef %2, i32 noundef %3)
  ret void
}
