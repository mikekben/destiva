...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_finalize(ptr noundef %pStmt) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %call = call i32 @vdbeSafety(ptr noundef %4)
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.then2, label %if.end

if.then2:                                         ; preds = %if.else
  %call3 = call i32 @sqlite3MisuseError(i32 noundef 81711)
  store i32 %call3, ptr %retval, align 4
  br label %return

if.end:                                           ; preds = %if.else
  %5 = load ptr, ptr %db, align 8
  %mutex = getelementptr inbounds nuw %struct.sqlite3, ptr %5, i32 0, i32 3
  %6 = load ptr, ptr %mutex, align 8
  call void @sqlite3_mutex_enter(ptr noundef %6)
  %7 = load ptr, ptr %v, align 8
  %startTime = getelementptr inbounds nuw %struct.Vdbe, ptr %7, i32 0, i32 30
  %8 = load i64, ptr %startTime, align 8
...
if.then5:                                         ; preds = %if.end
  ...
  call void @invokeProfileCallback(ptr noundef %9, ptr noundef %10)
  br label %if.end6

if.end6:                                          ; preds = %if.then5, %if.end
  %11 = load ptr, ptr %v, align 8
  %call7 = call i32 @sqlite3VdbeFinalize(ptr noundef %11)
  store i32 %call7, ptr %rc, align 4
  %12 = load ptr, ptr %db, align 8
  %13 = load i32, ptr %rc, align 4
  %call8 = call i32 @sqlite3ApiExit(ptr noundef %12, i32 noundef %13)
  store i32 %call8, ptr %rc, align 4
  %14 = load ptr, ptr %db, align 8
  call void @sqlite3LeaveMutexAndCloseZombie(ptr noundef %14)
  br label %if.end9

if.end9:                                          ; preds = %if.end6, %if.then
...
; Function Attrs: nounwind uwtable
declare hidden i32 @vdbeSafety(ptr noundef) #0
