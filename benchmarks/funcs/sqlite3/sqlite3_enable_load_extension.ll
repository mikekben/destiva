...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_enable_load_extension(ptr noundef %db, i32 noundef %onoff) #0 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %flags1 = getelementptr inbounds nuw %struct.sqlite3, ptr %5, i32 0, i32 7
  %6 = load i64, ptr %flags1, align 8
  %and = and i64 %6, -196609
