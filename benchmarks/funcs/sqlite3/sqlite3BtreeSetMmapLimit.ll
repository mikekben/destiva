...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3BtreeSetMmapLimit(ptr noundef %p, i64 noundef %szMmap) #0 {
entry:
  ...
  %5 = load i64, ptr %szMmap.addr, align 8
  call void @sqlite3PagerSetMmapLimit(ptr noundef %4, i64 noundef %5)
