...
; Function Attrs: nounwind uwtable
define hidden void @whereAndInfoDelete(ptr noundef %db, ptr noundef %p) #0 {
entry:
  ...
  %wc = getelementptr inbounds nuw %struct.WhereAndInfo, ptr %0, i32 0, i32 0
  call void @sqlite3WhereClauseClear(ptr noundef %wc)
  %1 = load ptr, ptr %db.addr, align 8
  %2 = load ptr, ptr %p.addr, align 8
  call void @sqlite3DbFree(ptr noundef %1, ptr noundef %2)
  ret void
}
