...
@.str.1035 = external hidden unnamed_addr constant [30 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden void @datetimeFunc(ptr noundef %context, i32 noundef %argc, ptr noundef %argv) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %8 = load double, ptr %s, align 8
  %conv = fptosi double %8 to i32
  %call1 = call ptr (i32, ptr, ptr, ...) @sqlite3_snprintf(i32 noundef 100, ptr noundef %arraydecay, ptr noundef @.str.1035, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %conv)
  %9 = load ptr, ptr %context.addr, align 8
  %arraydecay2 = getelementptr inbounds [100 x i8], ptr %zBuf, i64 0, i64 0
  call void @sqlite3_result_text(ptr noundef %9, ptr noundef %arraydecay2, i32 noundef -1, ptr noundef inttoptr (i64 -1 to ptr))
  br label %if.end
