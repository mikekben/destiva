...
@.str.653 = external hidden unnamed_addr constant [23 x i8], align 1

; Function Attrs: nounwind uwtable
declare hidden void @sqlite3ErrorMsg(ptr noundef, ptr noundef, ...) #0

; Function Attrs: nounwind uwtable
define hidden i32 @cannotBeFunction(ptr noundef %pParse, ptr noundef %pFrom) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %zName = getelementptr inbounds nuw %struct.SrcList_item, ptr %2, i32 0, i32 2
  %3 = load ptr, ptr %zName, align 8
  call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef %1, ptr noundef @.str.653, ptr noundef %3)
