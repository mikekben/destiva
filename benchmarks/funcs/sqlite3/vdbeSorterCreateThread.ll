...
define hidden i32 @vdbeSorterCreateThread(ptr noundef %pTask, ptr noundef %xTask, ptr noundef %pIn) #0 {
entry:
  ...
  %1 = load ptr, ptr %xTask.addr, align 8
  %2 = load ptr, ptr %pIn.addr, align 8
  %call = call i32 @sqlite3ThreadCreate(ptr noundef %pThread, ptr noundef %1, ptr noundef %2)
  ret i32 %call
}

; Function Attrs: nounwind uwtable
declare hidden i32 @sqlite3ThreadCreate(ptr noundef, ptr noundef, ptr noundef) #0
