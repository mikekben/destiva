...
; Function Attrs: nounwind uwtable
define dso_local ptr @sqlite3_commit_hook(ptr noundef %db, ptr noundef %xCallback, ptr noundef %pArg) #0 {
entry:
  ...
  %pCommitArg = getelementptr inbounds nuw %struct.sqlite3, ptr %2, i32 0, i32 47
  %3 = load ptr, ptr %pCommitArg, align 8
  store ptr %3, ptr %pOld, align 8
  %4 = load ptr, ptr %xCallback.addr, align 8
  %5 = load ptr, ptr %db.addr, align 8
  %xCommitCallback = getelementptr inbounds nuw %struct.sqlite3, ptr %5, i32 0, i32 48
  store ptr %4, ptr %xCommitCallback, align 8
  %6 = load ptr, ptr %pArg.addr, align 8
  %7 = load ptr, ptr %db.addr, align 8
  %pCommitArg1 = getelementptr inbounds nuw %struct.sqlite3, ptr %7, i32 0, i32 47
  store ptr %6, ptr %pCommitArg1, align 8
