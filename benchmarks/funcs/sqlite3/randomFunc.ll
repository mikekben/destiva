...
; Function Attrs: nounwind uwtable
define hidden void @randomFunc(ptr noundef %context, i32 noundef %NotUsed, ptr noundef %NotUsed2) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %and = and i64 %3, 9223372036854775807
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @sqlite3_result_int64(ptr noundef %4, i64 noundef %5)
  ret void
}
