...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3WalEndWriteTransaction(ptr noundef %pWal) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @walUnlockExclusive(ptr noundef %2, i32 noundef 0, i32 noundef 1)
  %3 = load ptr, ptr %pWal.addr, align 8
  %writeLock1 = getelementptr inbounds nuw %struct.Wal, ptr %3, i32 0, i32 12
  store i8 0, ptr %writeLock1, align 8
  %4 = load ptr, ptr %pWal.addr, align 8
  %iReCksum = getelementptr inbounds nuw %struct.Wal, ptr %4, i32 0, i32 21
  store i32 0, ptr %iReCksum, align 4
  %5 = load ptr, ptr %pWal.addr, align 8
  %truncateOnCommit = getelementptr inbounds nuw %struct.Wal, ptr %5, i32 0, i32 15
  store i8 0, ptr %truncateOnCommit, align 1
  br label %if.end
