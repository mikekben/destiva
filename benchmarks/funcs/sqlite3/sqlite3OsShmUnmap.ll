...
define hidden i32 @sqlite3OsShmUnmap(ptr noundef %id, i32 noundef %deleteFlag) #0 {
entry:
  ...
  %xShmUnmap = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 16
  %2 = load ptr, ptr %xShmUnmap, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i32, ptr %deleteFlag.addr, align 4
