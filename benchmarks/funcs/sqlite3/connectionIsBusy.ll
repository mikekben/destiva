...
; Function Attrs: nounwind uwtable
define hidden i32 @connectionIsBusy(ptr noundef %db) #0 {
entry:
  ...
  %pVdbe = getelementptr inbounds nuw %struct.sqlite3, ptr %0, i32 0, i32 1
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call = call i32 @sqlite3BtreeIsInBackup(ptr noundef %10)
