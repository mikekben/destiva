...
define hidden i32 @sqlite3OsAccess(ptr noundef %pVfs, ptr noundef %zPath, i32 noundef %flags, ptr noundef %pResOut) #0 {
entry:
  ...
  %xAccess = getelementptr inbounds nuw %struct.sqlite3_vfs, ptr %0, i32 0, i32 8
  %1 = load ptr, ptr %xAccess, align 8
  %2 = load ptr, ptr %pVfs.addr, align 8
  %3 = load ptr, ptr %zPath.addr, align 8
  %4 = load i32, ptr %flags.addr, align 4
  %5 = load ptr, ptr %pResOut.addr, align 8
  %call = call i32 %1(ptr noundef %2, ptr noundef %3, i32 noundef %4, ptr noundef %5)
  ret i32 %call
}
