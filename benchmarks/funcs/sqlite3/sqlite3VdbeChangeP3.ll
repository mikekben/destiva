...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3VdbeChangeP3(ptr noundef %p, i32 noundef %addr, i32 noundef %val) #0 {
entry:
  ...
  %p3 = getelementptr inbounds nuw %struct.VdbeOp, ptr %call, i32 0, i32 5
