...
define hidden i32 @sqlite3OsRead(ptr noundef %id, ptr noundef %pBuf, i32 noundef %amt, i64 noundef %offset) #0 {
entry:
  ...
  %xRead = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 2
  %2 = load ptr, ptr %xRead, align 8
