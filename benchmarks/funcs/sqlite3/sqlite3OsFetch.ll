...
define hidden i32 @sqlite3OsFetch(ptr noundef %id, i64 noundef %iOff, i32 noundef %iAmt, ptr noundef %pp) #0 {
entry:
  ...
  %xFetch = getelementptr inbounds nuw %struct.sqlite3_io_methods, ptr %1, i32 0, i32 17
  %2 = load ptr, ptr %xFetch, align 8
  %3 = load ptr, ptr %id.addr, align 8
  %4 = load i64, ptr %iOff.addr, align 8
  %5 = load i32, ptr %iAmt.addr, align 4
  %6 = load ptr, ptr %pp.addr, align 8
  %call = call i32 %2(ptr noundef %3, i64 noundef %4, i32 noundef %5, ptr noundef %6)
  ret i32 %call
}
