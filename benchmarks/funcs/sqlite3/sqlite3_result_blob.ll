...
define dso_local void @sqlite3_result_blob(ptr noundef %pCtx, ptr noundef %z, i32 noundef %n, ptr noundef %xDel) #0 {
entry:
  ...
  call void @setResultStrOrError(ptr noundef %0, ptr noundef %1, i32 noundef %2, i8 noundef zeroext 0, ptr noundef %3)
  ret void
}
