...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_column_type(ptr noundef %pStmt, i32 noundef %i) #0 {
entry:
  ...
  %call1 = call i32 @sqlite3_value_type(ptr noundef %call)
  store i32 %call1, ptr %iType, align 4
