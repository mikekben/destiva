...
declare hidden void @sqlite3ExprDeleteNN(ptr noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define hidden void @sqlite3ExprUnmapAndDelete(ptr noundef %pParse, ptr noundef %p) #0 {
entry:
...
if.end:                                           ; preds = %if.then2, %if.then
  ...
  call void @sqlite3ExprDeleteNN(ptr noundef %6, ptr noundef %7)
  br label %if.end3
