...
; Function Attrs: nounwind uwtable
define hidden i32 @sqlite3VdbeMemRealify(ptr noundef %pMem) #0 {
entry:
  %pMem.addr = alloca ptr, align 8
  store ptr %pMem, ptr %pMem.addr, align 8
  %0 = load ptr, ptr %pMem.addr, align 8
  %call = call double @sqlite3VdbeRealValue(ptr noundef %0)
  %1 = load ptr, ptr %pMem.addr, align 8
  %u = getelementptr inbounds nuw %struct.sqlite3_value, ptr %1, i32 0, i32 0
  ...
  store i16 %conv1, ptr %flags2, align 8
  ret i32 0
}
