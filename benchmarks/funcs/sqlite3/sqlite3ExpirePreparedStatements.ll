...
define hidden void @sqlite3ExpirePreparedStatements(ptr noundef %db, i32 noundef %iCode) #0 {
entry:
  %db.addr = alloca ptr, align 8
  %iCode.addr = alloca i32, align 4
  %p = alloca ptr, align 8
  store ptr %db, ptr %db.addr, align 8
  store i32 %iCode, ptr %iCode.addr, align 4
...
for.body:                                         ; preds = %for.cond
  %3 = load i32, ptr %iCode.addr, align 4
  %add = add nsw i32 %3, 1
  %4 = load ptr, ptr %p, align 8
  %expired = getelementptr inbounds nuw %struct.Vdbe, ptr %4, i32 0, i32 35
