...
; Function Attrs: nounwind uwtable
define dso_local i32 @sqlite3_bind_parameter_index(ptr noundef %pStmt, ptr noundef %zName) #0 {
entry:
  ...
  %call1 = call i32 @sqlite3VdbeParameterIndex(ptr noundef %0, ptr noundef %1, i32 noundef %call)
  ret i32 %call1
}
