...
define hidden void @sqlite3BtreeCursorHintFlags(ptr noundef %pCur, i32 noundef %x) #0 {
entry:
  ...
  %hints = getelementptr inbounds nuw %struct.BtCursor, ptr %1, i32 0, i32 3
  store i8 %conv, ptr %hints, align 1
  ret void
}
