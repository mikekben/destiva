...
@.str.717 = external hidden unnamed_addr constant [15 x i8], align 1
@.str.718 = external hidden unnamed_addr constant [56 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden void @destroyRootPage(ptr noundef %pParse, i32 noundef %iTable, i32 noundef %iDb) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef %3, ptr noundef @.str.717)
  br label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 @sqlite3VdbeAddOp3(ptr noundef %4, i32 noundef 136, i32 noundef %5, i32 noundef %6, i32 noundef %7)
  %8 = load ptr, ptr %pParse.addr, align 8
  call void @sqlite3MayAbort(ptr noundef %8)
  %9 = load ptr, ptr %pParse.addr, align 8
  %10 = load ptr, ptr %pParse.addr, align 8
  %db = getelementptr inbounds nuw %struct.Parse, ptr %10, i32 0, i32 0
  ...
  %15 = load i32, ptr %iTable.addr, align 4
  %16 = load i32, ptr %r1, align 4
  %17 = load i32, ptr %r1, align 4
  call void (ptr, ptr, ...) @sqlite3NestedParse(ptr noundef %9, ptr noundef @.str.718, ptr noundef %14, ptr noundef @.str.320, i32 noundef %15, i32 noundef %16, i32 noundef %17)
