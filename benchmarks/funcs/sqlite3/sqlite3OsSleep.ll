...
define hidden i32 @sqlite3OsSleep(ptr noundef %pVfs, i32 noundef %nMicro) #0 {
entry:
  ...
  %xSleep = getelementptr inbounds nuw %struct.sqlite3_vfs, ptr %0, i32 0, i32 15
  %1 = load ptr, ptr %xSleep, align 8
  %2 = load ptr, ptr %pVfs.addr, align 8
  %3 = load i32, ptr %nMicro.addr, align 4
