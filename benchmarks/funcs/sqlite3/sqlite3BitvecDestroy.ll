...
; Function Attrs: nounwind uwtable
define hidden void @sqlite3BitvecDestroy(ptr noundef %p) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %iDivisor = getelementptr inbounds nuw %struct.Bitvec, ptr %1, i32 0, i32 2
  %2 = load i32, ptr %iDivisor, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %u = getelementptr inbounds nuw %struct.Bitvec, ptr %4, i32 0, i32 3
