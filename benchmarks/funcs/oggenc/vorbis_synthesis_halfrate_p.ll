...
define dso_local i32 @vorbis_synthesis_halfrate_p(ptr noundef %vi) #0 {
entry:
  ...
  %halfrate_flag = getelementptr inbounds nuw %struct.codec_setup_info, ptr %2, i32 0, i32 20
  %3 = load i32, ptr %halfrate_flag, align 8
  ret i32 %3
}
