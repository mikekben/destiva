...
define dso_local i64 @vorbis_book_codelen(ptr noundef %book, i32 noundef %entry1) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %c2 = getelementptr inbounds nuw %struct.codebook, ptr %2, i32 0, i32 3
  %3 = load ptr, ptr %c2, align 8
  %lengthlist = getelementptr inbounds nuw %struct.static_codebook, ptr %3, i32 0, i32 2
  %4 = load ptr, ptr %lengthlist, align 8
  %5 = load i32, ptr %entry.addr, align 4
