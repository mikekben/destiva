...
define dso_local i32 @ov_open_callbacks(ptr noundef %f, ptr noundef %vf, ptr noundef %initial, i64 noundef %ibytes, ptr noundef byval(%struct.ov_callbacks) align 8 %callbacks) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i32 @_ov_open2(ptr noundef %6)
