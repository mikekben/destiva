...
define hidden i32 @book_dup_or_new(ptr noundef %ci, ptr noundef %book) #0 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %books = getelementptr inbounds nuw %struct.codec_setup_info, ptr %1, i32 0, i32 5
  %2 = load i32, ptr %books, align 8
  %cmp = icmp slt i32 %0, %2
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %3 = load ptr, ptr %ci.addr, align 8
  %book_param = getelementptr inbounds nuw %struct.codec_setup_info, ptr %3, i32 0, i32 14
...
for.end:                                          ; preds = %for.cond
  ...
  %books2 = getelementptr inbounds nuw %struct.codec_setup_info, ptr %9, i32 0, i32 5
  %10 = load i32, ptr %books2, align 8
  %inc3 = add nsw i32 %10, 1
  store i32 %inc3, ptr %books2, align 8
