...
define dso_local void @drft_forward(ptr noundef %l, ptr noundef %data) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  call void @drftf1(i32 noundef %3, ptr noundef %4, ptr noundef %6, ptr noundef %add.ptr, ptr noundef %12)
  br label %return
...
; Function Attrs: nounwind uwtable
declare hidden void @drftf1(i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) #0
