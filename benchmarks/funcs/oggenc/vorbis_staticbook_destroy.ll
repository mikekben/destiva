...
define dso_local void @vorbis_staticbook_destroy(ptr noundef %b) #1 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  call void @vorbis_staticbook_clear(ptr noundef %2)
...
; Function Attrs: nounwind uwtable
declare dso_local void @vorbis_staticbook_clear(ptr noundef) #1
