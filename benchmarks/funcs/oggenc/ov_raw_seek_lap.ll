...
; Function Attrs: nounwind uwtable
define dso_local i32 @ov_raw_seek_lap(ptr noundef %vf, i64 noundef %pos) #0 {
entry:
  ...
  %call = call i32 @_ov_64_seek_lap(ptr noundef %0, i64 noundef %1, ptr noundef @ov_raw_seek)
  ret i32 %call
}
