...
define hidden i32 @tagcompare(ptr noundef %s1, ptr noundef %s2, i32 noundef %n) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 @toupper(i32 noundef %conv) #2
  ...
  %call4 = call i32 @toupper(i32 noundef %conv3) #2
