...
define dso_local ptr @res2_class(ptr noundef %vb, ptr noundef %vl, ptr noundef %in, ptr noundef %nonzero, i32 noundef %ch) #0 {
entry:
...
if.then3:                                         ; preds = %for.end
  ...
  %9 = load ptr, ptr %vl.addr, align 8
  %10 = load ptr, ptr %in.addr, align 8
  %11 = load i32, ptr %ch.addr, align 4
  %call = call ptr @_2class(ptr noundef %8, ptr noundef %9, ptr noundef %10, i32 noundef %11)
...
; Function Attrs: nounwind uwtable
declare hidden ptr @_2class(ptr noundef, ptr noundef, ptr noundef, i32 noundef) #0
