...
@__PRETTY_FUNCTION__.res_drain = external hidden unnamed_addr constant [38 x i8], align 1
...
; Function Attrs: nounwind uwtable
define dso_local i32 @res_drain(ptr noundef %state, ptr noundef %dstlist) #3 {
entry:
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(ptr noundef @.str.115, ptr noundef @.str.116, i32 noundef 3545, ptr noundef @__PRETTY_FUNCTION__.res_drain) #4
  unreachable
...
if.else3:                                         ; preds = %if.end
  call void @__assert_fail(ptr noundef @.str.126, ptr noundef @.str.116, i32 noundef 3546, ptr noundef @__PRETTY_FUNCTION__.res_drain) #4
  unreachable
...
if.else7:                                         ; preds = %if.end4
  call void @__assert_fail(ptr noundef @.str.128, ptr noundef @.str.116, i32 noundef 3547, ptr noundef @__PRETTY_FUNCTION__.res_drain) #4
  unreachable
...
for.body:                                         ; preds = %for.cond
  ...
  %19 = load ptr, ptr %dstlist.addr, align 8
  ...
  %taps18 = getelementptr inbounds nuw %struct.res_state, ptr %23, i32 0, i32 3
  %24 = load i32, ptr %taps18, align 4
  %div = udiv i32 %24, 2
  %sub = sub i32 %div, 1
  %conv19 = zext i32 %sub to i64
  %call20 = call i32 @push(ptr noundef %13, ptr noundef %add.ptr, ptr noundef %poolfill, ptr noundef %offset, ptr noundef %21, i32 noundef 1, ptr noundef %22, i32 noundef 1, i64 noundef %conv19)
...
for.end:                                          ; preds = %for.cond
  ...
  %poolfill21 = getelementptr inbounds nuw %struct.res_state, ptr %27, i32 0, i32 6
  store i32 -1, ptr %poolfill21, align 8
