...
define hidden void @render_line(i32 noundef %x0, i32 noundef %x1, i32 noundef %y0, i32 noundef %y1, ptr noundef %d) #1 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %arrayidx = getelementptr inbounds [256 x float], ptr @FLOOR1_fromdB_LOOKUP, i64 0, i64 %idxprom
  %18 = load float, ptr %arrayidx, align 4
  %19 = load ptr, ptr %d.addr, align 8
  %20 = load i32, ptr %x, align 4
  %idxprom4 = sext i32 %20 to i64
  %arrayidx5 = getelementptr inbounds float, ptr %19, i64 %idxprom4
  %21 = load float, ptr %arrayidx5, align 4
  %mul6 = fmul float %21, %18
...
while.cond:                                       ; preds = %if.end, %cond.end
  ...
  %23 = load i32, ptr %x1.addr, align 4
  %cmp7 = icmp slt i32 %inc, %23
  br i1 %cmp7, label %while.body, label %while.end

while.body:                                       ; preds = %while.cond
  %24 = load i32, ptr %err, align 4
  %25 = load i32, ptr %ady, align 4
  %add8 = add nsw i32 %24, %25
  store i32 %add8, ptr %err, align 4
  %26 = load i32, ptr %err, align 4
  %27 = load i32, ptr %adx, align 4
  %cmp9 = icmp sge i32 %26, %27
  br i1 %cmp9, label %if.then, label %if.else

if.then:                                          ; preds = %while.body
  %28 = load i32, ptr %adx, align 4
  %29 = load i32, ptr %err, align 4
  %sub10 = sub nsw i32 %29, %28
  store i32 %sub10, ptr %err, align 4
  %30 = load i32, ptr %sy, align 4
  %31 = load i32, ptr %y, align 4
  %add11 = add nsw i32 %31, %30
...
if.else:                                          ; preds = %while.body
  ...
  %add12 = add nsw i32 %33, %32
  store i32 %add12, ptr %y, align 4
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %34 = load i32, ptr %y, align 4
  %idxprom13 = sext i32 %34 to i64
  %arrayidx14 = getelementptr inbounds [256 x float], ptr @FLOOR1_fromdB_LOOKUP, i64 0, i64 %idxprom13
  %35 = load float, ptr %arrayidx14, align 4
  %36 = load ptr, ptr %d.addr, align 8
  %37 = load i32, ptr %x, align 4
  %idxprom15 = sext i32 %37 to i64
  %arrayidx16 = getelementptr inbounds float, ptr %36, i64 %idxprom15
  %38 = load float, ptr %arrayidx16, align 4
  %mul17 = fmul float %38, %35
  store float %mul17, ptr %arrayidx16, align 4
