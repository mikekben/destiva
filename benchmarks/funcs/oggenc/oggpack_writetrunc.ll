...
define dso_local void @oggpack_writetrunc(ptr noundef %b, i64 noundef %bits) #0 {
entry:
  ...
  %arrayidx = getelementptr inbounds [33 x i64], ptr @mask, i64 0, i64 %11
