...
declare dso_local i32 @_best(ptr noundef, ptr noundef, i32 noundef) #0

; Function Attrs: nounwind uwtable
define dso_local i32 @vorbis_book_errorv(ptr noundef %book, ptr noundef %a) #0 {
entry:
  ...
  %call = call i32 @_best(ptr noundef %2, ptr noundef %3, i32 noundef 1)
  store i32 %call, ptr %best, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %valuelist = getelementptr inbounds nuw %struct.codebook, ptr %6, i32 0, i32 4
  %7 = load ptr, ptr %valuelist, align 8
  ...
  store float %11, ptr %arrayidx4, align 4
  br label %for.inc
