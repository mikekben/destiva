...
define dso_local i32 @vorbis_info_blocksize(ptr noundef %vi, i32 noundef %zo) #0 {
entry:
  %vi.addr = alloca ptr, align 8
  %zo.addr = alloca i32, align 4
  %ci = alloca ptr, align 8
  store ptr %vi, ptr %vi.addr, align 8
  store i32 %zo, ptr %zo.addr, align 4
...
cond.true:                                        ; preds = %entry
  ...
  %blocksizes = getelementptr inbounds nuw %struct.codec_setup_info, ptr %3, i32 0, i32 0
  %4 = load i32, ptr %zo.addr, align 4
  %idxprom = sext i32 %4 to i64
  %arrayidx = getelementptr inbounds [2 x i64], ptr %blocksizes, i64 0, i64 %idxprom
