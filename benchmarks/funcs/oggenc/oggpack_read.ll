...
define dso_local i64 @oggpack_read(ptr noundef %b, i32 noundef %bits) #0 {
entry:
...
overflow:                                         ; preds = %if.end59, %if.then8
  %51 = load i32, ptr %bits.addr, align 4
  %div = sdiv i32 %51, 8
  %52 = load ptr, ptr %b.addr, align 8
  %ptr60 = getelementptr inbounds nuw %struct.oggpack_buffer, ptr %52, i32 0, i32 3
  %53 = load ptr, ptr %ptr60, align 8
  %idx.ext = sext i32 %div to i64
  %add.ptr = getelementptr inbounds i8, ptr %53, i64 %idx.ext
  store ptr %add.ptr, ptr %ptr60, align 8
  %54 = load i32, ptr %bits.addr, align 4
  %div61 = sdiv i32 %54, 8
  %conv62 = sext i32 %div61 to i64
  %55 = load ptr, ptr %b.addr, align 8
  %endbyte63 = getelementptr inbounds nuw %struct.oggpack_buffer, ptr %55, i32 0, i32 0
  %56 = load i64, ptr %endbyte63, align 8
  %add64 = add nsw i64 %56, %conv62
  store i64 %add64, ptr %endbyte63, align 8
  %57 = load i32, ptr %bits.addr, align 4
  %and65 = and i32 %57, 7
  %58 = load ptr, ptr %b.addr, align 8
  %endbit66 = getelementptr inbounds nuw %struct.oggpack_buffer, ptr %58, i32 0, i32 1
  store i32 %and65, ptr %endbit66, align 8
