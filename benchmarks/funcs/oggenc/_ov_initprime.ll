...
; Function Attrs: nounwind uwtable
define hidden i32 @_ov_initprime(ptr noundef %vf) #0 {
entry:
  ...
  %vd1 = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %0, i32 0, i32 19
  store ptr %vd1, ptr %vd, align 8
  br label %while.body
...
if.then:                                          ; preds = %while.body
  ...
  %call = call i32 @vorbis_synthesis_pcmout(ptr noundef %3, ptr noundef null)
...
if.end3:                                          ; preds = %if.end, %while.body
  ...
  %call4 = call i32 @_fetch_and_process_packet(ptr noundef %4, ptr noundef null, i32 noundef 1, i32 noundef 0)
