...
declare dso_local i64 @vorbis_book_decodev_add(ptr noundef, ptr noundef, ptr noundef, i32 noundef) #0

; Function Attrs: nounwind uwtable
declare hidden i32 @_01inverse(ptr noundef, ptr noundef, ptr noundef, i32 noundef, ptr noundef) #0

; Function Attrs: nounwind uwtable
define dso_local i32 @res1_inverse(ptr noundef %vb, ptr noundef %vl, ptr noundef %in, ptr noundef %nonzero, i32 noundef %ch) #0 {
entry:
...
if.then7:                                         ; preds = %for.end
  ...
  %call = call i32 @_01inverse(ptr noundef %12, ptr noundef %13, ptr noundef %14, i32 noundef %15, ptr noundef @vorbis_book_decodev_add)
