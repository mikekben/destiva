...
define dso_local i64 @ov_pcm_tell(ptr noundef %vf) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %pcm_offset = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %2, i32 0, i32 12
  %3 = load i64, ptr %pcm_offset, align 8
