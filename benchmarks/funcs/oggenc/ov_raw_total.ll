...
define dso_local i64 @ov_raw_total(ptr noundef %vf, i32 noundef %i) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i64 @ov_raw_total(ptr noundef %11, i32 noundef %12)
...
if.else:                                          ; preds = %if.end3
  ...
  %offsets = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %16, i32 0, i32 6
  ...
  %offsets10 = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %20, i32 0, i32 6
  %21 = load ptr, ptr %offsets10, align 8
  %22 = load i32, ptr %i.addr, align 4
  %idxprom11 = sext i32 %22 to i64
  %arrayidx12 = getelementptr inbounds i64, ptr %21, i64 %idxprom11
  %23 = load i64, ptr %arrayidx12, align 8
  %sub = sub nsw i64 %19, %23
