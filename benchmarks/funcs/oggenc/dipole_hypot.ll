...
define hidden float @dipole_hypot(float noundef %a, float noundef %b) #1 {
entry:
...
if.end16:                                         ; preds = %if.end
  ...
  %18 = call float @llvm.fmuladd.f32(float %14, float %15, float %neg18)
  %conv19 = fpext float %18 to double
  %call20 = call double @sqrt(double noundef %conv19) #3
  %fneg21 = fneg double %call20
  %conv22 = fptrunc double %fneg21 to float
  store float %conv22, ptr %retval, align 4
  br label %return
...
if.then27:                                        ; preds = %if.end23
  ...
  %24 = call float @llvm.fmuladd.f32(float %20, float %21, float %mul28)
  %conv29 = fpext float %24 to double
  %call30 = call double @sqrt(double noundef %conv29) #3
  %fneg31 = fneg double %call30
  %conv32 = fptrunc double %fneg31 to float
  store float %conv32, ptr %retval, align 4
  br label %return

if.end33:                                         ; preds = %if.end23
  %25 = load float, ptr %a.addr, align 4
  %fneg34 = fneg float %25
  %26 = load float, ptr %b.addr, align 4
  %cmp35 = fcmp ogt float %fneg34, %26
...
if.then37:                                        ; preds = %if.end33
  ...
  %31 = call float @llvm.fmuladd.f32(float %27, float %28, float %neg39)
  %conv40 = fpext float %31 to double
  %call41 = call double @sqrt(double noundef %conv40) #3
  %fneg42 = fneg double %call41
  %conv43 = fptrunc double %fneg42 to float
  store float %conv43, ptr %retval, align 4
  br label %return
...
if.end44:                                         ; preds = %if.end33
  ...
  %mul45 = fmul float %34, %35
  %neg46 = fneg float %mul45
  %36 = call float @llvm.fmuladd.f32(float %32, float %33, float %neg46)
  %conv47 = fpext float %36 to double
  %call48 = call double @sqrt(double noundef %conv47) #3
  %conv49 = fptrunc double %call48 to float
  store float %conv49, ptr %retval, align 4
  br label %return

return:                                           ; preds = %if.end44, %if.then37, %if.then27, %if.end16, %if.then11, %if.then5
