...
define dso_local ptr @ov_info(ptr noundef %vf, i32 noundef %link) #0 {
entry:
...
if.then3:                                         ; preds = %if.then1
  ...
  %vi = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %5, i32 0, i32 10
  ...
  %add.ptr = getelementptr inbounds %struct.vorbis_info, ptr %6, i64 %idx.ext
  store ptr %add.ptr, ptr %retval, align 8
  br label %return

if.else:                                          ; preds = %if.then1
  %9 = load ptr, ptr %vf.addr, align 8
  %vi4 = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %9, i32 0, i32 10
  %10 = load ptr, ptr %vi4, align 8
...
if.else8:                                         ; preds = %if.else5
  ...
  %vi9 = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %14, i32 0, i32 10
  %15 = load ptr, ptr %vi9, align 8
  %16 = load i32, ptr %link.addr, align 4
  %idx.ext10 = sext i32 %16 to i64
  %add.ptr11 = getelementptr inbounds %struct.vorbis_info, ptr %15, i64 %idx.ext10
  store ptr %add.ptr11, ptr %retval, align 8
  br label %return

if.else12:                                        ; preds = %entry
  %17 = load ptr, ptr %vf.addr, align 8
  %vi13 = getelementptr inbounds nuw %struct.OggVorbis_File, ptr %17, i32 0, i32 10
  %18 = load ptr, ptr %vi13, align 8
