...
; Function Attrs: nounwind uwtable
declare dso_local i32 @ov_pcm_seek(ptr noundef, i64 noundef) #1

; Function Attrs: nounwind uwtable
define dso_local i32 @ov_time_seek(ptr noundef %vf, double noundef %seconds) #1 {
entry:
...
for.end:                                          ; preds = %if.then13, %for.cond
  ...
  %call21 = call i32 @ov_pcm_seek(ptr noundef %31, i64 noundef %32)
