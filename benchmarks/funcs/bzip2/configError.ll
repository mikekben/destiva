...
@.str.118 = external hidden unnamed_addr constant [236 x i8], align 1
...
define hidden void @configError() #3 {
entry:
  %0 = load ptr, ptr @stderr, align 8
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef @.str.118) #4
