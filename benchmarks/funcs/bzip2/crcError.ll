...
@.str.133 = external hidden unnamed_addr constant [47 x i8], align 1
...
; Function Attrs: noreturn nounwind uwtable
define hidden void @crcError() #2 {
entry:
  %0 = load ptr, ptr @stderr, align 8
  %1 = load ptr, ptr @progName, align 8
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef @.str.133, ptr noundef %1) #3
