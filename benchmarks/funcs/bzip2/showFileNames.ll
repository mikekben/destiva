...
@.str.80 = external hidden unnamed_addr constant [36 x i8], align 1

; Function Attrs: nounwind
declare i32 @fprintf(ptr noundef, ptr noundef, ...) #0

; Function Attrs: nounwind uwtable
define hidden void @showFileNames() #1 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef @.str.80, ptr noundef @inName, ptr noundef @outName) #2
  br label %if.end
