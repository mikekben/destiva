...
define hidden void @saveInputFileMetaInfo(ptr noundef %srcName) #1 {
entry:
  %srcName.addr = alloca ptr, align 8
  %retVal = alloca i32, align 4
  store ptr %srcName, ptr %srcName.addr, align 8
  %0 = load ptr, ptr %srcName.addr, align 8
  %call = call i32 @stat(ptr noundef %0, ptr noundef @fileMetaInfo) #3
