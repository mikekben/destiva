...
@.str.92 = external hidden unnamed_addr constant [1230 x i8], align 1
...
; Function Attrs: nounwind uwtable
define hidden void @usage(ptr noundef %fullProgName) #1 {
entry:
  ...
  %call1 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef @.str.92, ptr noundef %call, ptr noundef %1) #2
  ret void
}
