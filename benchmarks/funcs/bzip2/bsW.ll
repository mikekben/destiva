...
define hidden void @bsW(ptr noundef %s, i32 noundef %n, i32 noundef %v) #0 {
entry:
...
while.end:                                        ; preds = %while.cond
  ...
  %bsLive4 = getelementptr inbounds nuw %struct.EState, ptr %15, i32 0, i32 25
  %16 = load i32, ptr %bsLive4, align 4
  %sub5 = sub nsw i32 32, %16
  %17 = load i32, ptr %n.addr, align 4
  %sub6 = sub nsw i32 %sub5, %17
  %shl7 = shl i32 %14, %sub6
  %18 = load ptr, ptr %s.addr, align 8
  %bsBuff8 = getelementptr inbounds nuw %struct.EState, ptr %18, i32 0, i32 24
  %19 = load i32, ptr %bsBuff8, align 8
  %or = or i32 %19, %shl7
  store i32 %or, ptr %bsBuff8, align 8
  %20 = load i32, ptr %n.addr, align 4
  %21 = load ptr, ptr %s.addr, align 8
  %bsLive9 = getelementptr inbounds nuw %struct.EState, ptr %21, i32 0, i32 25
  %22 = load i32, ptr %bsLive9, align 4
