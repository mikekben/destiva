...
@.str.113 = external hidden unnamed_addr constant [108 x i8], align 1
...
; Function Attrs: noreturn nounwind uwtable
define hidden void @panic(ptr noundef %s) #2 {
entry:
  ...
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef @.str.113, ptr noundef %1, ptr noundef %2) #3
