...
declare dso_local i32 @fiat_p384_value_barrier_u32(i32 noundef) #0

; Function Attrs: nounwind uwtable
define dso_local void @fiat_p384_cmovznz_u32(ptr noundef %out1, i8 noundef zeroext %arg1, i32 noundef %arg2, i32 noundef %arg3) #0 {
entry:
  ...
  %call = call i32 @fiat_p384_value_barrier_u32(i32 noundef %2)
  %3 = load i32, ptr %arg3.addr, align 4
  %and5 = and i32 %call, %3
  %4 = load i32, ptr %x2, align 4
  %not = xor i32 %4, -1
  %call6 = call i32 @fiat_p384_value_barrier_u32(i32 noundef %not)
