...
entry:
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x1, ptr noundef %x2, i8 noundef zeroext 0, i32 noundef %1, i32 noundef %3)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x3, ptr noundef %x4, i8 noundef zeroext %4, i32 noundef %6, i32 noundef %8)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x5, ptr noundef %x6, i8 noundef zeroext %9, i32 noundef %11, i32 noundef %13)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x7, ptr noundef %x8, i8 noundef zeroext %14, i32 noundef %16, i32 noundef %18)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x9, ptr noundef %x10, i8 noundef zeroext %19, i32 noundef %21, i32 noundef %23)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x11, ptr noundef %x12, i8 noundef zeroext %24, i32 noundef %26, i32 noundef %28)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x13, ptr noundef %x14, i8 noundef zeroext %29, i32 noundef %31, i32 noundef %33)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x15, ptr noundef %x16, i8 noundef zeroext %34, i32 noundef %36, i32 noundef %38)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x17, ptr noundef %x18, i8 noundef zeroext %39, i32 noundef %41, i32 noundef %43)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x19, ptr noundef %x20, i8 noundef zeroext %44, i32 noundef %46, i32 noundef %48)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x21, ptr noundef %x22, i8 noundef zeroext %49, i32 noundef %51, i32 noundef %53)
  ...
  call void @fiat_p384_addcarryx_u32(ptr noundef %x23, ptr noundef %x24, i8 noundef zeroext %54, i32 noundef %56, i32 noundef %58)
  %59 = load i32, ptr %x1, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x25, ptr noundef %x26, i8 noundef zeroext 0, i32 noundef %59, i32 noundef -1)
  %60 = load i8, ptr %x26, align 1
  %61 = load i32, ptr %x3, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x27, ptr noundef %x28, i8 noundef zeroext %60, i32 noundef %61, i32 noundef 0)
  %62 = load i8, ptr %x28, align 1
  %63 = load i32, ptr %x5, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x29, ptr noundef %x30, i8 noundef zeroext %62, i32 noundef %63, i32 noundef 0)
  %64 = load i8, ptr %x30, align 1
  %65 = load i32, ptr %x7, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x31, ptr noundef %x32, i8 noundef zeroext %64, i32 noundef %65, i32 noundef -1)
  %66 = load i8, ptr %x32, align 1
  %67 = load i32, ptr %x9, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x33, ptr noundef %x34, i8 noundef zeroext %66, i32 noundef %67, i32 noundef -2)
  %68 = load i8, ptr %x34, align 1
  %69 = load i32, ptr %x11, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x35, ptr noundef %x36, i8 noundef zeroext %68, i32 noundef %69, i32 noundef -1)
  %70 = load i8, ptr %x36, align 1
  %71 = load i32, ptr %x13, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x37, ptr noundef %x38, i8 noundef zeroext %70, i32 noundef %71, i32 noundef -1)
  %72 = load i8, ptr %x38, align 1
  %73 = load i32, ptr %x15, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x39, ptr noundef %x40, i8 noundef zeroext %72, i32 noundef %73, i32 noundef -1)
  %74 = load i8, ptr %x40, align 1
  %75 = load i32, ptr %x17, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x41, ptr noundef %x42, i8 noundef zeroext %74, i32 noundef %75, i32 noundef -1)
  %76 = load i8, ptr %x42, align 1
  %77 = load i32, ptr %x19, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x43, ptr noundef %x44, i8 noundef zeroext %76, i32 noundef %77, i32 noundef -1)
  %78 = load i8, ptr %x44, align 1
  %79 = load i32, ptr %x21, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x45, ptr noundef %x46, i8 noundef zeroext %78, i32 noundef %79, i32 noundef -1)
  %80 = load i8, ptr %x46, align 1
  %81 = load i32, ptr %x23, align 4
  call void @fiat_p384_subborrowx_u32(ptr noundef %x47, ptr noundef %x48, i8 noundef zeroext %80, i32 noundef %81, i32 noundef -1)
  %82 = load i8, ptr %x48, align 1
  %83 = load i8, ptr %x24, align 1
  %conv = zext i8 %83 to i32
  call void @fiat_p384_subborrowx_u32(ptr noundef %x49, ptr noundef %x50, i8 noundef zeroext %82, i32 noundef %conv, i32 noundef 0)
  %84 = load i8, ptr %x50, align 1
  %85 = load i32, ptr %x25, align 4
  %86 = load i32, ptr %x1, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x51, i8 noundef zeroext %84, i32 noundef %85, i32 noundef %86)
  %87 = load i8, ptr %x50, align 1
  %88 = load i32, ptr %x27, align 4
  %89 = load i32, ptr %x3, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x52, i8 noundef zeroext %87, i32 noundef %88, i32 noundef %89)
  %90 = load i8, ptr %x50, align 1
  %91 = load i32, ptr %x29, align 4
  %92 = load i32, ptr %x5, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x53, i8 noundef zeroext %90, i32 noundef %91, i32 noundef %92)
  %93 = load i8, ptr %x50, align 1
  %94 = load i32, ptr %x31, align 4
  %95 = load i32, ptr %x7, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x54, i8 noundef zeroext %93, i32 noundef %94, i32 noundef %95)
  %96 = load i8, ptr %x50, align 1
  %97 = load i32, ptr %x33, align 4
  %98 = load i32, ptr %x9, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x55, i8 noundef zeroext %96, i32 noundef %97, i32 noundef %98)
  %99 = load i8, ptr %x50, align 1
  %100 = load i32, ptr %x35, align 4
  %101 = load i32, ptr %x11, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x56, i8 noundef zeroext %99, i32 noundef %100, i32 noundef %101)
  %102 = load i8, ptr %x50, align 1
  %103 = load i32, ptr %x37, align 4
  %104 = load i32, ptr %x13, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x57, i8 noundef zeroext %102, i32 noundef %103, i32 noundef %104)
  %105 = load i8, ptr %x50, align 1
  %106 = load i32, ptr %x39, align 4
  %107 = load i32, ptr %x15, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x58, i8 noundef zeroext %105, i32 noundef %106, i32 noundef %107)
  %108 = load i8, ptr %x50, align 1
  %109 = load i32, ptr %x41, align 4
  %110 = load i32, ptr %x17, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x59, i8 noundef zeroext %108, i32 noundef %109, i32 noundef %110)
  %111 = load i8, ptr %x50, align 1
  %112 = load i32, ptr %x43, align 4
  %113 = load i32, ptr %x19, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x60, i8 noundef zeroext %111, i32 noundef %112, i32 noundef %113)
  %114 = load i8, ptr %x50, align 1
  %115 = load i32, ptr %x45, align 4
  %116 = load i32, ptr %x21, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x61, i8 noundef zeroext %114, i32 noundef %115, i32 noundef %116)
  %117 = load i8, ptr %x50, align 1
  %118 = load i32, ptr %x47, align 4
  %119 = load i32, ptr %x23, align 4
  call void @fiat_p384_cmovznz_u32(ptr noundef %x62, i8 noundef zeroext %117, i32 noundef %118, i32 noundef %119)
