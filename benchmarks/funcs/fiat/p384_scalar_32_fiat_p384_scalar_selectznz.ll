...
entry:
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x1, i8 noundef zeroext %0, i32 noundef %2, i32 noundef %4)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x2, i8 noundef zeroext %5, i32 noundef %7, i32 noundef %9)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x3, i8 noundef zeroext %10, i32 noundef %12, i32 noundef %14)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x4, i8 noundef zeroext %15, i32 noundef %17, i32 noundef %19)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x5, i8 noundef zeroext %20, i32 noundef %22, i32 noundef %24)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x6, i8 noundef zeroext %25, i32 noundef %27, i32 noundef %29)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x7, i8 noundef zeroext %30, i32 noundef %32, i32 noundef %34)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x8, i8 noundef zeroext %35, i32 noundef %37, i32 noundef %39)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x9, i8 noundef zeroext %40, i32 noundef %42, i32 noundef %44)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x10, i8 noundef zeroext %45, i32 noundef %47, i32 noundef %49)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x11, i8 noundef zeroext %50, i32 noundef %52, i32 noundef %54)
  ...
  call void @fiat_p384_scalar_cmovznz_u32(ptr noundef %x12, i8 noundef zeroext %55, i32 noundef %57, i32 noundef %59)
  %60 = load i32, ptr %x1, align 4
  %61 = load ptr, ptr %out1.addr, align 8
  %arrayidx24 = getelementptr inbounds i32, ptr %61, i64 0
  store i32 %60, ptr %arrayidx24, align 4
  %62 = load i32, ptr %x2, align 4
  %63 = load ptr, ptr %out1.addr, align 8
  %arrayidx25 = getelementptr inbounds i32, ptr %63, i64 1
  store i32 %62, ptr %arrayidx25, align 4
  %64 = load i32, ptr %x3, align 4
  %65 = load ptr, ptr %out1.addr, align 8
  %arrayidx26 = getelementptr inbounds i32, ptr %65, i64 2
  store i32 %64, ptr %arrayidx26, align 4
  %66 = load i32, ptr %x4, align 4
  %67 = load ptr, ptr %out1.addr, align 8
  %arrayidx27 = getelementptr inbounds i32, ptr %67, i64 3
  store i32 %66, ptr %arrayidx27, align 4
  %68 = load i32, ptr %x5, align 4
  %69 = load ptr, ptr %out1.addr, align 8
  %arrayidx28 = getelementptr inbounds i32, ptr %69, i64 4
  store i32 %68, ptr %arrayidx28, align 4
  %70 = load i32, ptr %x6, align 4
  %71 = load ptr, ptr %out1.addr, align 8
  %arrayidx29 = getelementptr inbounds i32, ptr %71, i64 5
  store i32 %70, ptr %arrayidx29, align 4
  %72 = load i32, ptr %x7, align 4
  %73 = load ptr, ptr %out1.addr, align 8
  %arrayidx30 = getelementptr inbounds i32, ptr %73, i64 6
  store i32 %72, ptr %arrayidx30, align 4
  %74 = load i32, ptr %x8, align 4
  %75 = load ptr, ptr %out1.addr, align 8
  %arrayidx31 = getelementptr inbounds i32, ptr %75, i64 7
  store i32 %74, ptr %arrayidx31, align 4
  %76 = load i32, ptr %x9, align 4
  %77 = load ptr, ptr %out1.addr, align 8
  %arrayidx32 = getelementptr inbounds i32, ptr %77, i64 8
  store i32 %76, ptr %arrayidx32, align 4
  %78 = load i32, ptr %x10, align 4
  %79 = load ptr, ptr %out1.addr, align 8
  %arrayidx33 = getelementptr inbounds i32, ptr %79, i64 9
  store i32 %78, ptr %arrayidx33, align 4
  %80 = load i32, ptr %x11, align 4
  %81 = load ptr, ptr %out1.addr, align 8
  %arrayidx34 = getelementptr inbounds i32, ptr %81, i64 10
  store i32 %80, ptr %arrayidx34, align 4
  %82 = load i32, ptr %x12, align 4
  %83 = load ptr, ptr %out1.addr, align 8
  %arrayidx35 = getelementptr inbounds i32, ptr %83, i64 11
  store i32 %82, ptr %arrayidx35, align 4
  ret void
}
