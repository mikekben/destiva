...
entry:
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x1, ptr noundef %x2, i8 noundef zeroext 0, i32 noundef %1, i32 noundef %3)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x3, ptr noundef %x4, i8 noundef zeroext %4, i32 noundef %6, i32 noundef %8)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x5, ptr noundef %x6, i8 noundef zeroext %9, i32 noundef %11, i32 noundef %13)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x7, ptr noundef %x8, i8 noundef zeroext %14, i32 noundef %16, i32 noundef %18)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x9, ptr noundef %x10, i8 noundef zeroext %19, i32 noundef %21, i32 noundef %23)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x11, ptr noundef %x12, i8 noundef zeroext %24, i32 noundef %26, i32 noundef %28)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x13, ptr noundef %x14, i8 noundef zeroext %29, i32 noundef %31, i32 noundef %33)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x15, ptr noundef %x16, i8 noundef zeroext %34, i32 noundef %36, i32 noundef %38)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x17, ptr noundef %x18, i8 noundef zeroext %39, i32 noundef %41, i32 noundef %43)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x19, ptr noundef %x20, i8 noundef zeroext %44, i32 noundef %46, i32 noundef %48)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x21, ptr noundef %x22, i8 noundef zeroext %49, i32 noundef %51, i32 noundef %53)
  ...
  call void @fiat_p384_subborrowx_u32(ptr noundef %x23, ptr noundef %x24, i8 noundef zeroext %54, i32 noundef %56, i32 noundef %58)
  %59 = load i8, ptr %x24, align 1
  call void @fiat_p384_cmovznz_u32(ptr noundef %x25, i8 noundef zeroext %59, i32 noundef 0, i32 noundef -1)
  %60 = load i32, ptr %x1, align 4
  %61 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x26, ptr noundef %x27, i8 noundef zeroext 0, i32 noundef %60, i32 noundef %61)
  %62 = load i8, ptr %x27, align 1
  %63 = load i32, ptr %x3, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x28, ptr noundef %x29, i8 noundef zeroext %62, i32 noundef %63, i32 noundef 0)
  %64 = load i8, ptr %x29, align 1
  %65 = load i32, ptr %x5, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x30, ptr noundef %x31, i8 noundef zeroext %64, i32 noundef %65, i32 noundef 0)
  %66 = load i8, ptr %x31, align 1
  %67 = load i32, ptr %x7, align 4
  %68 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x32, ptr noundef %x33, i8 noundef zeroext %66, i32 noundef %67, i32 noundef %68)
  %69 = load i8, ptr %x33, align 1
  %70 = load i32, ptr %x9, align 4
  %71 = load i32, ptr %x25, align 4
  %and = and i32 %71, -2
  call void @fiat_p384_addcarryx_u32(ptr noundef %x34, ptr noundef %x35, i8 noundef zeroext %69, i32 noundef %70, i32 noundef %and)
  %72 = load i8, ptr %x35, align 1
  %73 = load i32, ptr %x11, align 4
  %74 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x36, ptr noundef %x37, i8 noundef zeroext %72, i32 noundef %73, i32 noundef %74)
  %75 = load i8, ptr %x37, align 1
  %76 = load i32, ptr %x13, align 4
  %77 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x38, ptr noundef %x39, i8 noundef zeroext %75, i32 noundef %76, i32 noundef %77)
  %78 = load i8, ptr %x39, align 1
  %79 = load i32, ptr %x15, align 4
  %80 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x40, ptr noundef %x41, i8 noundef zeroext %78, i32 noundef %79, i32 noundef %80)
  %81 = load i8, ptr %x41, align 1
  %82 = load i32, ptr %x17, align 4
  %83 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x42, ptr noundef %x43, i8 noundef zeroext %81, i32 noundef %82, i32 noundef %83)
  %84 = load i8, ptr %x43, align 1
  %85 = load i32, ptr %x19, align 4
  %86 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x44, ptr noundef %x45, i8 noundef zeroext %84, i32 noundef %85, i32 noundef %86)
  %87 = load i8, ptr %x45, align 1
  %88 = load i32, ptr %x21, align 4
  %89 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x46, ptr noundef %x47, i8 noundef zeroext %87, i32 noundef %88, i32 noundef %89)
  %90 = load i8, ptr %x47, align 1
  %91 = load i32, ptr %x23, align 4
  %92 = load i32, ptr %x25, align 4
  call void @fiat_p384_addcarryx_u32(ptr noundef %x48, ptr noundef %x49, i8 noundef zeroext %90, i32 noundef %91, i32 noundef %92)
  %93 = load i32, ptr %x26, align 4
  %94 = load ptr, ptr %out1.addr, align 8
  %arrayidx24 = getelementptr inbounds i32, ptr %94, i64 0
  store i32 %93, ptr %arrayidx24, align 4
  %95 = load i32, ptr %x28, align 4
  %96 = load ptr, ptr %out1.addr, align 8
  %arrayidx25 = getelementptr inbounds i32, ptr %96, i64 1
  store i32 %95, ptr %arrayidx25, align 4
  %97 = load i32, ptr %x30, align 4
  %98 = load ptr, ptr %out1.addr, align 8
  %arrayidx26 = getelementptr inbounds i32, ptr %98, i64 2
  store i32 %97, ptr %arrayidx26, align 4
  %99 = load i32, ptr %x32, align 4
  %100 = load ptr, ptr %out1.addr, align 8
  %arrayidx27 = getelementptr inbounds i32, ptr %100, i64 3
  store i32 %99, ptr %arrayidx27, align 4
  %101 = load i32, ptr %x34, align 4
  %102 = load ptr, ptr %out1.addr, align 8
  %arrayidx28 = getelementptr inbounds i32, ptr %102, i64 4
  store i32 %101, ptr %arrayidx28, align 4
  %103 = load i32, ptr %x36, align 4
  %104 = load ptr, ptr %out1.addr, align 8
  %arrayidx29 = getelementptr inbounds i32, ptr %104, i64 5
  store i32 %103, ptr %arrayidx29, align 4
  %105 = load i32, ptr %x38, align 4
  %106 = load ptr, ptr %out1.addr, align 8
  %arrayidx30 = getelementptr inbounds i32, ptr %106, i64 6
  store i32 %105, ptr %arrayidx30, align 4
  %107 = load i32, ptr %x40, align 4
  %108 = load ptr, ptr %out1.addr, align 8
  %arrayidx31 = getelementptr inbounds i32, ptr %108, i64 7
  store i32 %107, ptr %arrayidx31, align 4
  %109 = load i32, ptr %x42, align 4
  %110 = load ptr, ptr %out1.addr, align 8
  %arrayidx32 = getelementptr inbounds i32, ptr %110, i64 8
  store i32 %109, ptr %arrayidx32, align 4
  %111 = load i32, ptr %x44, align 4
  %112 = load ptr, ptr %out1.addr, align 8
  %arrayidx33 = getelementptr inbounds i32, ptr %112, i64 9
  store i32 %111, ptr %arrayidx33, align 4
  %113 = load i32, ptr %x46, align 4
  %114 = load ptr, ptr %out1.addr, align 8
  %arrayidx34 = getelementptr inbounds i32, ptr %114, i64 10
  store i32 %113, ptr %arrayidx34, align 4
  %115 = load i32, ptr %x48, align 4
  %116 = load ptr, ptr %out1.addr, align 8
  %arrayidx35 = getelementptr inbounds i32, ptr %116, i64 11
  store i32 %115, ptr %arrayidx35, align 4
  ret void
}
